...
(
	cd "${TMP_DIR}/${ARTIFACT}"
	zip -r -q "${ROOT_DIR}/${ZIP_FILE}" nvoos-graphify/
)
...
echo "🎉 NV oOS Graphify standalone plugin ZIP built successfully!"
echo "   ${ZIP_FILE}"
