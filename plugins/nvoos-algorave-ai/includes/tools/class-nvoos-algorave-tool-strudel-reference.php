...
class NV_oOS_Algorave_Tool_Strudel_Reference implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Strudel Reference', 'nvoos-algorave-ai' );
	}
	...
	public function get_description() {
		return __( 'Get Strudel live coding reference documentation. Use this tool when you need to look up Strudel mini-notation syntax, available effects, pattern transformations, sample banks, synthesizer types, MIDI output syntax, or visual feedback features before generating or modifying a pattern. Returns detailed reference for the requested topic. Always consult this before writing complex Strudel code.', 'nvoos-algorave-ai' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties'           => array(
				'topic' => array(
					'type'        => 'string',
					'description' => __( 'Reference topic to look up.', 'nvoos-algorave-ai' ),
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'message'   => sprintf(
				...
				__( 'Strudel reference for "%s". Use this information to generate correct Strudel patterns.', 'nvoos-algorave-ai' ),
				$topic
			),
		);
	}
