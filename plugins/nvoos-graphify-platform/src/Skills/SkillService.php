...
namespace NvoosGraphifyPlatform\Skills;
...
final class SkillService {
	...
	private function registerAdmin(): void {
		if ( class_exists( 'NvoosGraphifyPlatform\Skills\Admin\SkillsAdmin' ) ) {
			( new \NvoosGraphifyPlatform\Skills\Admin\SkillsAdmin() )->register();
		}
	}
