...
namespace NvoosGraphifyPlatform\Agents;
...
final class Agents {
	 ...
	 *
	 * Called from {@see \NvoosGraphifyPlatform\Plugin::register()}.
	 *
	 * @return void
	 */
	...
	private function registerAdmin(): void {
		if ( class_exists( 'NvoosGraphifyPlatform\Agents\Admin\AgentsAdmin' ) ) {
			( new \NvoosGraphifyPlatform\Agents\Admin\AgentsAdmin() )->register();
		}
	}
