...
use NvoosGraphifyAiPlatform\Agents\Agents;
...
final class BuildAgentPage {
	...
	public function registerPage(): void {
		$this->page_hook = add_submenu_page(
			...
			__( 'Build Agent', 'nvoos-graphify-ai-platform' ),
			__( 'Build Agent', 'nvoos-graphify-ai-platform' ),
			'edit_posts',
			'nvoos-graphify-ai-platform-build-agent',
	...
	public function enqueueScripts( string $hook ): void {
		...
		wp_enqueue_style(
			'nvoos-graphify-ai-platform-agents-build',
			NVOOS_GRAPHIFY_AI_PLATFORM_URL . 'assets/css/agents-build.css',
			array( 'wp-mcp-ai-chat' ),
			NVOOS_GRAPHIFY_AI_PLATFORM_VERSION
		);

		wp_enqueue_script(
			'nvoos-graphify-ai-platform-agents-build',
			NVOOS_GRAPHIFY_AI_PLATFORM_URL . 'assets/js/agents-build.js',
		...
		wp_enqueue_style(
			'nvoos-graphify-ai-platform-agents-build-blocks',
		...
		wp_localize_script(
			...
			array(
				...
				'strings'     => array(
					'creating'          => __( 'Creating agent...', 'nvoos-graphify-ai-platform' ),
					'createAgent'       => __( 'Create Agent', 'nvoos-graphify-ai-platform' ),
					'success'           => __( 'Agent created successfully!', 'nvoos-graphify-ai-platform' ),
					'error'             => __( 'Error creating agent. Please try again.', 'nvoos-graphify-ai-platform' ),
					'required'          => __( 'This field is required.', 'nvoos-graphify-ai-platform' ),
					'maxProfessions'    => __( 'You can select up to 3 professions.', 'nvoos-graphify-ai-platform' ),
					'maxRegions'        => __( 'You can select up to 2 regions.', 'nvoos-graphify-ai-platform' ),
					'emptyConversation' => __( 'Please describe what kind of agent you want to create before clicking Build.', 'nvoos-graphify-ai-platform' ),
				),
	...
	private function getChatStrings(): array {
		return array(
			...
			'roleLabels'                => array(
				...
				'tool'      => __( 'Tool', 'nvoos-graphify-ai-platform' ),
			),
		);
	}
	...
	private function isBuildAgentPage( string $hook ): bool {
		...
		if ( function_exists( 'get_current_screen' ) ) {
			...
			if ( $screen && isset( $screen->id ) ) {
				return false !== strpos( $screen->id, '_page_nvoos-graphify-ai-platform-build-agent' );
			}
		}

		// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$page = isset( $_GET['page'] ) ? sanitize_key( wp_unslash( $_GET['page'] ) ) : '';
		return 'nvoos-graphify-ai-platform-build-agent' === $page;
	}
	...
	private function getTabs(): array {
		return array(
			'manual'        => array(
				'title' => __( 'Manual', 'nvoos-graphify-ai-platform' ),
				'icon'  => 'dashicons-edit',
			),
			'prompt'        => array(
				'title' => __( 'Prompt', 'nvoos-graphify-ai-platform' ),
				'icon'  => 'dashicons-format-chat',
			),
			'configuration' => array(
				'title' => __( 'Configuration', 'nvoos-graphify-ai-platform' ),
				'icon'  => 'dashicons-admin-settings',
			),
			'advanced'      => array(
				'title' => __( 'Advanced', 'nvoos-graphify-ai-platform' ),
	...
	public function renderPage(): void {
		...
		<div class="wrap wp-mcp-ai-build-assistant-page">
			<h1><?php esc_html_e( 'Build Agent', 'nvoos-graphify-ai-platform' ); ?></h1>
			<p class="description">
				<?php esc_html_e( 'Configure and build custom AI agents with advanced settings and options.', 'nvoos-graphify-ai-platform' ); ?>
			</p>

			<nav class="nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e( 'Build Agent tabs', 'nvoos-graphify-ai-platform' ); ?>">
				<?php foreach ( $tabs as $tab_id => $tab ) : ?>
					<?php
					$tab_url = add_query_arg(
						array(
							'post_type' => Agents::POST_TYPE,
							'page'      => 'nvoos-graphify-ai-platform-build-agent',
							'tab'       => $tab_id,
						),
						admin_url( 'edit.php' )
					);
	...
	private function renderManualTab(): void {
		...
		<div class="wp-mcp-ai-tab-content wp-mcp-ai-manual-tab">
			<div class="wp-mcp-ai-section">
				<h2><?php esc_html_e( 'Create Agent Manually', 'nvoos-graphify-ai-platform' ); ?></h2>
				<p class="description"><?php esc_html_e( 'Fill in the form below to create a new AI agent with custom settings.', 'nvoos-graphify-ai-platform' ); ?></p>
				...
				<form id="wp-mcp-ai-create-assistant-form" class="wp-mcp-ai-assistant-form">
							...
							<tr>
								<th scope="row">
									<label for="assistant-title">
										<?php esc_html_e( 'Agent Title', 'nvoos-graphify-ai-platform' ); ?> <span class="required">*</span>
									</label>
								</th>
								<td>
									<input type="text" id="assistant-title" name="title" class="regular-text" required>
									<p class="description">
										<?php esc_html_e( 'E.g., "Jamaica Tax Agent", "Sri Lanka Customs Broker"', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-professions">
										<?php esc_html_e( 'Professions', 'nvoos-graphify-ai-platform' ); ?> <span class="required">*</span>
									</label>
								</th>
								<td>
									...
									<p class="description">
										<?php esc_html_e( 'Select up to 3 professions. Hold Ctrl/Cmd to select multiple.', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-regions">
										<?php esc_html_e( 'Regions', 'nvoos-graphify-ai-platform' ); ?> <span class="required">*</span>
									</label>
								</th>
								<td>
									...
									<p class="description">
										<?php esc_html_e( 'Select up to 2 regions. Hold Ctrl/Cmd to select multiple.', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-industry">
										<?php esc_html_e( 'Industry Focus', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
									<input type="text" id="assistant-industry" name="industry_focus" class="regular-text">
									<p class="description">
										<?php esc_html_e( 'Optional: E.g., "perfumes", "technology", "restaurants"', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-attachments">
										<?php esc_html_e( 'Knowledge Files', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
									<input type="file" id="assistant-attachments" name="attachments[]" multiple accept=".txt,.md,.pdf,.doc,.docx">
									<p class="description">
										<?php esc_html_e( 'Optional: Upload files to include in the agent\'s knowledge base (.txt, .md, .pdf, .doc, .docx)', 'nvoos-graphify-ai-platform' ); ?>
									</p>
							...
							<tr>
								<th scope="row">
									<label for="assistant-provider">
										<?php esc_html_e( 'AI Provider', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<label for="assistant-model">
										<?php esc_html_e( 'Model', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
									<input type="text" id="assistant-model" name="model" class="regular-text" value="gpt-4">
									<p class="description">
										<?php esc_html_e( 'E.g., "gpt-4", "gpt-4-turbo", "gemini-pro"', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-temperature">
										<?php esc_html_e( 'Temperature', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
									<input type="number" id="assistant-temperature" name="temperature" class="small-text" min="0" max="2" step="0.1" value="0.7">
									<p class="description">
										<?php esc_html_e( '0-2. Lower is more deterministic, higher is more creative.', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="assistant-async">
										...
										<?php esc_html_e( 'Create in Background', 'nvoos-graphify-ai-platform' ); ?>
									</label>
								</th>
								<td>
									<p class="description">
										<?php esc_html_e( 'For complex agents, create asynchronously via cron. You will be notified when complete.', 'nvoos-graphify-ai-platform' ); ?>
									</p>
								</td>
							</tr>
						</tbody>
					...
					<p class="submit">
						<button type="submit" class="button button-primary" id="wp-mcp-ai-submit-create">
							<?php esc_html_e( 'Create Agent', 'nvoos-graphify-ai-platform' ); ?>
						</button>
					</p>
				</form>
			</div>
	...
	private function renderPromptTab(): void {
		...
		<div class="wp-mcp-ai-tab-content wp-mcp-ai-prompt-tab wp-mcp-ai-admin-blocks">
			<div class="wp-mcp-ai-section">
				<h2><?php esc_html_e( 'Build with AI Prompt', 'nvoos-graphify-ai-platform' ); ?></h2>
				<div class="wp-mcp-ai-prompt-intro">
					<strong><?php esc_html_e( 'Describe your agent', 'nvoos-graphify-ai-platform' ); ?></strong>
					<p><?php esc_html_e( 'Tell the AI what kind of agent you want to create. Describe its purpose, expertise, target audience, and any specific capabilities. You can also upload files to include in its knowledge base and select tools for the agent to use. When ready, click the "Build" button to create your agent.', 'nvoos-graphify-ai-platform' ); ?></p>
				</div>
				...
				<div class="wp-mcp-ai-prompt-action">
					<?php if ( $builder_agent_id ) : ?>
						<button
							...
							data-assistant-title="<?php esc_attr_e( 'AI Agent Builder', 'nvoos-graphify-ai-platform' ); ?>"
						>
							<span class="dashicons dashicons-format-chat"></span>
							<?php esc_html_e( 'Build with AI', 'nvoos-graphify-ai-platform' ); ?>
						</button>
						<p class="description"><?php esc_html_e( 'Click to open the AI chat interface and describe your agent.', 'nvoos-graphify-ai-platform' ); ?></p>
					<?php else : ?>
						<div class="wp-mcp-ai-no-builder">
							<p><?php esc_html_e( 'The Agent Builder is not configured. Please create an agent with the slug "assistant-builder" or set one in the plugin settings.', 'nvoos-graphify-ai-platform' ); ?></p>
						</div>
					<?php endif; ?>
				</div>
			</div>
		...
		<div id="wp-mcp-ai-build-assistant-modal" class="wp-mcp-ai-test-modal" style="display: none;">
			...
			<div class="wp-mcp-ai-test-modal__panel">
				<div class="wp-mcp-ai-test-modal__header">
					<h2><?php esc_html_e( 'Build with AI', 'nvoos-graphify-ai-platform' ); ?></h2>
					<button type="button" class="wp-mcp-ai-test-modal__close" aria-label="<?php esc_attr_e( 'Close', 'nvoos-graphify-ai-platform' ); ?>">
	...
	private function renderToolsGridComponent(): void {
		...
		$attributes = array(
			'title'            => __( 'Tools Configuration', 'nvoos-graphify-ai-platform' ),
			'description'      => __( 'Select the tools you want your agent to be able to use.', 'nvoos-graphify-ai-platform' ),
	...
	private function renderKnowledgeBaseComponent(): void {
		...
		$attributes = array(
			'title'         => __( 'Knowledge Base', 'nvoos-graphify-ai-platform' ),
			'description'   => __( 'Upload files to include in the agent\'s knowledge base.', 'nvoos-graphify-ai-platform' ),
	...
	private function getProfessions(): array {
		...
		return array(
			'tax_advisor'              => __( 'Tax Advisor', 'nvoos-graphify-ai-platform' ),
			'accountant'               => __( 'Accountant', 'nvoos-graphify-ai-platform' ),
			'bookkeeper'               => __( 'Bookkeeper', 'nvoos-graphify-ai-platform' ),
			'lawyer'                   => __( 'Lawyer', 'nvoos-graphify-ai-platform' ),
			'legal_advisor'            => __( 'Legal Advisor', 'nvoos-graphify-ai-platform' ),
			'customs_broker'           => __( 'Customs Broker', 'nvoos-graphify-ai-platform' ),
			'import_export_specialist' => __( 'Import/Export Specialist', 'nvoos-graphify-ai-platform' ),
			'financial_advisor'        => __( 'Financial Advisor', 'nvoos-graphify-ai-platform' ),
			'business_consultant'      => __( 'Business Consultant', 'nvoos-graphify-ai-platform' ),
			'real_estate_agent'        => __( 'Real Estate Agent', 'nvoos-graphify-ai-platform' ),
			'healthcare_advisor'       => __( 'Healthcare Advisor', 'nvoos-graphify-ai-platform' ),
			'marketing_consultant'     => __( 'Marketing Consultant', 'nvoos-graphify-ai-platform' ),
			'hr_consultant'            => __( 'HR Consultant', 'nvoos-graphify-ai-platform' ),
			'it_consultant'            => __( 'IT Consultant', 'nvoos-graphify-ai-platform' ),
			'restaurant_consultant'    => __( 'Restaurant Consultant', 'nvoos-graphify-ai-platform' ),
		);
	}
	...
	private function getRegions(): array {
		return array(
			'united_states'        => __( 'United States', 'nvoos-graphify-ai-platform' ),
			'canada'               => __( 'Canada', 'nvoos-graphify-ai-platform' ),
			'united_kingdom'       => __( 'United Kingdom', 'nvoos-graphify-ai-platform' ),
			'australia'            => __( 'Australia', 'nvoos-graphify-ai-platform' ),
			'jamaica'              => __( 'Jamaica', 'nvoos-graphify-ai-platform' ),
			'sri_lanka'            => __( 'Sri Lanka', 'nvoos-graphify-ai-platform' ),
			'india'                => __( 'India', 'nvoos-graphify-ai-platform' ),
			'singapore'            => __( 'Singapore', 'nvoos-graphify-ai-platform' ),
			'united_arab_emirates' => __( 'United Arab Emirates', 'nvoos-graphify-ai-platform' ),
			'germany'              => __( 'Germany', 'nvoos-graphify-ai-platform' ),
			'france'               => __( 'France', 'nvoos-graphify-ai-platform' ),
			'spain'                => __( 'Spain', 'nvoos-graphify-ai-platform' ),
			'italy'                => __( 'Italy', 'nvoos-graphify-ai-platform' ),
			'netherlands'          => __( 'Netherlands', 'nvoos-graphify-ai-platform' ),
			'brazil'               => __( 'Brazil', 'nvoos-graphify-ai-platform' ),
			'mexico'               => __( 'Mexico', 'nvoos-graphify-ai-platform' ),
			'south_africa'         => __( 'South Africa', 'nvoos-graphify-ai-platform' ),
			'new_zealand'          => __( 'New Zealand', 'nvoos-graphify-ai-platform' ),
			'ireland'              => __( 'Ireland', 'nvoos-graphify-ai-platform' ),
			'japan'                => __( 'Japan', 'nvoos-graphify-ai-platform' ),
			'china'                => __( 'China', 'nvoos-graphify-ai-platform' ),
			'global'               => __( 'Global', 'nvoos-graphify-ai-platform' ),
		);
	}
	...
	private function renderConfigurationTab(): void {
		...
		<div class="wp-mcp-ai-tab-content wp-mcp-ai-configuration-tab">
			<div class="wp-mcp-ai-section">
				<h2><?php esc_html_e( 'Agent Configuration', 'nvoos-graphify-ai-platform' ); ?></h2>
				<p class="description"><?php esc_html_e( 'Configure the basic settings for your AI agent.', 'nvoos-graphify-ai-platform' ); ?></p>

				<div class="wp-mcp-ai-config-grid">
					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-format-chat"></span>
						<h3><?php esc_html_e( 'Create from Template', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Create a new agent using a professional template with pre-configured settings.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=' . Agents::POST_TYPE . '&page=nvoos-graphify-ai-platform-add-agent' ) ); ?>" class="button button-primary">
							<?php esc_html_e( 'Use Template', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>

					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-plus-alt"></span>
						<h3><?php esc_html_e( 'Create Custom', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Create a new custom agent from scratch with your own configuration.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=' . Agents::POST_TYPE ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'Add New', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>

					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-list-view"></span>
						<h3><?php esc_html_e( 'Manage Agents', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'View and manage all existing AI agents in your system.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=' . Agents::POST_TYPE ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'View All', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="wp-mcp-ai-section">
				<h2><?php esc_html_e( 'Quick Statistics', 'nvoos-graphify-ai-platform' ); ?></h2>
	...
	private function renderAdvancedTab(): void {
		...
		<div class="wp-mcp-ai-tab-content wp-mcp-ai-advanced-tab">
			<div class="wp-mcp-ai-section">
				<h2><?php esc_html_e( 'Advanced Settings', 'nvoos-graphify-ai-platform' ); ?></h2>
				<p class="description"><?php esc_html_e( 'Advanced configuration options for power users.', 'nvoos-graphify-ai-platform' ); ?></p>

				<div class="wp-mcp-ai-config-grid">
					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-admin-users"></span>
						<h3><?php esc_html_e( 'Professional Templates', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Manage professional templates that define roles, tools, and knowledge bases for agents.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=mcp_ai_profession' ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'Manage Templates', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>

					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-groups"></span>
						<h3><?php esc_html_e( 'Teams', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Create teams of agents that can work together on complex tasks.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=mcp_ai_team' ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'Manage Teams', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>

					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-admin-tools"></span>
						<h3><?php esc_html_e( 'Tools & Features', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Configure available tools and features that agents can use.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=wp-mcp-ai-dashboard&tab=tools' ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'Configure Tools', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>

					<div class="wp-mcp-ai-config-card">
						<span class="dashicons dashicons-admin-generic"></span>
						<h3><?php esc_html_e( 'AI Providers', 'nvoos-graphify-ai-platform' ); ?></h3>
						<p><?php esc_html_e( 'Configure API keys and settings for AI providers.', 'nvoos-graphify-ai-platform' ); ?></p>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=wp-mcp-ai-dashboard&tab=providers' ) ); ?>" class="button button-secondary">
							<?php esc_html_e( 'Configure Providers', 'nvoos-graphify-ai-platform' ); ?>
						</a>
					</div>
				</div>
			</div>
	...
	private function renderStats(): void {
		...
		<div class="wp-mcp-ai-stats-grid">
			<div class="wp-mcp-ai-stat-card">
				...
				<span class="wp-mcp-ai-stat-label"><?php esc_html_e( 'Active Agents', 'nvoos-graphify-ai-platform' ); ?></span>
			</div>
			<div class="wp-mcp-ai-stat-card">
				<span class="wp-mcp-ai-stat-number"><?php echo esc_html( (string) $published_professions ); ?></span>
				<span class="wp-mcp-ai-stat-label"><?php esc_html_e( 'Professional Templates', 'nvoos-graphify-ai-platform' ); ?></span>
			</div>
			<div class="wp-mcp-ai-stat-card">
				<span class="wp-mcp-ai-stat-number"><?php echo esc_html( (string) $published_teams ); ?></span>
				<span class="wp-mcp-ai-stat-label"><?php esc_html_e( 'Teams', 'nvoos-graphify-ai-platform' ); ?></span>
			</div>
		</div>
		<?php
	}
