...
final class AgentsDashboardSection extends PlatformSection {
	...
	public function get_title(): string {
		return __( 'Agents', 'nvoos-graphify-ai-platform' );
	}
	...
	public function render_wrapper( string $page_slug = '' ): void {
		...
		?>
		<h2><?php esc_html_e( 'Agent Management', 'nvoos-graphify-ai-platform' ); ?></h2>
		...
		<div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:1.5rem;">
			<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem;min-width:140px;text-align:center;">
				...
				<div style="color:#646970;"><?php esc_html_e( 'Total Agents', 'nvoos-graphify-ai-platform' ); ?></div>
			</div>
			<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem;min-width:140px;text-align:center;">
				...
				<div style="color:#646970;"><?php esc_html_e( 'Max Allowed', 'nvoos-graphify-ai-platform' ); ?></div>
			</div>
		</div>
		...
		<div style="display:flex;flex-wrap:wrap;gap:0.75rem;margin-bottom:1.5rem;">
			...
			<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=' . Agents::POST_TYPE ) ); ?>" class="button">
				<?php esc_html_e( 'View All Agents', 'nvoos-graphify-ai-platform' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=nvoos-graphify-ai-platform-add-agent' ) ); ?>" class="button">
				<?php esc_html_e( 'Add from Template', 'nvoos-graphify-ai-platform' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=nvoos-graphify-ai-platform-build-agent' ) ); ?>" class="button">
				<?php esc_html_e( 'Build Agent', 'nvoos-graphify-ai-platform' ); ?>
			</a>
		</div>

		<?php if ( ! empty( $agents ) ) : ?>
			<h3><?php esc_html_e( 'Recent Agents', 'nvoos-graphify-ai-platform' ); ?></h3>
			<table class="wp-list-table widefat fixed striped" style="max-width:100%;">
				<thead>
					<tr>
						<th><?php esc_html_e( 'Agent', 'nvoos-graphify-ai-platform' ); ?></th>
						<th><?php esc_html_e( 'Provider', 'nvoos-graphify-ai-platform' ); ?></th>
						<th><?php esc_html_e( 'Model', 'nvoos-graphify-ai-platform' ); ?></th>
		...
		<?php else : ?>
			<div style="background:#fff;border:1px solid #c3c4c7;padding:2rem;text-align:center;">
				<h3><?php esc_html_e( 'No agents yet', 'nvoos-graphify-ai-platform' ); ?></h3>
				<p><?php esc_html_e( 'Create your first AI agent to get started. Agents are powered by the AI addon and can be configured with tools, skills, and memory.', 'nvoos-graphify-ai-platform' ); ?></p>
				<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=' . Agents::POST_TYPE ) ); ?>" class="button button-primary">
					<?php esc_html_e( 'Create Your First Agent', 'nvoos-graphify-ai-platform' ); ?>
				</a>
			</div>
		<?php endif; ?>
		<?php
