...
namespace NvoosGraphifyAiPlatform\Agents;
...
final class Agents {
	 ...
	 *
	 * Called from {@see \NvoosGraphifyAiPlatform\Plugin::register()}.
	 *
	 * @return void
	 */
	...
	private function registerAdmin(): void {
		if ( class_exists( 'NvoosGraphifyAiPlatform\Agents\Admin\AgentsAdmin' ) ) {
			( new \NvoosGraphifyAiPlatform\Agents\Admin\AgentsAdmin() )->register();
		}
	}
