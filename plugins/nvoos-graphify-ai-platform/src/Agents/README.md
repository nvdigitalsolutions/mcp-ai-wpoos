 ...
 *
 * @package NvoosGraphifyAiPlatform\Agents
 */
...
| **PHP target** | 8.1+ |
| **License** | Proprietary |
| **Loaded by** | `NvoosGraphifyAiPlatform\Plugin::register()` → `Agents::instance()->register()` |
...
| Symbol | File | Purpose |
|---|---|---|
| `NvoosGraphifyAiPlatform\Agents\Agents` | `Agents.php` | Singleton service — wires agent hooks |
| `NvoosGraphifyAiPlatform\Agents\Admin\AgentsAdmin` | `Admin/AgentsAdmin.php` | Admin menu + SettingsRegistry integration |
| `NvoosGraphifyAiPlatform\Agents\Agents::POST_TYPE` | `Agents.php` | Post type constant (`mcp_ai_assistant`) |
