...
| **Loaded by** | `nvoos-graphify-ai-platform.php` via `spl_autoload_register` (PSR-4 fallback) + Composer autoload |
...
| Symbol | File | Used by |
|---|---|---|
| `NvoosGraphifyAiPlatform\Plugin` | `Plugin.php` | Bootstrap (singleton composition root) |
...
- **Upstream callers:** `nvoos-graphify-ai-platform.php` (bootstrap), core `NvoosGraphify\Plugin`
