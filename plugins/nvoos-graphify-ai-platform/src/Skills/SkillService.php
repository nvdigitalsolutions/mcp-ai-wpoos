...
namespace NvoosGraphifyAiPlatform\Skills;
...
final class SkillService {
	...
	private function registerAdmin(): void {
		if ( class_exists( 'NvoosGraphifyAiPlatform\Skills\Admin\SkillsAdmin' ) ) {
			( new \NvoosGraphifyAiPlatform\Skills\Admin\SkillsAdmin() )->register();
		}
	}
