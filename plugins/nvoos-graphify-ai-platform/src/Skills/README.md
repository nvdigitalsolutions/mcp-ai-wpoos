 ...
 *
 * @package NvoosGraphifyAiPlatform\Skills
 */
...
Agent Skills subsystem for NV oOS Graphify — manages Anthropic-compatible Agent Skills (SKILL.md files) with YAML frontmatter, bundled skill packs, and progressive-disclosure prompt construction.
...
```php
use NvoosGraphifyAiPlatform\Skills\SkillBridge;
