...
final class MeasurementDashboardSection extends PlatformSection {
	...
	public function get_title(): string {
		return __( 'Measurement & Telemetry', 'nvoos-graphify-ai-platform' );
	}
	...
	public function get_fields(): array {
		return array(
			'measurement_retention_days' => array(
				'type'        => 'number',
				'label'       => __( 'Data Retention (days)', 'nvoos-graphify-ai-platform' ),
				'description' => __( 'How long telemetry data is kept before automatic cleanup. Set to 0 to keep indefinitely.', 'nvoos-graphify-ai-platform' ),
				'min'         => 0,
				'max'         => 365,
				'default'     => 90,
			),
	...
	public function render_wrapper( string $page_slug = '' ): void {
		...
		<div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:1.5rem;">
			<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem;min-width:140px;text-align:center;">
				...
				<div style="color:#646970;"><?php esc_html_e( 'Total Events', 'nvoos-graphify-ai-platform' ); ?></div>
			</div>
			<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem;min-width:140px;text-align:center;">
				<div style="font-size:2rem;font-weight:700;color:#2271b1;"><?php echo absint( $retention_days ); ?></div>
				<div style="color:#646970;"><?php esc_html_e( 'Retention Days', 'nvoos-graphify-ai-platform' ); ?></div>
			</div>
			<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem;min-width:140px;text-align:center;">
		...
		<h3><?php esc_html_e( 'About Telemetry', 'nvoos-graphify-ai-platform' ); ?></h3>
		<div style="background:#fff;border:1px solid #c3c4c7;padding:1rem 1.5rem;max-width:800px;">
			<p><?php esc_html_e( 'The measurement subsystem collects telemetry data from agent runs, tool executions, and chat interactions. This data powers dashboards, cost analysis, and performance monitoring. No personally identifiable information is collected.', 'nvoos-graphify-ai-platform' ); ?></p>
			<p><?php esc_html_e( 'Markup telemetry measures the structural distance between agent responses and canonical examples, providing a quantitative signal for response quality. Run Timeline visualises each agent execution as a span tree.', 'nvoos-graphify-ai-platform' ); ?></p>
		</div>
		<?php
	}
