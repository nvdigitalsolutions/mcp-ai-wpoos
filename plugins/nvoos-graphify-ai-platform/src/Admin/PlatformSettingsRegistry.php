 ...
 *
 * Owned by the NV Platform addon (NOT the Graphify core registry).
 * Subsystem sections register themselves here so they render under
 * the "NV Platform" top-level menu rather than under "NV Graphify".
 *
 * Pattern mirrored from NvoosGraphify\Admin\SettingsRegistry.
 *
 * @since 1.0.0
