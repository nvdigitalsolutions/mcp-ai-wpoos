...
/**
 * Schema constants — not instantiable.
 *
 * @since 1.0.0
 */
final class Schema
{
     ...
     *
     * AI-related settings (API keys, models, providers) are NOT in core
     * defaults. They are registered by AI addon plugins via the
    ...
    public static function defaultSettings(): array
    {
        ...
        /**
         * Filters the default settings for NV oOS Graphify.
         *
         * @since 1.0.0
