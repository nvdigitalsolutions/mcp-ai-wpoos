...
class SettingsPage {
	...
	public function registerSettings(): void {
		...
		add_settings_field( 'enabled', __( 'Enable Graphify', 'nvoos-graphify' ), array( $this, 'fieldEnabled' ), self::PAGE_SLUG, 'nvoos_graphify_general' );

		// --- Build section ---
		add_settings_section( 'nvoos_graphify_build', __( 'Build Settings', 'nvoos-graphify' ), '__return_false', self::PAGE_SLUG );
		add_settings_field( 'semantic_extraction', __( 'Semantic Extraction', 'nvoos-graphify' ), array( $this, 'fieldSemantic' ), self::PAGE_SLUG, 'nvoos_graphify_build' );
		add_settings_field( 'incremental_builds', __( 'Incremental Builds', 'nvoos-graphify' ), array( $this, 'fieldIncremental' ), self::PAGE_SLUG, 'nvoos_graphify_build' );
		add_settings_field( 'auto_rebuild', __( 'Auto-Rebuild on Save', 'nvoos-graphify' ), array( $this, 'fieldAutoRebuild' ), self::PAGE_SLUG, 'nvoos_graphify_build' );
		add_settings_field( 'rebuild_schedule', __( 'Scheduled Rebuild', 'nvoos-graphify' ), array( $this, 'fieldRebuildSchedule' ), self::PAGE_SLUG, 'nvoos_graphify_build' );
		add_settings_field( 'openai_api_key', __( 'OpenAI API Key (optional)', 'nvoos-graphify' ), array( $this, 'fieldOpenaiKey' ), self::PAGE_SLUG, 'nvoos_graphify_build' );
		...
		add_settings_field( 'remote_enrich_enabled', __( 'Enable Remote Enrichment', 'nvoos-graphify' ), array( $this, 'fieldRemoteEnrichEnabled' ), self::PAGE_SLUG, 'nvoos_graphify_remote' );
		add_settings_field( 'remote_enrich_budget', __( 'Enrichment Budget (nodes/run)', 'nvoos-graphify' ), array( $this, 'fieldRemoteEnrichBudget' ), self::PAGE_SLUG, 'nvoos_graphify_remote' );
		add_settings_field( 'remote_enrich_async', __( 'Async Enrichment', 'nvoos-graphify' ), array( $this, 'fieldRemoteEnrichAsync' ), self::PAGE_SLUG, 'nvoos_graphify_remote' );

		// --- Embeddings section ---
		add_settings_section( 'nvoos_graphify_embeddings', __( 'Embeddings', 'nvoos-graphify' ), '__return_false', self::PAGE_SLUG );
		add_settings_field( 'embeddings_enabled', __( 'Enable Embeddings', 'nvoos-graphify' ), array( $this, 'fieldEmbeddingsEnabled' ), self::PAGE_SLUG, 'nvoos_graphify_embeddings' );
		add_settings_field( 'embeddings_model', __( 'Embeddings Model', 'nvoos-graphify' ), array( $this, 'fieldEmbeddingsModel' ), self::PAGE_SLUG, 'nvoos_graphify_embeddings' );

		// --- Sources section (NV oOS bridge post types + external tables) ---
		add_settings_section( 'nvoos_graphify_sources_cpts', __( 'NV oOS Post Types', 'nvoos-graphify' ), array( $this, 'sectionSourcesCptsIntro' ), self::PAGE_SLUG );
		add_settings_field( 'nvoos_post_types', __( 'Indexed Post Types', 'nvoos-graphify' ), array( $this, 'fieldNvoosPostTypes' ), self::PAGE_SLUG, 'nvoos_graphify_sources_cpts' );

		add_settings_section( 'nvoos_graphify_sources_ext', __( 'NV oOS Internal Tables', 'nvoos-graphify' ), array( $this, 'sectionSourcesExtIntro' ), self::PAGE_SLUG );
		add_settings_field( 'nvoos_external_tables', __( 'Indexed Tables', 'nvoos-graphify' ), array( $this, 'fieldNvoosExternalTables' ), self::PAGE_SLUG, 'nvoos_graphify_sources_ext' );

		// --- Display section ---
		add_settings_section( 'nvoos_graphify_display', __( 'Display', 'nvoos-graphify' ), '__return_false', self::PAGE_SLUG );
		add_settings_field( 'schema_injection', __( 'Schema.org Injection', 'nvoos-graphify' ), array( $this, 'fieldSchema' ), self::PAGE_SLUG, 'nvoos_graphify_display' );
		add_settings_field( 'related_content', __( 'Related Content Widget', 'nvoos-graphify' ), array( $this, 'fieldRelated' ), self::PAGE_SLUG, 'nvoos_graphify_display' );
		add_settings_field( 'cytoscape_height', __( 'Graph Explorer Height', 'nvoos-graphify' ), array( $this, 'fieldHeight' ), self::PAGE_SLUG, 'nvoos_graphify_display' );
		add_settings_field( 'max_display_nodes', __( 'Max Explorer Nodes', 'nvoos-graphify' ), array( $this, 'fieldMaxNodes' ), self::PAGE_SLUG, 'nvoos_graphify_display' );
	}
		...
		<div class="wrap nvoos-graphify-admin">
			...
			<?php elseif ( 'remote' === $current_tab ) : ?>
				...
				<form method="post" action="options.php" style="margin-top:20px;">
					<?php
					settings_fields( 'nvoos_graphify_settings_group' );
					$this->doSettingsSectionsFiltered( self::PAGE_SLUG, array( 'nvoos_graphify_remote' ) );
			...
			<?php elseif ( 'embeddings' === $current_tab ) : ?>
				...
				<form method="post" action="options.php" style="margin-top:20px;">
					<?php
					settings_fields( 'nvoos_graphify_settings_group' );
					$this->doSettingsSectionsFiltered( self::PAGE_SLUG, array( 'nvoos_graphify_embeddings' ) );
