...
class WP_MCP_AI_Tool_Get_Unwatermarked_Images implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Get Unwatermarked Images tool requires the Image Production Toolkit to be enabled in plugin settings.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_name() {
		return __( 'Get Unwatermarked Images', 'nvoos-content-graph-pro' );
	}
	...
	public function get_description() {
		return __( 'Retrieves images that have not been watermarked (no `_is_watermarked` meta).', 'nvoos-content-graph-pro' );
	}
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'message' => sprintf(
				...
				__( 'Found %d unwatermarked image(s).', 'nvoos-content-graph-pro' ),
				count( $images )
			),
			'count'   => count( $images ),
			'images'  => $images,
