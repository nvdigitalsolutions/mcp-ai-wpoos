...
class WP_MCP_AI_Tool_Extract_Video_Metadata implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		...
		return __( 'Extract Video Metadata tool is not available.', 'nvoos-content-graph-pro' );
	}
	...
	public function get_name() {
		return __( 'Extract Video Metadata', 'nvoos-content-graph-pro' );
	}
	...
	public function get_description() {
		return __( 'Extract comprehensive video information including duration, resolution, codec, and bitrate.', 'nvoos-content-graph-pro' );
	}
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			'success' => true,
			'message' => __( 'Extract Video Metadata executed successfully. Note: Video processing requires FFmpeg.', 'nvoos-content-graph-pro' ),
		);
	}
}
