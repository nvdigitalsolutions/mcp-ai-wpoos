...
class Test_Healthcare_Wellness_Crud extends WP_UnitTestCase {
	...
	/**
	 * Standalone only: the init's tool filter must carry the sixty-seven
	 * ported wellness + vitals + imaging tools with the addon's file paths.
	 */
