...
class Test_Law_Firm_Data_Layer extends WP_UnitTestCase {
	 ...
	 * filter must carry the thirty-six matter-management + billing-trust +
	 * intake-management + litigation-support tools (the further law-firm tool
	 * batches land with the following sub-clusters), and the enqueue helper must load.
	 */
