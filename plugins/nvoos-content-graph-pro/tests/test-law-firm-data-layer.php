...
class Test_Law_Firm_Data_Layer extends WP_UnitTestCase {
	 ...
	 * filter must carry the forty-four matter-management + billing-trust +
	 * intake-management + litigation-support + compliance-ethics tools (the
	 * further law-firm tool batches land with the following sub-clusters), and
	 * the enqueue helper must load.
	 */
	public function test_init_gate_targets_standalone(): void {
		...
		$this->assertCount( 44, apply_filters( 'wp_mcp_ai_pro_tools', array() ) );
