...
class Test_CRE_Debt_Data_Layer extends WP_UnitTestCase {
	 ...
	 * filter must carry the eleven originations batch-1 tools (the further
	 * cre-debt tool batches land with the following sub-clusters), and the
	 * enqueue helper must load.
	 */
