...
class Test_CRE_Debt_Data_Layer extends WP_UnitTestCase {
	 ...
	 * filter must carry the twenty-four originations + underwriting tools (the
	 * further cre-debt tool batches land with the following sub-clusters), and
	...
	public function test_init_gate_targets_standalone(): void {
		...
		$this->assertCount( 24, apply_filters( 'wp_mcp_ai_pro_tools', array() ) );
