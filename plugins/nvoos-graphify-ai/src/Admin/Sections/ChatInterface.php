 ...
 * The actual chat logic lives in JS (graphify-ai-chat.js) which
 * talks to the REST endpoint at /nvoos-graphify/v1/ai/chat.
 *
 * @since 1.0.0
 */
class ChatInterface extends Section {
	...
	public function get_title(): string {
		return __( 'Chat Tester', 'nvoos-graphify-ai' );
	}
	...
	private function enqueueAssets(): void {
		...
		\wp_add_inline_script(
			'nvoos-graphify-ai-chat',
			'window.NvoosGraphifyAiChat = ' . \wp_json_encode(
				array(
		...
		<div id="nvoos-graphify-ai-chat-app" class="nvoos-chat-app">
			...
			<div id="nvoos-chat-messages" class="nvoos-chat-messages" role="log" aria-live="polite">
				<div class="nvoos-chat-empty">
					<?php echo \esc_html__( 'Send a message to test the AI. Your knowledge graph is available as context.', 'nvoos-graphify-ai' ); ?>
				</div>
			</div>
			...
			<div class="nvoos-chat-input-row">
				<textarea
					...
					rows="2"
					placeholder="<?php echo \esc_attr__( 'Type your message…', 'nvoos-graphify-ai' ); ?>"
					aria-label="<?php echo \esc_attr__( 'Chat message', 'nvoos-graphify-ai' ); ?>"
				></textarea>
				<button
					type="button"
					id="nvoos-chat-send"
				...
				>
					<?php echo \esc_html__( 'Send', 'nvoos-graphify-ai' ); ?>
				</button>
			</div>
		</div>
		<?php
