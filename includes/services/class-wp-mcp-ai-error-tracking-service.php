...
class WP_MCP_AI_Error_Tracking_Service {
	...
	public function track_error( $component, $message, $context = array() ) {
		...
		if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log -- error_log used as a WP_DEBUG-gated diagnostic logger; only executes when WP_DEBUG is explicitly enabled.
