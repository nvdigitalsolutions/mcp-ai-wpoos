...
class WP_MCP_AI_Memory_RRF_Fusion_Service {
	...
	protected static function query_bm25_cct( $query, $agent_id, $filters, $limit ) {
		...
		// phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- table name comes from a constant CCT slug + $wpdb->prefix; values are parameterised.
