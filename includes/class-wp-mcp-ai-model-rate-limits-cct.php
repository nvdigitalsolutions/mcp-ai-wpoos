	...
	public static function get_default_model_data() {
		return array(
			...
			array(
				...
				'notes'                     => 'GPT-5.4 - OpenAI flagship model (March 2026). 1M+ context window, native computer use, tool search, vision. $2.50/$15 per 1M tokens.',
			),
			array(
				...
				'notes'                     => 'GPT-5.4 Pro - Enterprise-grade GPT-5.4 variant (March 2026). 1M+ context, highest reasoning quality. $30/$180 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_output_tokens' => 0.015,
				'notes'                     => 'GPT-5.3 Codex - Specialized coding and software engineering agent. 922k context window. $3/$15 per 1M tokens.',
			),
			array(
				...
				'notes'                     => 'GPT-5.3 Codex Spark - Ultra-fast real-time coding model on Cerebras. 128k context window.',
			),
			array(
				'model_name'                => 'gpt-5.2',
				'provider'                  => 'openai',
				...
				'supports_function_calling' => true,
				'supports_vision'           => true,
				'cost_per_1k_input_tokens'  => 0.00175,
				'cost_per_1k_output_tokens' => 0.014,
				'notes'                     => 'GPT-5.2 with enhanced reasoning for coding, math, writing. 128k standard context.',
			),
			array(
				'model_name'                => 'gpt-5.1',
				'provider'                  => 'openai',
				...
				'notes'                     => 'GPT-5.1 general-purpose model with agentic coding tools.',
			),
			array(
				'model_name'                => 'gpt-5',
				'provider'                  => 'openai',
			...
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => true,
				'cost_per_1k_input_tokens'  => 0.021,
				'cost_per_1k_output_tokens' => 0.168,
				'notes'                     => 'Enhanced precision and intelligence for advanced enterprise needs. Research-grade quality.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00175,
				'cost_per_1k_output_tokens' => 0.014,
				'notes'                     => 'Optimized for agentic coding workflows and IDE integrations. Enhanced code generation.',
			),
			array(
			...
			// OpenAI GPT-5.2 Codex and GPT-5.1 Codex Series.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00175,
				'cost_per_1k_output_tokens' => 0.014,
				'notes'                     => 'GPT-5.2 Codex - Optimized for agentic coding and software engineering with 400K context.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00125,
				'cost_per_1k_output_tokens' => 0.01,
				'notes'                     => 'GPT-5.1 Codex - Standard coding model for programmable agents and software tasks.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00175,
				'cost_per_1k_output_tokens' => 0.014,
				'notes'                     => 'GPT-5.1 Codex Max - Long-horizon, power user version for extended coding tasks.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00025,
				'cost_per_1k_output_tokens' => 0.002,
				'notes'                     => 'GPT-5.1 Codex Mini - Cost-effective coding variant for lighter tasks.',
			),
			...
			// OpenAI GPT-4.1 Series - Tier 1 (Multimodal, Vision-Capable).
			array(
				'model_name'                => 'gpt-4.1',
				'provider'                  => 'openai',
				'tpm_limit'                 => 80000,
				...
				'cost_per_1k_output_tokens' => 0.018,
				'fallback_model'            => 'gpt-4.1-mini',
				'notes'                     => 'GPT-4.1 multimodal model with vision capabilities.',
			),
			array(
				...
				'notes'                     => 'Cost-effective GPT-4.1 Mini variant.',
			),
			array(
				...
				'fallback_model'            => 'gpt-4.1-mini',
				'notes'                     => 'Lightweight GPT-4.1 Nano for high-throughput tasks.',
			),
			array(
				...
				'notes'                     => 'GPT-4.1 Turbo with enhanced performance.',
			),
			array(
				...
				'cost_per_1k_output_tokens' => 0.018,
				'fallback_model'            => 'gpt-4.1',
				'notes'                     => 'GPT-4.1 (Apr 2025) dated snapshot.',
			),
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.002,
				'cost_per_1k_output_tokens' => 0.012,
				'notes'                     => 'Gemini 3 Pro (Preview) - Latest generation with 1M token context. Advanced reasoning and multimodal understanding. $2-4/$12-18 per 1M (varies by context size).',
			),
			array(
				...
				'notes'                     => 'Gemini 3 Flash (Preview) - Fastest with 1M context, strong multimodal search and grounding. $0.50-1/$3 per 1M tokens.',
			),
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00125,
				'cost_per_1k_output_tokens' => 0.01,
				'notes'                     => 'Gemini 2.5 Pro - Best for complex reasoning and agentic workflows. 1M context window.',
			),
			array(
				...
				'notes'                     => 'Gemini 2.5 Flash (Recommended). Fast, high-volume processing. Best performance/cost ratio.',
			),
			array(
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0004,
				'notes'                     => 'Gemini 2.0 Flash. Efficient coding and reasoning. 1M context window.',
			),
			array(
			...
			// Anthropic Claude 4.6 Series - 2026 Models (Latest).
			array(
				...
				'notes'                     => 'Claude Opus 4.6 (Flagship, Feb 2026). 1M token context with 76% accuracy at full length. Agent teams, adaptive thinking. API/Claude Code only.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.003,
				'cost_per_1k_output_tokens' => 0.012,
				'notes'                     => 'Claude Sonnet 4.6 (Recommended, 2026). Speed-optimized with 1M context. Strong for production and autonomous agents.',
			),

			// Anthropic Claude 4.5 Series - 2025 Models.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.003,
				'cost_per_1k_output_tokens' => 0.015,
				'notes'                     => 'Claude Sonnet 4.5 (Legacy). Exceptional coding and agentic tasks. 200k context.',
			),
			array(
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Gemma 4 via Ollama. Google\'s latest multimodal open model with 256K context.',
			),
			array(
				'model_name'                => 'gemma2',
				'tpm_limit'                 => 0,
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Gemma 4 31B Dense via LM Studio. Google\'s flagship multimodal open model with 256K context.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Gemma 4 26B MoE via LM Studio. Efficient multimodal model with 256K context.',
			),
			...
			// Cloudflare Workers AI - Serverless AI at the Edge (10,000 neurons/day free).
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => false,
				'cost_per_1k_input_tokens'  => 0.000293,
				'cost_per_1k_output_tokens' => 0.002253,
				'notes'                     => 'Llama 3.3 70B via Cloudflare Workers AI. Fast 8-bit quantized inference at edge.',
			),
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => false,
				'cost_per_1k_input_tokens'  => 0.000051,
				'cost_per_1k_output_tokens' => 0.000335,
				'notes'                     => 'Llama 3.2 3B via Cloudflare. Ultra-fast, cost-efficient edge inference.',
			),
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => false,
				'cost_per_1k_input_tokens'  => 0.000027,
				'cost_per_1k_output_tokens' => 0.000201,
				'notes'                     => 'Llama 3.2 1B via Cloudflare. Smallest, fastest model for simple tasks.',
			),
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => false,
				'cost_per_1k_input_tokens'  => 0.000351,
				'cost_per_1k_output_tokens' => 0.000555,
				'notes'                     => 'Mistral Small 3.1 24B via Cloudflare. Efficient 24B model with strong performance.',
			),
			array(
				...
				'supports_function_calling' => true,
				'supports_vision'           => false,
				'cost_per_1k_input_tokens'  => 0.000497,
				'cost_per_1k_output_tokens' => 0.004881,
				'notes'                     => 'DeepSeek R1 Distill Qwen 32B via Cloudflare. Advanced reasoning model at edge.',
			),

			// WebLLM - Browser-based cached models (runs locally in browser, zero cost).
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Llama 3.1 8B in-browser via WebLLM. Runs locally with WebGPU, cached for offline use.',
			),
			array(
				'model_name'                => 'Mistral-7B-Instruct-v0.3-q4f16_1-MLC',
				'provider'                  => 'webllm',
				'tpm_limit'                 => 0,
				'rpm_limit'                 => 0,
				'context_window'            => 32768,
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Mistral 7B v0.3 in-browser via WebLLM. Fast, private inference in browser.',
			),
			array(
				'model_name'                => 'gemma-2-2b-it-q4f16_1-MLC',
				'provider'                  => 'webllm',
				'tpm_limit'                 => 0,
				'rpm_limit'                 => 0,
				'context_window'            => 8192,
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Gemma 2 2B in-browser via WebLLM. Compact Google model for client-side AI.',
			),
			array(
				'model_name'                => 'Qwen2.5-7B-Instruct-q4f16_1-MLC',
				'provider'                  => 'webllm',
				'tpm_limit'                 => 0,
				'rpm_limit'                 => 0,
				'context_window'            => 32768,
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Qwen 2.5 7B in-browser via WebLLM. Multilingual model with browser caching.',
			),
			array(
				'model_name'                => 'Phi-3.5-mini-instruct-q4f16_1-MLC',
				'provider'                  => 'webllm',
				'tpm_limit'                 => 0,
				'rpm_limit'                 => 0,
				'context_window'            => 128000,
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Phi-3.5 Mini in-browser via WebLLM. Microsoft SLM optimized for browser execution.',
			),

			// ──────────────────────────────────────────────────────────────────
			// NVIDIA NIM Models (via integrate.api.nvidia.com).
			// Comprehensive catalog sourced from build.nvidia.com.
			// ──────────────────────────────────────────────────────────────────

			// Meta Llama 3.x Family (Function Calling).
			array(
				...
				'notes'                     => 'Llama 3.3 70B Instruct - Meta flagship 70B on NVIDIA NIM. 128K context, function calling. $0.40/$1.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.002,
				'cost_per_1k_output_tokens' => 0.006,
				'notes'                     => 'Llama 3.1 405B Instruct - Largest open-source LLM on NVIDIA NIM. 128K context. $2/$6 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0004,
				'cost_per_1k_output_tokens' => 0.0016,
				'notes'                     => 'Llama 3.1 70B Instruct - Versatile 70B model on NVIDIA NIM. 128K context, function calling. $0.40/$1.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Llama 3.1 8B Instruct - Budget-friendly 8B model on NVIDIA NIM. 128K context, high throughput. $0.10/$0.30 per 1M tokens.',
			),
			...
			array(
				...
				'notes'                     => 'Llama 3.2 3B Instruct - Lightweight model on NVIDIA NIM. 128K context. $0.06/$0.18 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_output_tokens' => 0.00012,
				'notes'                     => 'Llama 3.2 1B Instruct - Ultra-fast smallest Llama on NVIDIA NIM. 128K context. $0.04/$0.12 per 1M tokens.',
			),
			...
			array(
				...
				'cost_per_1k_output_tokens' => 0.0036,
				'notes'                     => 'Llama 3.2 90B Vision Instruct - Multimodal vision model on NVIDIA NIM. Image+text understanding. $1.20/$3.60 per 1M tokens.',
			),
			array(
				...
				'supports_vision'           => true,
				'cost_per_1k_input_tokens'  => 0.00015,
				'cost_per_1k_output_tokens' => 0.00045,
				'notes'                     => 'Llama 3.2 11B Vision Instruct - Compact multimodal model on NVIDIA NIM. Image+text. $0.15/$0.45 per 1M tokens.',
			),
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0005,
				'cost_per_1k_output_tokens' => 0.002,
				'notes'                     => 'Llama 4 Maverick 17Bx128E Instruct - MoE multimodal model on NVIDIA NIM. 1M context, vision. $0.50/$2 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_output_tokens' => 0.001,
				'notes'                     => 'Llama 4 Scout 17Bx16E Instruct - MoE model on NVIDIA NIM. 1M context, vision-capable. $0.27/$1 per 1M tokens.',
			),
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0005,
				'cost_per_1k_output_tokens' => 0.002,
				'notes'                     => 'Nemotron 70B Instruct - NVIDIA custom-trained on Llama 3.1. Strong reasoning. $0.50/$2 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0015,
				'cost_per_1k_output_tokens' => 0.005,
				'notes'                     => 'Nemotron 3 Super 120B (MoE) - NVIDIA flagship MoE model. 1M context window, advanced reasoning. $1.50/$5 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.001,
				'notes'                     => 'Nemotron 3 Nano 30B (MoE) - Efficient MoE model. 1M context, fast inference. $0.30/$1 per 1M tokens.',
			),

			// Mistral AI Models on NVIDIA NIM.
			array(
				...
				'notes'                     => 'Mistral Large 2 Instruct - Premium Mistral model on NVIDIA NIM. 128K context. $0.80/$2.40 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0004,
				'cost_per_1k_output_tokens' => 0.0012,
				'notes'                     => 'Mixtral 8x22B Instruct v0.1 - MoE model on NVIDIA NIM. 64K context. $0.40/$1.20 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Mixtral 8x7B Instruct v0.1 - Efficient MoE model on NVIDIA NIM. 32K context. $0.20/$0.60 per 1M tokens.',
			),
			array(
				'model_name'                => 'mistralai/mistral-7b-instruct-v0.3',
				'provider'                  => 'nvidia',
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Mistral 7B Instruct v0.3 - Budget Mistral model on NVIDIA NIM. 32K context. $0.10/$0.30 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Mistral Small 24B Instruct (Jan 2025) - Efficient instruct model on NVIDIA NIM. $0.20/$0.60 per 1M tokens.',
			),

			// Microsoft Phi-3 Models on NVIDIA NIM.
			// Phi-3 models do not support function calling (tools parameter) on NVIDIA NIM.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Phi-3 Medium 128K Instruct - Microsoft 14B model on NVIDIA NIM. 128K context. No tool support. $0.20/$0.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Phi-3 Medium 4K Instruct - Microsoft 14B model on NVIDIA NIM. 4K context. No tool support. $0.20/$0.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Phi-3 Mini 128K Instruct - Compact Microsoft model on NVIDIA NIM. 128K context. No tool support. $0.10/$0.30 per 1M tokens.',
			),
			array(
				'model_name'                => 'microsoft/phi-3-mini-4k-instruct',
				'provider'                  => 'nvidia',
				...
				'notes'                     => 'Phi-3 Mini 4K Instruct - Ultra-fast compact model on NVIDIA NIM. 4K context. No tool support. $0.08/$0.24 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00015,
				'cost_per_1k_output_tokens' => 0.00045,
				'notes'                     => 'Phi-3 Small 128K Instruct - Mid-size Microsoft model on NVIDIA NIM. 128K context. No tool support. $0.15/$0.45 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Phi-3 Small 8K Instruct - Microsoft model on NVIDIA NIM. 8K context, fast inference. No tool support. $0.10/$0.30 per 1M tokens.',
			),

			// Google Gemma 2 Models (Legacy) on NVIDIA NIM.
			// Gemma models do not support function calling (tools parameter) on NVIDIA NIM.
			array(
				'model_name'                => 'google/gemma-2-27b-it',
				'provider'                  => 'nvidia',
				'tpm_limit'                 => 100000,
				...
				'notes'                     => 'Gemma 2 27B IT - Google 27B model on NVIDIA NIM. 8K context. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				'model_name'                => 'google/gemma-2-9b-it',
				'provider'                  => 'nvidia',
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Gemma 2 9B IT - Google compact model on NVIDIA NIM. 8K context. No tool support. $0.10/$0.30 per 1M tokens.',
			),
			array(
				'model_name'                => 'google/gemma-2-2b-it',
				'provider'                  => 'nvidia',
				...
				'cost_per_1k_input_tokens'  => 0.00004,
				'cost_per_1k_output_tokens' => 0.00012,
				'notes'                     => 'Gemma 2 2B IT - Ultra-compact Google model on NVIDIA NIM. 8K context. No tool support. $0.04/$0.12 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'CodeGemma 7B - Google code-focused model on NVIDIA NIM. 8K context. No tool support. $0.10/$0.30 per 1M tokens.',
			),

			// Google Gemma 4 Models (Multimodal, Apache 2.0) on NVIDIA NIM.
			// Gemma 4 models support multimodal input on NVIDIA NIM.
			array(
				'model_name'                => 'google/gemma-4-31b-it',
				'provider'                  => 'nvidia',
				'tpm_limit'                 => 100000,
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.0009,
				'notes'                     => 'Gemma 4 31B Dense - Google flagship multimodal model on NVIDIA NIM. 256K context, vision. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				'model_name'                => 'google/gemma-4-26b-it',
				'provider'                  => 'nvidia',
				...
				'cost_per_1k_input_tokens'  => 0.00015,
				'cost_per_1k_output_tokens' => 0.00045,
				'notes'                     => 'Gemma 4 26B MoE - Efficient multimodal model on NVIDIA NIM. 256K context, vision. No tool support. $0.15/$0.45 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00008,
				'cost_per_1k_output_tokens' => 0.00024,
				'notes'                     => 'Gemma 4 E4B - Edge/mobile multimodal model on NVIDIA NIM. 128K context, vision. No tool support. $0.08/$0.24 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00004,
				'cost_per_1k_output_tokens' => 0.00012,
				'notes'                     => 'Gemma 4 E2B - Ultra-compact multimodal model on NVIDIA NIM. 128K context, vision. No tool support. $0.04/$0.12 per 1M tokens.',
			),

			// Google Gemma 3 Models (Multimodal) on NVIDIA NIM.
			// Gemma 3 models do not support function calling (tools parameter) on NVIDIA NIM.
			// NVIDIA NIM enforces max_tokens <= 4096 for Gemma models.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.0009,
				'notes'                     => 'Gemma 3 27B IT - Google multimodal model on NVIDIA NIM. 128K context, vision. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00015,
				'cost_per_1k_output_tokens' => 0.00045,
				'notes'                     => 'Gemma 3 12B IT - Google mid-size multimodal model on NVIDIA NIM. 128K context, vision. No tool support. $0.15/$0.45 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00008,
				'cost_per_1k_output_tokens' => 0.00024,
				'notes'                     => 'Gemma 3 4B IT - Compact Google multimodal model on NVIDIA NIM. 128K context, vision. No tool support. $0.08/$0.24 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00004,
				'cost_per_1k_output_tokens' => 0.00012,
				'notes'                     => 'Gemma 3 1B IT - Smallest Gemma 3 model on NVIDIA NIM. 32K context. No tool support. $0.04/$0.12 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00006,
				'cost_per_1k_output_tokens' => 0.00018,
				'notes'                     => 'Gemma 3n E4B IT - Edge/mobile optimized model on NVIDIA NIM. 32K context. No tool support. $0.06/$0.18 per 1M tokens.',
			),

			// Qwen 2.5 Models on NVIDIA NIM.
			// Qwen 2.5 models do not support function calling (tools parameter) on NVIDIA NIM.
			array(
				'model_name'                => 'qwen/qwen2.5-72b-instruct',
				'provider'                  => 'nvidia',
				'tpm_limit'                 => 80000,
				...
				'cost_per_1k_input_tokens'  => 0.0005,
				'cost_per_1k_output_tokens' => 0.0015,
				'notes'                     => 'Qwen 2.5 72B Instruct - Alibaba flagship model on NVIDIA NIM. 128K context. No tool support. $0.50/$1.50 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.0009,
				'notes'                     => 'Qwen 2.5 32B Instruct - Mid-size Qwen model on NVIDIA NIM. 128K context. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Qwen 2.5 14B Instruct - Balanced Qwen model on NVIDIA NIM. 128K context. No tool support. $0.20/$0.60 per 1M tokens.',
			),
			array(
				'model_name'                => 'qwen/qwen2.5-7b-instruct',
				'provider'                  => 'nvidia',
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Qwen 2.5 7B Instruct - Budget Qwen model on NVIDIA NIM. 128K context. No tool support. $0.10/$0.30 per 1M tokens.',
			),

			// Qwen 3 Models (Dense + MoE, Thinking) on NVIDIA NIM.
			// Qwen 3 models do not support function calling (tools parameter) on NVIDIA NIM.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0008,
				'cost_per_1k_output_tokens' => 0.0024,
				'notes'                     => 'Qwen 3 235B A22B (MoE) - Largest Qwen 3 model on NVIDIA NIM. Thinking mode. No tool support. $0.80/$2.40 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.0009,
				'notes'                     => 'Qwen 3 32B (Dense) - Strong reasoning model on NVIDIA NIM. Thinking mode. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Qwen 3 30B A3B (MoE) - Efficient MoE model on NVIDIA NIM. Thinking mode. No tool support. $0.10/$0.30 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'Qwen 3 14B (Dense) - Mid-size Qwen 3 on NVIDIA NIM. Thinking mode. No tool support. $0.20/$0.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Qwen 3 8B (Dense) - Budget-friendly Qwen 3 on NVIDIA NIM. Thinking mode. No tool support. $0.10/$0.30 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00006,
				'cost_per_1k_output_tokens' => 0.00018,
				'notes'                     => 'Qwen 3 4B (Dense) - Smallest Qwen 3 on NVIDIA NIM. Thinking mode. $0.06/$0.18 per 1M tokens.',
			),

			// Qwen 3.5 Models (Latest, Vision + MoE) on NVIDIA NIM.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0015,
				'cost_per_1k_output_tokens' => 0.005,
				'notes'                     => 'Qwen 3.5 397B A17B (VLM, MoE) - Largest Qwen 3.5 on NVIDIA NIM. Vision+language. $1.50/$5 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0005,
				'cost_per_1k_output_tokens' => 0.0015,
				'notes'                     => 'Qwen 3.5 122B A10B (MoE) - Advanced Qwen 3.5 on NVIDIA NIM. 128K context. No tool support. $0.50/$1.50 per 1M tokens.',
			),

			// Qwen 3 Specialized Models on NVIDIA NIM.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.002,
				'cost_per_1k_output_tokens' => 0.006,
				'notes'                     => 'Qwen 3 Coder 480B A35B (MoE) - Specialized coding model on NVIDIA NIM. 256K context. $2/$6 per 1M tokens.',
			),

			// DeepSeek Models (Reasoning) on NVIDIA NIM.
			// DeepSeek reasoning models do not support function calling (tools parameter) on NVIDIA NIM.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.001,
				'cost_per_1k_output_tokens' => 0.003,
				'notes'                     => 'DeepSeek R1 - Advanced reasoning model on NVIDIA NIM. Chain-of-thought. No tool support. $1/$3 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0004,
				'cost_per_1k_output_tokens' => 0.0012,
				'notes'                     => 'DeepSeek R1 Distill Llama 70B - Reasoning-distilled Llama 70B on NVIDIA NIM. No tool support. $0.40/$1.20 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'DeepSeek R1 Distill Llama 8B - Budget reasoning model on NVIDIA NIM. No tool support. $0.10/$0.30 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0003,
				'cost_per_1k_output_tokens' => 0.0009,
				'notes'                     => 'DeepSeek R1 Distill Qwen 32B - Reasoning-distilled Qwen on NVIDIA NIM. No tool support. $0.30/$0.90 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0002,
				'cost_per_1k_output_tokens' => 0.0006,
				'notes'                     => 'DeepSeek R1 Distill Qwen 14B - Mid-size reasoning model on NVIDIA NIM. No tool support. $0.20/$0.60 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'DeepSeek R1 Distill Qwen 7B - Budget reasoning model on NVIDIA NIM. No tool support. $0.10/$0.30 per 1M tokens.',
			),

			// IBM Granite Code Models on NVIDIA NIM.
			// Granite models do not support function calling (tools parameter) on NVIDIA NIM.
			// Note: ibm/granite-34b-code-instruct has been deprecated and may return 404 from the API.
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0004,
				'cost_per_1k_output_tokens' => 0.0012,
				'notes'                     => 'Granite 34B Code Instruct - IBM code model on NVIDIA NIM. Deprecated; may return 404. No tool support. $0.40/$1.20 per 1M tokens.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0.0001,
				'cost_per_1k_output_tokens' => 0.0003,
				'notes'                     => 'Granite 8B Code Instruct - IBM compact code model on NVIDIA NIM. No tool support. $0.10/$0.30 per 1M tokens.',
			),

			// Databricks DBRX on NVIDIA NIM.
			array(
				...
				'cost_per_1k_output_tokens' => 0.0018,
				'notes'                     => 'DBRX Instruct (132B MoE) - Databricks MoE model on NVIDIA NIM. 32K context. No tool support. $0.60/$1.80 per 1M tokens.',
			),

			// MiniMax Models on NVIDIA NIM.
			array(
				'model_name'                => 'minimax/minimax-m1-80k',
				'provider'                  => 'nvidia',
				'tpm_limit'                 => 80000,
				'rpm_limit'                 => 800,
				...
				'cost_per_1k_input_tokens'  => 0.0004,
				'cost_per_1k_output_tokens' => 0.0012,
				'notes'                     => 'MiniMax M1 80K - MiniMax model on NVIDIA NIM. 80K context window. No tool support. $0.40/$1.20 per 1M tokens.',
			),
		);
	}
}
