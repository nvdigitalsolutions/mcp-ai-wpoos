...
'cost_per_1k_input_tokens'  => 0.0002,
'cost_per_1k_output_tokens' => 0.0006,
'notes'                     => 'Phi-3 Medium 128K Instruct - Microsoft 14B model on NVIDIA NIM. 128K context. $0.20/$0.60 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0002,
'cost_per_1k_output_tokens' => 0.0006,
'notes'                     => 'Phi-3 Medium 4K Instruct - Microsoft 14B model on NVIDIA NIM. 4K context. $0.20/$0.60 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Phi-3 Mini 128K Instruct - Compact Microsoft model on NVIDIA NIM. 128K context. $0.10/$0.30 per 1M tokens.',
),
array(
'model_name'                => 'microsoft/phi-3-mini-4k-instruct',
'provider'                  => 'nvidia',
...
'notes'                     => 'Phi-3 Mini 4K Instruct - Ultra-fast compact model on NVIDIA NIM. 4K context. $0.08/$0.24 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.00015,
'cost_per_1k_output_tokens' => 0.00045,
'notes'                     => 'Phi-3 Small 128K Instruct - Mid-size Microsoft model on NVIDIA NIM. 128K context. $0.15/$0.45 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Phi-3 Small 8K Instruct - Microsoft model on NVIDIA NIM. 8K context, fast inference. $0.10/$0.30 per 1M tokens.',
),
...
'notes'                     => 'Gemma 2 27B IT - Google 27B model on NVIDIA NIM. 8K context. $0.30/$0.90 per 1M tokens.',
),
array(
'model_name'                => 'google/gemma-2-9b-it',
'provider'                  => 'nvidia',
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Gemma 2 9B IT - Google compact model on NVIDIA NIM. 8K context. $0.10/$0.30 per 1M tokens.',
),
array(
'model_name'                => 'google/gemma-2-2b-it',
'provider'                  => 'nvidia',
...
'cost_per_1k_input_tokens'  => 0.00004,
'cost_per_1k_output_tokens' => 0.00012,
'notes'                     => 'Gemma 2 2B IT - Ultra-compact Google model on NVIDIA NIM. 8K context. $0.04/$0.12 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'CodeGemma 7B - Google code-focused model on NVIDIA NIM. 8K context. $0.10/$0.30 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.0003,
'cost_per_1k_output_tokens' => 0.0009,
'notes'                     => 'Gemma 3 27B IT - Google multimodal model on NVIDIA NIM. 128K context, vision. $0.30/$0.90 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.00015,
'cost_per_1k_output_tokens' => 0.00045,
'notes'                     => 'Gemma 3 12B IT - Google mid-size multimodal model on NVIDIA NIM. 128K context, vision. $0.15/$0.45 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.00008,
'cost_per_1k_output_tokens' => 0.00024,
'notes'                     => 'Gemma 3 4B IT - Compact Google multimodal model on NVIDIA NIM. 128K context, vision. $0.08/$0.24 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.00004,
'cost_per_1k_output_tokens' => 0.00012,
'notes'                     => 'Gemma 3 1B IT - Smallest Gemma 3 model on NVIDIA NIM. 32K context. $0.04/$0.12 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.00006,
'cost_per_1k_output_tokens' => 0.00018,
'notes'                     => 'Gemma 3n E4B IT - Edge/mobile optimized model on NVIDIA NIM. 32K context. $0.06/$0.18 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.0005,
'cost_per_1k_output_tokens' => 0.0015,
'notes'                     => 'Qwen 2.5 72B Instruct - Alibaba flagship model on NVIDIA NIM. 128K context. $0.50/$1.50 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0003,
'cost_per_1k_output_tokens' => 0.0009,
'notes'                     => 'Qwen 2.5 32B Instruct - Mid-size Qwen model on NVIDIA NIM. 128K context. $0.30/$0.90 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0002,
'cost_per_1k_output_tokens' => 0.0006,
'notes'                     => 'Qwen 2.5 14B Instruct - Balanced Qwen model on NVIDIA NIM. 128K context. $0.20/$0.60 per 1M tokens.',
),
array(
'model_name'                => 'qwen/qwen2.5-7b-instruct',
'provider'                  => 'nvidia',
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Qwen 2.5 7B Instruct - Budget Qwen model on NVIDIA NIM. 128K context. $0.10/$0.30 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.0008,
'cost_per_1k_output_tokens' => 0.0024,
'notes'                     => 'Qwen 3 235B A22B (MoE) - Largest Qwen 3 model on NVIDIA NIM. Thinking mode. $0.80/$2.40 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0003,
'cost_per_1k_output_tokens' => 0.0009,
'notes'                     => 'Qwen 3 32B (Dense) - Strong reasoning model on NVIDIA NIM. Thinking mode. $0.30/$0.90 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Qwen 3 30B A3B (MoE) - Efficient MoE model on NVIDIA NIM. Thinking mode. $0.10/$0.30 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0002,
'cost_per_1k_output_tokens' => 0.0006,
'notes'                     => 'Qwen 3 14B (Dense) - Mid-size Qwen 3 on NVIDIA NIM. Thinking mode. $0.20/$0.60 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Qwen 3 8B (Dense) - Budget-friendly Qwen 3 on NVIDIA NIM. Thinking mode. $0.10/$0.30 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0005,
'cost_per_1k_output_tokens' => 0.0015,
'notes'                     => 'Qwen 3.5 122B A10B (MoE) - Advanced Qwen 3.5 on NVIDIA NIM. 128K context. $0.50/$1.50 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.001,
'cost_per_1k_output_tokens' => 0.003,
'notes'                     => 'DeepSeek R1 - Advanced reasoning model on NVIDIA NIM. Chain-of-thought. $1/$3 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0004,
'cost_per_1k_output_tokens' => 0.0012,
'notes'                     => 'DeepSeek R1 Distill Llama 70B - Reasoning-distilled Llama 70B on NVIDIA NIM. $0.40/$1.20 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'DeepSeek R1 Distill Llama 8B - Budget reasoning model on NVIDIA NIM. $0.10/$0.30 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0003,
'cost_per_1k_output_tokens' => 0.0009,
'notes'                     => 'DeepSeek R1 Distill Qwen 32B - Reasoning-distilled Qwen on NVIDIA NIM. $0.30/$0.90 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0002,
'cost_per_1k_output_tokens' => 0.0006,
'notes'                     => 'DeepSeek R1 Distill Qwen 14B - Mid-size reasoning model on NVIDIA NIM. $0.20/$0.60 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'DeepSeek R1 Distill Qwen 7B - Budget reasoning model on NVIDIA NIM. $0.10/$0.30 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.0004,
'cost_per_1k_output_tokens' => 0.0012,
'notes'                     => 'Granite 34B Code Instruct - IBM code model on NVIDIA NIM. Optimized for coding tasks. $0.40/$1.20 per 1M tokens.',
),
array(
...
'cost_per_1k_input_tokens'  => 0.0001,
'cost_per_1k_output_tokens' => 0.0003,
'notes'                     => 'Granite 8B Code Instruct - IBM compact code model on NVIDIA NIM. $0.10/$0.30 per 1M tokens.',
),
...
'notes'                     => 'DBRX Instruct (132B MoE) - Databricks MoE model on NVIDIA NIM. 32K context. $0.60/$1.80 per 1M tokens.',
),
...
'cost_per_1k_input_tokens'  => 0.0004,
'cost_per_1k_output_tokens' => 0.0012,
'notes'                     => 'MiniMax M1 80K - MiniMax model on NVIDIA NIM. 80K context window. $0.40/$1.20 per 1M tokens.',
),
);
}
}
