...
class WP_MCP_AI_Model_Rate_Limits_CCT {
	...
	protected static function get_default_model_data() {
		return array(
			...
			// LM Studio Models (local deployment, no API rate limits).
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'IBM Granite 4.0-H-Tiny via LM Studio. Hybrid Mamba-2/Transformer MoE architecture. Supports function calling with OpenAI schema. 7B total params, 1B active.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'Qwen3 Coder 30B via LM Studio. MoE model with 256K context, extendable to 1M. Native tool calling for agentic coding workflows. 30.5B total params, 3.3B active.',
			),
			array(
				...
				'cost_per_1k_input_tokens'  => 0,
				'cost_per_1k_output_tokens' => 0,
				'notes'                     => 'OpenAI GPT-OSS 20B via LM Studio. Open-weight MoE model with 131K context. Native function calling and tool use. Apache 2.0 license. 21B total params, 3.6B active.',
			),
		);
	}
}
