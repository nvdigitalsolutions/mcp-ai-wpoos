	...
	public static function get_default_model_data() {
		return array(
			...
			array(
				...
				'cost_per_1k_input_tokens'  => 0.00125,
				'cost_per_1k_output_tokens' => 0.01,
				'notes'                     => 'GPT-5.0 base model with configurable reasoning.',
			),
			array(
				'model_name'                => 'gpt-5',
				'provider'                  => 'openai',
			...
			array(
				...
				'notes'                     => 'Gemini 3 Pro - Latest generation with 1M token context. Advanced reasoning and multimodal understanding. $2-4/$12-18 per 1M (varies by context size).',
			),
			array(
				...
				'notes'                     => 'Gemini 3 Flash - Fastest with 1M context, strong multimodal search and grounding. $0.50-1/$3 per 1M tokens.',
			),
