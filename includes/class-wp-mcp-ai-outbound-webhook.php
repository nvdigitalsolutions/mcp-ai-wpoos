 ...
 *
 * Manages outbound webhook subscriptions and dispatches signed HTTP POST
 * notifications to registered subscribers when plugin events occur.
 *
 * @package WP_MCP_AI
 * @since   2.2.0
 ...
 * @since 2.2.0
 */
class WP_MCP_AI_Outbound_Webhook {

	/**
	 * Option key for subscription storage.
	 */
	 ...
	 * Singleton instance.
	 *
	 * @var WP_MCP_AI_Outbound_Webhook|null
	 */
	 ...
	 * @return void
	 */
	private function save_subscriptions( array $subscriptions ) {
