		...
		if ( $components_available && ( $needs_vectorizer || $needs_knowledge_base ) ) {
			...
			?>
				...
				/* translators: placeholder */
											errorP.innerHTML = <?php echo wp_json_encode( sprintf( __( 'Download failed. Please try again or manage your data on the <a href="%s">Data Management</a> page.', 'mcp-ai-wpoos' ), esc_url( admin_url( 'admin.php?page=wp-mcp-ai-dashboard&tab=advanced&subtab=data_management' ) ) ) ); ?>; // phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment -- Placeholder meaning is self-evident from context.
