...
class WP_MCP_AI_REST_Profiles_Controller {
	...
	public function register_routes() {
		...
		register_rest_route( $namespace, '/profiles/(?P<name>[a-z0-9_-]+)', array(
			array(
				'methods'             => WP_REST_Server::READABLE,
		...
		register_rest_route( $namespace, '/profiles/(?P<name>[a-z0-9_-]+)/tools', array(
			array(
				'methods'             => WP_REST_Server::READABLE,
	...
	public function list_profiles() {
		...
		return array( 'success' => true, 'message' => '', 'data' => array( 'profiles' => $profiles ) );
	}
	...
	public function get_profile( $request ) {
		...
		return array( 'success' => true, 'message' => '', 'data' => $profile );
	}
	...
	public function get_profile_tools( $request ) {
		...
		if ( ! class_exists( 'WP_MCP_AI_Tool_Registry' ) ) {
			return array( 'success' => true, 'message' => '', 'data' => array( 'tools' => array() ) );
		}
		...
		return array( 'success' => true, 'message' => '', 'data' => array( 'tools' => $filtered ) );
	}
}
