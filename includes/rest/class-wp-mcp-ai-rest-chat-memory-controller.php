...
class WP_MCP_AI_REST_Chat_Memory_Controller extends WP_MCP_AI_REST_Controller_Base {
	 ...
	 *
	 * Hooked to `wp_mcp_ai_chat_memory_enabled`. When the admin has disabled
	 * the feature via Orchestration → Settings, this overrides the per-user
	 * preference and returns `false` for every user.
	 *
