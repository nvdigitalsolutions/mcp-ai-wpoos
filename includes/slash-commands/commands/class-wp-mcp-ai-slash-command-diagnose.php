...
/**
 * Class WP_MCP_AI_Slash_Command_Diagnose
 *
 * @since 2.1.0
 */
class WP_MCP_AI_Slash_Command_Diagnose {
	...
	public function execute( $args, $flags, $context ) {
		...
		if ( ! user_can( $user_id, 'manage_options' ) ) {
			return new WP_Error( 'insufficient_capability', __( 'manage_options capability is required to run /diagnose.', 'mcp-ai-wpoos' ) );
		}
