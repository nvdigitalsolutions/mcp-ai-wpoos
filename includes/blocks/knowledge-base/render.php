...
/**
 * Renders the `wp-mcp-ai/knowledge-base` block on the server.
 *
 ...
 */
function wp_mcp_ai_render_knowledge_base_block( $attributes, $content = '', $block = null ) {
	...
	if ( null !== $block && function_exists( 'get_block_wrapper_attributes' ) ) {
		...
		$wrapper_attributes = sprintf(
			'class="wp-block-wp-mcp-ai-knowledge-base" data-block-id="%s" data-allowed-types="%s" data-max-files="%s" data-max-size="%s" data-nonce="%s" data-upload-url="%s"',
			esc_attr( $unique_id ),
