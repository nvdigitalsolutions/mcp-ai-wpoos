 ...
 * Prompt Cue Library.
 */
class WP_MCP_AI_Prompt_Cue_Library {

	/**
	 * Singleton instance.
	 *
	 * @var WP_MCP_AI_Prompt_Cue_Library|null
	 */
	 ...
	 * Get the singleton.
	 *
	 * @return WP_MCP_AI_Prompt_Cue_Library
	 */
	...
	private function maybe_seed() {
		 ...
		 *
		 * @param WP_MCP_AI_Prompt_Cue_Library $library Library instance.
		 */
