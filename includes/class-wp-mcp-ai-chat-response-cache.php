 ...
 * @since 1.5.0
 */
class WP_MCP_AI_Chat_Response_Cache {
	 ...
	 */
	public function set_cached_response( array $messages, array $options, array $response ) {
		if ( ! $this->is_cacheable( $options ) ) {
			return false;
		}
	 ...
	 * @return void
	 */
	public function invalidate_for_assistant( $assistant_id ) {
	 ...
	 */
	protected function build_cache_key( array $messages, array $options ) {
	 ...
	 * @return bool
	 */
	protected function is_cacheable( array $options ) {
	 ...
	 */
	protected function get_cache_ttl( array $options ) {
