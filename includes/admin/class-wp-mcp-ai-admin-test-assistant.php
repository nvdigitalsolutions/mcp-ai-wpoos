	...
	class WP_MCP_AI_Admin_Test_Assistant {
		...
		public function register_submenu_page() {
			$this->page_hook = add_submenu_page(
				'edit.php?post_type=' . WP_MCP_AI_Assistant_CPT::POST_TYPE,
					...
					<div class="notice notice-warning">
						<p>
							...
							printf(
								...
								'<a href="' . esc_url( admin_url( 'post-new.php?post_type=' . WP_MCP_AI_Assistant_CPT::POST_TYPE ) ) . '">' . esc_html__( 'Create your first assistant', 'wp-mcp-ai' ) . '</a>'
							);
							?>
						</p>
					</div>
						...
						<tbody>
							<?php foreach ( $assistants as $assistant ) : ?>
								...
								<tr>
									...
									<td><?php echo esc_html( sprintf( _n( '%d tool', '%d tools', $tool_count, 'wp-mcp-ai' ), $tool_count ) ); ?></td>
									<td>
										<button 
											type="button" 
