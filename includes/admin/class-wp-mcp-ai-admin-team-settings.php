...
class WP_MCP_AI_Admin_Team_Settings {
	...
	public function render_page() {
		...
		wp_add_inline_style(
			'wp-mcp-ai-team-settings',
			'.team-settings-nav{border-bottom:1px solid #ccd0d4;margin:20px 0;}'
			. '.team-settings-nav a{display:inline-block;padding:10px 15px;text-decoration:none;border-bottom:2px solid transparent;margin-bottom:-1px;}'
			. '.team-settings-nav a.nav-tab-active{border-bottom-color:#2271b1;font-weight:600;}'
			. '.team-settings-content{margin-top:20px;}'
			. '.team-card{background:#fff;border:1px solid #ccd0d4;box-shadow:0 1px 1px rgba(0,0,0,.04);padding:20px;margin-bottom:20px;}'
				...
				<table class="form-table" role="presentation">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" name="wp_mcp_ai_team_default_model" id="wp_mcp_ai_team_default_model" value="<?php echo esc_attr( $default_model ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'e.g., gpt-4.1, claude-sonnet-5', 'mcp-ai-wpoos' ); ?>">
								<p class="description">
