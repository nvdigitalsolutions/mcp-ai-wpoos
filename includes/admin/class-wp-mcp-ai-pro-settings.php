	...
	class WP_MCP_AI_Pro_Settings {
		...
		public static function get_individual_toolkit_status() {
			...
			$toolkits = array(
				...
				'enable_dietpi_toolkit'                  => __( 'DietPi Toolkit', 'mcp-ai-wpoos' ),
				...
				'enable_comic_creation_toolkit'          => __( 'Comic Creation Toolkit', 'mcp-ai-wpoos' ),
		...
		public static function get_toolkit_details() {
			...
			$toolkits = array(
				...
				'flowhub_toolkit'                 => array(
					'name'          => __( 'FlowHub Toolkit', 'mcp-ai-wpoos' ),
					'description'   => __( 'Synchronize FlowHub dispensary inventory with WooCommerce. AI assistants can query inventory instantly through a local CCT cache.', 'mcp-ai-wpoos' ),
					'enabled'       => ! empty( $settings['enable_flowhub_toolkit'] ),
					'category'      => 'specialized',
					'php_functions' => array(),
					'npm_packages'  => array(),
					'tools_count'   => 5,
					'tools'         => array(
						__( 'flowhub_inventory tool', 'mcp-ai-wpoos' ),
						__( 'flowhub_products tool', 'mcp-ai-wpoos' ),
				...
				'shopify_sync_toolkit'            => array(
					'name'          => __( 'Shopify Sync Toolkit', 'mcp-ai-wpoos' ),
					'description'   => __( 'Bidirectional Shopify↔WooCommerce inventory sync with a local CCT cache for zero-cost bulk queries and analytics.', 'mcp-ai-wpoos' ),
					'enabled'       => ! empty( $settings['enable_shopify_sync_toolkit'] ),
					'category'      => 'specialized',
					'php_functions' => array(),
					'npm_packages'  => array(),
					'tools_count'   => 5,
					'tools'         => array(
						__( 'shopify_sync_products tool', 'mcp-ai-wpoos' ),
						__( 'shopify_sync_inventory tool', 'mcp-ai-wpoos' ),
						__( 'shopify_sync_analytics tool', 'mcp-ai-wpoos' ),
						__( 'shopify_sync_status tool', 'mcp-ai-wpoos' ),
						__( 'shopify_sync_settings tool', 'mcp-ai-wpoos' ),
					),
				),
				...
				'comic_creation_toolkit'          => array(
					'name'          => __( 'Comic Creation Toolkit', 'mcp-ai-wpoos' ),
					'description'   => __( 'AI-powered comic book creation: script generation, panel breakdowns, character sheets, panel art, inking/coloring/lettering, page layouts, speech bubbles, and CBZ export.', 'mcp-ai-wpoos' ),
					'enabled'       => ! empty( $settings['enable_comic_creation_toolkit'] ),
					'category'      => 'specialized',
					'php_functions' => array(),
					'npm_packages'  => array(),
					'tools_count'   => 12,
					'tools'         => array(
						__( 'generate_comic_script tool', 'mcp-ai-wpoos' ),
						__( 'breakdown_comic_panels tool', 'mcp-ai-wpoos' ),
						__( 'generate_character_sheet tool', 'mcp-ai-wpoos' ),
						__( 'generate_comic_panel tool', 'mcp-ai-wpoos' ),
						__( 'create_comic_layout tool', 'mcp-ai-wpoos' ),
						__( 'ink_comic_panel tool', 'mcp-ai-wpoos' ),
						__( 'colorize_comic_panel tool', 'mcp-ai-wpoos' ),
						__( 'export_comic_cbz tool', 'mcp-ai-wpoos' ),
					),
				),
