...
<div class="wp-mcp-ai-widget-usage-overview">
	...
	<div class="wp-mcp-ai-stats-grid">
		...
		<div class="wp-mcp-ai-stat-card">
			...
			<div class="wp-mcp-ai-stat-label"><?php esc_html_e( 'This Month', 'mcp-ai-wpoos' ); ?></div>
		</div>
		<div class="wp-mcp-ai-stat-card">
		...
		<div style="display: flex; align-items: center; gap: 20px;">
			...
			<div style="flex: 1;">
				...
				<div style="font-size: 14px; color: #666; margin-bottom: 10px;">
					<?php esc_html_e( 'of daily limit used', 'mcp-ai-wpoos' ); ?>
				</div>
				<div style="font-size: 12px; color: #999;">
					...
					echo esc_html(
						sprintf(
							...
							__( '%1$s / %2$s tokens', 'mcp-ai-wpoos' ),
	...
	<div class="wp-mcp-ai-chart-controls" style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
		<div class="wp-mcp-ai-period-selector">
			<label for="wp-mcp-ai-usage-period" style="margin-right: 8px;"><?php esc_html_e( 'Period:', 'mcp-ai-wpoos' ); ?></label>
			<select id="wp-mcp-ai-usage-period" class="wp-mcp-ai-chart-period" data-chart-id="wp-mcp-ai-dashboard-usage-trend">
				...
				<option value="7" selected><?php esc_html_e( '7 Days', 'mcp-ai-wpoos' ); ?></option>
				<option value="30"><?php esc_html_e( '30 Days', 'mcp-ai-wpoos' ); ?></option>
				<option value="90"><?php esc_html_e( '90 Days', 'mcp-ai-wpoos' ); ?></option>
			</select>
		</div>
		<div class="wp-mcp-ai-chart-actions">
			<button type="button" class="button wp-mcp-ai-export-chart" data-chart-id="wp-mcp-ai-dashboard-usage-trend" title="<?php esc_attr_e( 'Export as PNG', 'mcp-ai-wpoos' ); ?>">
				<span class="dashicons dashicons-download" style="margin-top: 3px;"></span>
				<?php esc_html_e( 'Export', 'mcp-ai-wpoos' ); ?>
			</button>
		</div>
	</div>
