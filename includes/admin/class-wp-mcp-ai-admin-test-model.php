		...
		<div class="wrap wp-mcp-ai-test-model-page">
			...
			<div class="wp-mcp-ai-test-model-selector">
				...
				if ( shortcode_exists( 'mcp_ai_professional_selector' ) ) {
					...
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Shortcode output is generated by WP_MCP_AI_Professional_Selector_Shortcode::render_shortcode() which individually escapes all values with esc_attr()/esc_html(). The output contains <script type="application/json"> config blocks and data-* attributes that wp_kses_post() strips, breaking functionality.
