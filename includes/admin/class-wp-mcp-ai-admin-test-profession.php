...
if ( ! class_exists( 'WP_MCP_AI_Admin_Test_Profession' ) ) {
	 ...
	 */
	class WP_MCP_AI_Admin_Test_Profession {
		...
		/**
		 * Register the submenu page under Professions.
		 */
		public function register_submenu_page() {
			...
			$this->page_hook = add_submenu_page(
				...
				__( 'Test Profession', 'wp-mcp-ai' ),
				__( 'Test Profession', 'wp-mcp-ai' ),
				'manage_options',
				'wp-mcp-ai-test-profession',
				array( $this, 'render_page' )
			);
		}

		/**
		 * Enqueue assets for the test profession page.
		 *
		...
		public function enqueue_assets( $hook ) {
			...
			// Enqueue test profession specific assets.
		...
		private function get_chat_strings() {
			return array(
				...
				'missingAssistant'              => __( 'Profession configuration was not found.', 'wp-mcp-ai' ),
				'notAuthorized'                 => __( 'You do not have permission to test this profession.', 'wp-mcp-ai' ),
				...
				'roleLabels'                    => array(
					'assistant' => __( 'Professional', 'wp-mcp-ai' ),
					...
					<div class="wp-mcp-ai-test-modal__panel">
						...
						<div class="wp-mcp-ai-test-modal__body">
							<div class="wp-mcp-ai-test-profession-info">
								<p class="description">
									<?php echo esc_html__( 'Testing profession behavior by creating a temporary assistant. This allows you to validate the profession\'s role, expertise, tools, and knowledge base configuration.', 'wp-mcp-ai' ); ?>
								</p>
							</div>
