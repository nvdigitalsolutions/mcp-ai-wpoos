	...
	class WP_MCP_AI_Admin_Gmail_Crawl_Integration {
		...
		public function register_page() {
			$this->page_hook = add_submenu_page(
				'wp-mcp-ai-dashboard',
				__( 'External Tools - NV oOS', 'mcp-ai-wpoos' ),
				__( 'External Tools', 'mcp-ai-wpoos' ),
				'manage_options',
				self::PAGE_SLUG,
			...
			?>
				...
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
					...
					<table class="form-table" role="presentation">
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Gmail', 'mcp-ai-wpoos' ); ?>
								</h2>
						...
						<tr>
							<th scope="row">
								<label for="gmail_client_id"><?php esc_html_e( 'Gmail OAuth Client ID', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'OAuth 2.0 Client ID from Google Cloud Console for Gmail integration.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="gmail_client_secret"><?php esc_html_e( 'Gmail OAuth Client Secret', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'OAuth 2.0 Client Secret from Google Cloud Console.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Crawl4AI', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="crawl4ai_base_url"><?php esc_html_e( 'Crawl4AI Base URL', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Base URL for Crawl4AI service (if using external crawler).', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="crawl4ai_api_key"><?php esc_html_e( 'Crawl4AI API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API key for Crawl4AI service (if required).', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Brave Search', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="brave_search_api_key"><?php esc_html_e( 'Brave Search API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Cloudflare', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="cloudflare_api_token"><?php esc_html_e( 'Cloudflare API Token', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API token for Cloudflare integration. Create a token in your Cloudflare dashboard.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="cloudflare_zone_id"><?php esc_html_e( 'Cloudflare Zone ID', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Your Cloudflare zone ID for cache management.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									<span class="dashicons dashicons-admin-site"></span>
									<?php esc_html_e( 'Cloudways', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="cloudways_api_key"><?php esc_html_e( 'Cloudways API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API key for Cloudways hosting integration.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="cloudways_email"><?php esc_html_e( 'Cloudways Account Email', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Email address associated with your Cloudways account.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									<span class="dashicons dashicons-email"></span>
									<?php esc_html_e( 'Mailjet', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="mailjet_api_key"><?php esc_html_e( 'Mailjet API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API key for Mailjet email service integration.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="mailjet_api_secret"><?php esc_html_e( 'Mailjet API Secret', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API secret for Mailjet email service.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Brevo', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="brevo_api_key"><?php esc_html_e( 'Brevo API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'QuickBooks', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="quickbooks_api_key"><?php esc_html_e( 'QuickBooks API Key', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'API key for QuickBooks integration.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="quickbooks_client_id"><?php esc_html_e( 'QuickBooks Client ID', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'OAuth 2.0 Client ID from QuickBooks developer portal.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="quickbooks_client_secret"><?php esc_html_e( 'QuickBooks Client Secret', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'OAuth 2.0 Client Secret from QuickBooks developer portal.', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<h2 style="margin: 20px 0 10px 0; display: flex; align-items: center; gap: 8px;">
									...
									<?php esc_html_e( 'Google Analytics', 'mcp-ai-wpoos' ); ?>
								</h2>
								<hr style="margin: 10px 0; border: none; border-top: 1px solid #ddd;">
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="google_analytics_property_id"><?php esc_html_e( 'Google Analytics Property ID', 'mcp-ai-wpoos' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Google Analytics 4 Property ID (e.g., 123456789).', 'mcp-ai-wpoos' ); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
