				...
				<aside class="mcp-ai-dag-sidebar">
					...
					<ul class="mcp-ai-dag-workflow-list">
						...
						<li class="mcp-ai-dag-workflow-item<?php echo ( $wf->ID === $workflow_id ) ? ' is-active' : ''; ?>">
							...
							<small>v<?php echo esc_html( get_post_meta( $wf->ID, WP_MCP_AI_Workflow_CPT::META_VERSION, true ) ?: '1.0.0' ); ?></small> // phpcs:ignore Universal.Operators.DisallowShortTernary.Found -- Short ternary is safe here. // phpcs:ignore Universal.Operators.DisallowShortTernary.Found
