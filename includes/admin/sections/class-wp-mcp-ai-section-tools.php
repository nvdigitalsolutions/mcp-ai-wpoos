	...
	class WP_MCP_AI_Section_Tools extends WP_MCP_AI_Settings_Section {
		...
		public function get_fields() {
			...
			$fields = array(
				...
				'enable_comic_creation_toolkit'          => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable Comic Creation Toolkit', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Enable AI-powered comic book creation tools (Pro Version only)', 'mcp-ai-wpoos' ),
					'description'    => __( 'Enables 12 AI-powered comic creation tools for script generation, panel breakdowns, character sheets, panel art, inking/coloring/lettering, page layouts, speech bubbles, and CBZ export. This feature is only available in the Pro addon.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				...
				// WebChat Integration - Real-time WebRTC chat rooms.
				'enable_webchat_integration'             => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable WebChat Integration', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Enable WebRTC-based video chat rooms (Pro Version only)', 'mcp-ai-wpoos' ),
				...
				<td>
					...
					var toolkitMemory = <?php echo $toolkit_memory_json ? $toolkit_memory_json : '{}'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_json_encode() output is safe for inline script context. ?>;
						...
						var toolkitCheckboxes = $(
							...
							'input[name="wp_mcp_ai_settings[enable_comic_creation_toolkit]"],' +
