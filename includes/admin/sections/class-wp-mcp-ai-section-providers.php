		...
		public function get_fields() {
			...
			return array(
				...
				'lm_studio_endpoint_url'      => array(
					...
					'description' => __( 'URL for your LM Studio server. Examples: "http://localhost:1234" for local, "http://192.168.2.222:1234" for network server. This is WHERE your LM Studio is running. Do NOT include /v1 in the URL. Ensure LM Studio is running with a loaded model and local server enabled before testing.', 'wp-mcp-ai' ),
