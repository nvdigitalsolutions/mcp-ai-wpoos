	...
	class WP_MCP_AI_Section_Chat_Client extends WP_MCP_AI_Settings_Section {
		...
		public function get_fields() {
			...
			'show_capability_flags'             => array(
				...
				// Chat Bubble subtab fields.
				'chat_bubble_enabled'               => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable Chat Bubble', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Display a floating chat bubble on all pages', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, a floating chat bubble will appear on every public page of your site, allowing visitors to open an AI chat panel. No widget or block placement is required.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				...
				'chat_bubble_allow_guests'          => array(
					...
					'checkbox_label' => __( 'Allow non-logged-in visitors to use the chat bubble', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, visitors who are not logged in can still use the chat bubble.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				'chat_bubble_save_transcript'       => array(
					'type'           => 'checkbox',
					'label'          => __( 'Save Transcript', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Save chat transcripts server-side', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, chat conversations will be saved server-side for later review.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'chat_bubble_enable_streaming'      => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable Streaming', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Stream assistant responses in real-time', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, responses will appear word-by-word as they are generated.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'chat_bubble_allow_sensitive_tools' => array(
					'type'           => 'checkbox',
					'label'          => __( 'Allow Sensitive Tools', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Allow the assistant to use sensitive/write tools via the bubble', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, the assistant may use tools that modify data. Disable for a read-only experience.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				'chat_bubble_template'              => array(
					'type'        => 'select',
					'label'       => __( 'Chat Template', 'mcp-ai-wpoos' ),
					'description' => __( 'Select the visual template for the chat interface inside the bubble panel.', 'mcp-ai-wpoos' ),
					'options'     => array(
				...
				'chat_bubble_position'              => array(
					'type'        => 'select',
					'label'       => __( 'Bubble Position', 'mcp-ai-wpoos' ),
					'description' => __( 'Where the floating chat bubble appears on the screen.', 'mcp-ai-wpoos' ),
					'options'     => array(
				...
				'chat_bubble_size'                  => array(
					'type'        => 'select',
					'label'       => __( 'Bubble Size', 'mcp-ai-wpoos' ),
					'description' => __( 'Size of the floating chat bubble trigger button.', 'mcp-ai-wpoos' ),
					'options'     => array(
				...
				'chat_bubble_animation'             => array(
					'type'        => 'select',
					'label'       => __( 'Bubble Animation', 'mcp-ai-wpoos' ),
					'description' => __( 'Animation effect for the chat bubble trigger button.', 'mcp-ai-wpoos' ),
					'options'     => array(
				...
				'chat_bubble_tooltip'               => array(
					'type'        => 'text',
					'label'       => __( 'Bubble Tooltip', 'mcp-ai-wpoos' ),
					'description' => __( 'Tooltip text displayed when hovering over the chat bubble. Leave empty to disable.', 'mcp-ai-wpoos' ),
					'default'     => '',
					'placeholder' => __( 'Chat with us!', 'mcp-ai-wpoos' ),
				),
				'chat_bubble_panel_title'           => array(
					'type'        => 'text',
					'label'       => __( 'Panel Title', 'mcp-ai-wpoos' ),
					'description' => __( 'Title displayed in the header of the chat panel.', 'mcp-ai-wpoos' ),
					'default'     => 'Chat with AI',
					'placeholder' => __( 'Chat with AI', 'mcp-ai-wpoos' ),
				),
				'chat_bubble_panel_width'           => array(
					'type'        => 'number',
					'label'       => __( 'Panel Width (px)', 'mcp-ai-wpoos' ),
					'description' => __( 'Width of the chat panel in pixels.', 'mcp-ai-wpoos' ),
					'default'     => 400,
					'placeholder' => '400',
					'min'         => 250,
					'max'         => 800,
				),
				'chat_bubble_panel_height'          => array(
					'type'        => 'number',
					'label'       => __( 'Panel Height (px)', 'mcp-ai-wpoos' ),
					'description' => __( 'Height of the chat panel in pixels.', 'mcp-ai-wpoos' ),
					'default'     => 550,
					'placeholder' => '550',
					'min'         => 300,
					'max'         => 900,
				),
				'chat_bubble_auto_open_delay'       => array(
					'type'        => 'number',
					'label'       => __( 'Auto-Open Delay (seconds)', 'mcp-ai-wpoos' ),
					'description' => __( 'Automatically open the chat panel after this many seconds. Set to 0 to disable auto-open.', 'mcp-ai-wpoos' ),
					'default'     => 0,
					'placeholder' => '0',
					'min'         => 0,
					'max'         => 300,
				),
				'chat_bubble_remember_state'        => array(
					'type'           => 'checkbox',
					'label'          => __( 'Remember State', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Remember whether the chat panel was open or closed', 'mcp-ai-wpoos' ),
					'description'    => __( 'When enabled, the bubble remembers its open/closed state across page navigations using localStorage.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				'chat_bubble_notification_badge'    => array(
					'type'           => 'checkbox',
					'label'          => __( 'Notification Badge', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Show a notification badge on the bubble', 'mcp-ai-wpoos' ),
					'description'    => __( 'Displays a small notification dot on the bubble to attract attention.', 'mcp-ai-wpoos' ),
					'default'        => false,
				),
				'chat_bubble_color'                 => array(
					'type'        => 'text',
					'label'       => __( 'Bubble Color', 'mcp-ai-wpoos' ),
					'description' => __( 'Background color of the chat bubble trigger button (HEX).', 'mcp-ai-wpoos' ),
					'default'     => '#4f46e5',
					'placeholder' => '#4f46e5',
				),
				'chat_bubble_text_color'            => array(
					'type'        => 'text',
					'label'       => __( 'Bubble Text/Icon Color', 'mcp-ai-wpoos' ),
					'description' => __( 'Color of the icon and text inside the chat bubble trigger button (HEX).', 'mcp-ai-wpoos' ),
					'default'     => '#ffffff',
					'placeholder' => '#ffffff',
				),
				'chat_bubble_header_background'     => array(
					'type'        => 'text',
					'label'       => __( 'Panel Header Background', 'mcp-ai-wpoos' ),
					'description' => __( 'Background color of the chat panel header (HEX). Leave empty to use bubble color.', 'mcp-ai-wpoos' ),
					'default'     => '',
					'placeholder' => '#4f46e5',
				),
				'chat_bubble_header_text_color'     => array(
					'type'        => 'text',
					'label'       => __( 'Panel Header Text Color', 'mcp-ai-wpoos' ),
					'description' => __( 'Text color in the chat panel header (HEX).', 'mcp-ai-wpoos' ),
					'default'     => '#ffffff',
					'placeholder' => '#ffffff',
				),
				'chat_bubble_exclude_pages'         => array(
					'type'        => 'text',
					'label'       => __( 'Exclude Pages', 'mcp-ai-wpoos' ),
					'description' => __( 'Comma-separated list of page/post IDs where the chat bubble should NOT appear. Leave empty to show on all pages.', 'mcp-ai-wpoos' ),
					'default'     => '',
					'placeholder' => __( '42, 123, 456', 'mcp-ai-wpoos' ),
				),
			);
		}
		...
		protected function get_subtab_groups() {
			return array(
				...
				'chat_bubble'          => array(
					'id'          => 'chat_bubble',
					'label'       => __( 'Chat Bubble', 'mcp-ai-wpoos' ),
					'icon'        => 'dashicons-format-status',
					'description' => __( 'Enable a global floating chat bubble on your site. When enabled, the bubble appears on every page without needing to add a widget or block to your theme.', 'mcp-ai-wpoos' ),
					'fields'      => array(
						'chat_bubble_enabled',
						'chat_bubble_assistant_id',
						'chat_bubble_allow_guests',
						'chat_bubble_save_transcript',
						'chat_bubble_enable_streaming',
						'chat_bubble_allow_sensitive_tools',
						'chat_bubble_template',
						'chat_bubble_position',
						'chat_bubble_size',
						'chat_bubble_animation',
						'chat_bubble_tooltip',
						'chat_bubble_panel_title',
						'chat_bubble_panel_width',
						'chat_bubble_panel_height',
						'chat_bubble_auto_open_delay',
						'chat_bubble_remember_state',
						'chat_bubble_notification_badge',
						'chat_bubble_color',
						'chat_bubble_text_color',
						'chat_bubble_header_background',
						'chat_bubble_header_text_color',
						'chat_bubble_exclude_pages',
					),
				),
				'presets'              => array(
					'id'     => 'presets',
