		...
		public function get_fields() {
			...
			$fields = array(
				...
				'_heading_ai_transparency'                 => array(
					'type'  => 'heading',
					'label' => __( 'AI Transparency & Compliance', 'mcp-ai-wpoos' ),
				),
				'enable_ai_disclosure'                     => array(
					'type'           => 'checkbox',
					'label'          => __( 'Show AI Disclosure', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Display an AI disclosure banner in the chat interface', 'mcp-ai-wpoos' ),
					'description'    => __( 'Required by EU AI Act Article 50(1). Informs users they are interacting with an AI assistant at the start of every chat session.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'ai_disclosure_message'                    => array(
					'type'        => 'textarea',
					'label'       => __( 'Disclosure Message', 'mcp-ai-wpoos' ),
					'description' => __( 'Custom AI disclosure message. Leave blank for the default: "You are interacting with an AI assistant. Responses may be generated by artificial intelligence and should be reviewed for accuracy."', 'mcp-ai-wpoos' ),
					'default'     => '',
				),
				'ai_disclosure_position'                   => array(
					'type'        => 'select',
					'label'       => __( 'Disclosure Position', 'mcp-ai-wpoos' ),
					'description' => __( 'Where to display the AI disclosure notice.', 'mcp-ai-wpoos' ),
					'options'     => array(
						'banner' => __( 'Banner (top of chat)', 'mcp-ai-wpoos' ),
						'header' => __( 'Header Badge', 'mcp-ai-wpoos' ),
						'both'   => __( 'Both Banner and Badge', 'mcp-ai-wpoos' ),
					),
					'default'     => 'banner',
				),
				'enable_consent_modal'                     => array(
					'type'           => 'checkbox',
					'label'          => __( 'Require User Consent', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Show a consent modal before the first AI chat interaction', 'mcp-ai-wpoos' ),
					'description'    => __( 'Required by EU AI Act Article 50(1). Users must acknowledge they are chatting with AI before sending their first message.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'consent_message'                          => array(
					'type'        => 'textarea',
					'label'       => __( 'Consent Message', 'mcp-ai-wpoos' ),
					'description' => __( 'Custom consent message shown in the modal. Leave blank for the default: "This chat is powered by AI. Your messages may be processed by AI models to generate responses. By continuing, you acknowledge and consent to AI-powered interactions."', 'mcp-ai-wpoos' ),
					'default'     => '',
				),
				'enable_transparency_headers'              => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable Transparency Headers', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Add X-AI-Generated, X-AI-Provider, and X-AI-Model headers to REST responses', 'mcp-ai-wpoos' ),
					'description'    => __( 'Required by EU AI Act Article 50(2). Enables downstream tools and platforms to detect AI-generated content via machine-readable HTTP headers.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'enable_generation_logging'                => array(
					'type'           => 'checkbox',
					'label'          => __( 'Enable Generation Provenance Logging', 'mcp-ai-wpoos' ),
					'checkbox_label' => __( 'Record every AI generation in an immutable hash-chain database', 'mcp-ai-wpoos' ),
					'description'    => __( 'Creates a tamper-evident audit trail of all AI interactions for regulatory compliance and debugging. Each record is cryptographically linked to the previous one, forming a verifiable chain of provenance.', 'mcp-ai-wpoos' ),
					'default'        => true,
				),
				'generation_log_retention_days'            => array(
					'type'        => 'number',
					'label'       => __( 'Provenance Log Retention (days)', 'mcp-ai-wpoos' ),
					'description' => __( 'Number of days to retain generation provenance records. Older records are automatically pruned daily.', 'mcp-ai-wpoos' ),
					'default'     => 365,
					'min'         => 1,
					'max'         => 3650,
				),
