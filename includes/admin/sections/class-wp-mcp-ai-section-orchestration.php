		...
		<div class="wp-mcp-ai-agents-view">
			...
			<!-- Styling -->
				...
				$agents_css = ''
					...
					. '.wp-mcp-ai-health-indicator.health-warning{border-left-color:#FF9800}'
					. '.wp-mcp-ai-health-indicator.health-critical{border-left-color:#F44336}'
					. '.wp-mcp-ai-health-indicator .dashicons{font-size:20px}'
					. '.wp-mcp-ai-health-indicator.health-good .dashicons{color:#4CAF50}'
					. '.wp-mcp-ai-health-indicator.health-warning .dashicons{color:#FF9800}'
					. '.wp-mcp-ai-health-indicator.health-critical .dashicons{color:#F44336}'
