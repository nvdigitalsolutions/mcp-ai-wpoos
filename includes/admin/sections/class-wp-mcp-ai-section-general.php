	...
	class WP_MCP_AI_Section_General extends WP_MCP_AI_Settings_Section {
		...
		public function get_fields() {
			...
			return array(
				...
				'context_strategy'                      => array(
					'type'        => 'select',
					'label'       => __( 'Context Strategy', 'mcp-ai-wpoos' ),
					'description' => __( 'Sliding Window: keeps only the most recent messages. BME: summarizes older messages and keeps recent ones verbatim. BME+RAG: adds memory retrieval for cross-session context.', 'mcp-ai-wpoos' ),
					'default'     => 'sliding_window',
					'options'     => array(
						'sliding_window' => __( 'Sliding Window', 'mcp-ai-wpoos' ),
						'bme'            => __( 'Beginning-Middle-End (BME)', 'mcp-ai-wpoos' ),
						'bme_rag'        => __( 'BME + RAG Memory', 'mcp-ai-wpoos' ),
					),
				),
				'end_window_size'                       => array(
					'type'        => 'number',
					'label'       => __( 'End Window Size', 'mcp-ai-wpoos' ),
					'description' => __( 'Number of recent messages to keep verbatim in the End zone. Older messages will be summarized. Only used with BME strategy.', 'mcp-ai-wpoos' ),
					'default'     => 10,
					'placeholder' => '10',
					'min'         => 2,
					'max'         => 50,
				),
				'summary_trigger_count'                 => array(
					'type'        => 'number',
					'label'       => __( 'Summary Trigger Count', 'mcp-ai-wpoos' ),
					'description' => __( 'When total non-system messages exceed this count, older messages are summarized. Only used with BME strategy.', 'mcp-ai-wpoos' ),
					'default'     => 30,
					'placeholder' => '30',
					'min'         => 10,
					'max'         => 200,
				),
				'summary_trigger_tokens'                => array(
					'type'        => 'number',
					'label'       => __( 'Summary Trigger Tokens', 'mcp-ai-wpoos' ),
					'description' => __( 'Alternative token-based trigger. When set (>0), summarization triggers at 80% of this value instead of using count. Set to 0 to use count-based trigger.', 'mcp-ai-wpoos' ),
					'default'     => 0,
					'placeholder' => '0',
					'min'         => 0,
					'max'         => 200000,
				...
				'summary_model'                         => array(
					'type'        => 'text',
					'label'       => __( 'Summary Model', 'mcp-ai-wpoos' ),
					'description' => __( 'Model to use for conversation summarization. Leave blank to use the assistant model. Use a faster/cheaper model for cost-efficient summaries.', 'mcp-ai-wpoos' ),
					'default'     => '',
					'placeholder' => __( 'Default: assistant model', 'mcp-ai-wpoos' ),
				),
				'summary_max_tokens'                    => array(
					'type'        => 'number',
					'label'       => __( 'Summary Max Tokens', 'mcp-ai-wpoos' ),
					'description' => __( 'Maximum tokens for the generated conversation summary. Higher values preserve more detail.', 'mcp-ai-wpoos' ),
					'default'     => 500,
					'placeholder' => '500',
					'min'         => 100,
					'max'         => 4000,
				),
				'tool_result_summarize_threshold'       => array(
					'type'        => 'number',
					'label'       => __( 'Tool Result Summarize Threshold', 'mcp-ai-wpoos' ),
					'description' => __( 'Tool results longer than this many characters will be truncated before storing in chat history. Set to 0 to disable.', 'mcp-ai-wpoos' ),
					'default'     => 2000,
					'placeholder' => '2000',
					'min'         => 0,
					'max'         => 100000,
