...
if ( ! class_exists( 'WP_MCP_AI_Section_Token_Manager' ) ) {
	...
	private function get_tool_multiplier( $tool_slug ) {
		return WP_MCP_AI_Token_Management_Service::get_tool_multiplier( $tool_slug );
	}
		...
		return WP_MCP_AI_Token_Management_Service::get_all_available_tools();
		}
		...
		return WP_MCP_AI_Token_Management_Service::get_site_wide_statistics();
		}
		...
		return WP_MCP_AI_Token_Management_Service::get_provider_display_name( $provider );
		}
