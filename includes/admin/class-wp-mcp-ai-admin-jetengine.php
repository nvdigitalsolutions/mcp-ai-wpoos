	...
	class WP_MCP_AI_Admin_JetEngine_Integration {
		...
		public function render_page() {
			...
			<div class="wrap">
				...
				<div style="background: <?php echo $jetengine_active ? '#d5f0db' : '#f0f0f1'; ?>; border-left: 4px solid <?php echo $jetengine_active ? '#0a5f1a' : '#646970'; ?>; padding: 1.5rem; margin: 1.5rem 0;">
