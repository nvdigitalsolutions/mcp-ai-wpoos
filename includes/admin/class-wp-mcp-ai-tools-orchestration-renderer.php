	...
	class WP_MCP_AI_Tools_Orchestration_Renderer {
		...
		public static function render_tools_view() {
			try {
				...
				<p class="description">
					<?php esc_html_e( 'View and manage orchestration settings for each tool. This includes capability flags, model requirements, execution rules, and other metadata that helps the orchestration layer make intelligent decisions about tool usage.', 'wp-mcp-ai' ); ?>
				</p>
				...
				<table class="wp-list-table widefat fixed striped">
					<thead>
						<tr>
							...
							<th style="width: 30%;"><?php esc_html_e( 'Capability Flags', 'wp-mcp-ai' ); ?></th>
							<th style="width: 15%;"><?php esc_html_e( 'Model Requirements', 'wp-mcp-ai' ); ?></th>
							<th style="width: 20%;"><?php esc_html_e( 'Orchestration Info', 'wp-mcp-ai' ); ?></th>
						</tr>
					</thead>
					<tbody>
