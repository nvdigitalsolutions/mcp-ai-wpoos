 ...
 *
 * Translates between A2A protocol message formats and the NV oOS
 * internal chat message format used by the chat pipeline.
 *
 * @package WP_MCP_AI
...
/**
 * Bidirectional message translator between A2A and NV oOS chat formats.
 */
class WP_MCP_AI_A2A_Message_Translator {

	/**
	 * Convert an A2A SendMessageRequest to NV oOS chat messages.
	 *
	 * @param array $a2a_request The A2A SendMessageRequest data.
	 * @return array {
	 *     @type array  $messages     Array of NV oOS chat messages.
	...
	/**
	 * Convert NV oOS chat response to an A2A Message object.
	 *
	...
	/**
	 * Convert NV oOS chat response to an A2A Artifact.
	 *
	...
	/**
	 * Map A2A role to NV oOS chat role.
	 *
	 * @param string $a2a_role The A2A role (user, agent).
	 * @return string The NV oOS chat role.
	 */
	...
	/**
	 * Map NV oOS chat role to A2A role.
	 *
	 * @param string $chat_role The NV oOS chat role.
