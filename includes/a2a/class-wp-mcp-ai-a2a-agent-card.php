 ...
 * mapping NV oOS assistant metadata to the A2A protocol specification.
 *
 * @package WP_MCP_AI
...
/**
 * Builds A2A-compliant Agent Cards from NV oOS assistant data.
 */
class WP_MCP_AI_A2A_Agent_Card {
	...
	protected static function build_generic_site_card() {
		...
		/** This filter is documented in includes/a2a/class-wp-mcp-ai-a2a-agent-card.php */
