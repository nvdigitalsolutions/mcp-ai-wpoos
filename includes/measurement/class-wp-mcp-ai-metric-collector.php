 ...
 */
class WP_MCP_AI_Metric_Collector {
	 ...
	 * Singleton instance.
	 *
	 * @var WP_MCP_AI_Metric_Collector|null
	 */
	 ...
	 * Private constructor.
	 *
	 * @param WP_MCP_AI_Measurement_Registry|null $registry Optional registry override (for tests).
	 */
	 ...
	 *
	 * @return WP_MCP_AI_Metric_Collector
	 */
	...
	public function record( $metric_id, $value, array $context = array() ) {
		 ...
		 * @param WP_MCP_AI_Metric_Collector     $collector  Collector instance.
		 */
