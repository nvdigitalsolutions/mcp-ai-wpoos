 ...
 */
class WP_MCP_AI_Verifier_Registry {

	/**
	 * Singleton instance.
	 *
	 * @var WP_MCP_AI_Verifier_Registry|null
	 */
	 ...
	 *
	 * @var array<string,WP_MCP_AI_Verifier_Interface>
	 */
	 ...
	 *
	 * @return WP_MCP_AI_Verifier_Registry
	 */
	...
	public function boot() {
		 ...
		 * @since 1.3.0
		 *
		 * @param WP_MCP_AI_Verifier_Registry $registry Verifier registry.
		 */
	 ...
	 * Register a verifier.
	 *
	 * @param WP_MCP_AI_Verifier_Interface $verifier Verifier.
	 * @return bool True on success.
	 */
	public function register( WP_MCP_AI_Verifier_Interface $verifier ) {
	 ...
	 * @return WP_MCP_AI_Verifier_Interface|null
	 */
	 ...
	 *
	 * @return array<string,WP_MCP_AI_Verifier_Interface>
	 */
	public function all() {
	...
	public function run( $slug, array $subject, array $context = array(), array $generator_context = array() ) {
		...
		if ( null === $verifier ) {
			return new WP_Error(
				...
				sprintf( __( 'Verifier "%s" is not registered.', 'mcp-ai-wpoos' ), $slug )
			);
		}
		 ...
		 * @param WP_MCP_AI_Verifier_Interface     $verifier Verifier instance.
