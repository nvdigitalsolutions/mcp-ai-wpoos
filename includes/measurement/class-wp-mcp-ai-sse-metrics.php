	...
	public static function definitions() {
		$definitions = array(
			array(
				...
				'label'          => __( 'SSE streams (total)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Total number of SSE streams dispatched through the stream handler, regardless of outcome.', 'mcp-ai-wpoos' ),
			...
			array(
				...
				'label'          => __( 'SSE streams (error)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Streams ended because the underlying job reached a terminal failed state. Client cancellations and timeouts are tracked separately and are NOT counted here.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_COUNTER,
				'unit'           => 'streams',
			...
			array(
				...
				'label'          => __( 'SSE streams (cancelled)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Streams ended by explicit cancellation — either the client disconnected (connection_aborted) or the underlying job transitioned to cancelled. Tracked separately from stream.error.count because cancellation is a first-class user outcome, not a quality regression.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_COUNTER,
				'unit'           => 'streams',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_NEUTRAL,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
			...
			array(
				...
				'label'          => __( 'SSE time-to-first-byte (ms)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Wall-clock time from stream start to the first non-heartbeat status chunk. Streams that end before any status chunk is emitted do not record this metric.', 'mcp-ai-wpoos' ),
			...
			array(
				...
				'label'          => __( 'SSE chunk interval (ms)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Time between successive non-heartbeat status chunks. Excludes heartbeat comments so the metric reflects real progress cadence.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'ms',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_NEUTRAL,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
			...
			array(
				...
				'label'          => __( 'SSE total duration (ms)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Wall-clock duration from stream start to stream end, regardless of outcome.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'ms',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_LOWER_IS_BETTER,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
			...
			array(
				...
				'label'          => __( 'SSE chunks per stream', 'mcp-ai-wpoos' ),
				'description'    => __( 'Number of non-heartbeat chunks (status updates) emitted during a single stream.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'chunks',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_NEUTRAL,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
