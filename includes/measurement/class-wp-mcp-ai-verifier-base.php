 ...
 * Verifier Base Class
 *
 * Convenience base class implementing {@see WP_MCP_AI_Verifier_Interface}.
 * Concrete verifiers extend this class and typically only need to override
 * {@see WP_MCP_AI_Verifier_Base::verify()}.
 *
 * @package WP_MCP_AI
 * @since   1.3.0
 ...
 */
abstract class WP_MCP_AI_Verifier_Base implements WP_MCP_AI_Verifier_Interface {
	...
	/**
	 * Verifier kind. See {@see WP_MCP_AI_Verifier_Interface} docblock.
	 *
	 * @var string
	 */
	protected $kind = 'rule';
