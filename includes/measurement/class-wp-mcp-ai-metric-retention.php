 ...
 */
class WP_MCP_AI_Metric_Retention {
	...
	public static function default_ttls_days() {
		return array(
			WP_MCP_AI_Measurement_Registry::PRIVACY_PUBLIC => 365,
			WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL => 90,
			WP_MCP_AI_Measurement_Registry::PRIVACY_SENSITIVE => 30,
		);
	}
