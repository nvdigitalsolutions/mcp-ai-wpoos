 ...
 * Recording values is the responsibility of {@see WP_MCP_AI_Metric_Collector}.
 *
 * @package WP_MCP_AI
 * @since   1.3.0
 ...
 */
class WP_MCP_AI_Measurement_Registry {
	 ...
	 * Singleton instance.
	 *
	 * @var WP_MCP_AI_Measurement_Registry|null
	 */
	 ...
	 *
	 * @return WP_MCP_AI_Measurement_Registry
	 */
	...
	public function boot() {
		 ...
		 * @since 1.3.0
		 *
		 * @param WP_MCP_AI_Measurement_Registry $registry The metric registry.
		 */
