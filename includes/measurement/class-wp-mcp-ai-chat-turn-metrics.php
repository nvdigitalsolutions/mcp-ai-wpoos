 ...
 */
class WP_MCP_AI_Chat_Turn_Metrics {
	...
	public static function definitions() {
		$definitions = array(
			array(
				...
				'label'          => __( 'Chat turns (total)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Total number of chat turns dispatched through the REST chat endpoint, regardless of outcome.', 'mcp-ai-wpoos' ),
			...
			array(
				...
				'label'          => __( 'Chat turns (error)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Chat turns that returned a WP_Error or whose provider response carried an error payload.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_COUNTER,
				'unit'           => 'turns',
			...
			array(
				...
				'label'          => __( 'Chat turn duration (ms)', 'mcp-ai-wpoos' ),
				'description'    => __( 'Wall-clock duration between the before_chat_request and after_chat_response hooks for a single turn.', 'mcp-ai-wpoos' ),
			...
			array(
				...
				'label'          => __( 'Prompt tokens per turn', 'mcp-ai-wpoos' ),
				'description'    => __( 'Prompt-side tokens reported by the provider for a single chat turn.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'tokens',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_LOWER_IS_BETTER,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
			...
			array(
				...
				'label'          => __( 'Completion tokens per turn', 'mcp-ai-wpoos' ),
				'description'    => __( 'Completion-side tokens reported by the provider for a single chat turn.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'tokens',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_NEUTRAL,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
			...
			array(
				...
				'label'          => __( 'Realised cost per turn (USD)', 'mcp-ai-wpoos' ),
				'description'    => __( 'USD cost reported by the plugin cost calculator for a single chat turn, sourced from the wp_mcp_ai_cost_calculated action.', 'mcp-ai-wpoos' ),
				'type'           => WP_MCP_AI_Measurement_Registry::TYPE_HISTOGRAM,
				'unit'           => 'usd',
				'direction'      => WP_MCP_AI_Measurement_Registry::DIRECTION_LOWER_IS_BETTER,
				'privacy_tier'   => WP_MCP_AI_Measurement_Registry::PRIVACY_INTERNAL,
