 ...
 * @since 1.9.0
 */
class WP_MCP_AI_Profession_Metabox_Agent_Orchestration extends WP_MCP_AI_Profession_Metabox_Base {
		...
		<div class="wp-mcp-ai-profession-orchestration">
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_agent_role">
					<?php esc_html_e( 'Agent Role', 'mcp-ai-wpoos' ); ?>
				...
				>
					<option value="generalist" <?php selected( $agent_role, 'generalist' ); ?>>
						<?php esc_html_e( 'Generalist (Can perform any role)', 'mcp-ai-wpoos' ); ?>
					</option>
					<option value="planner" <?php selected( $agent_role, 'planner' ); ?>>
						<?php esc_html_e( 'Planner (Task decomposition & sequencing)', 'mcp-ai-wpoos' ); ?>
					</option>
					<option value="executor" <?php selected( $agent_role, 'executor' ); ?>>
						<?php esc_html_e( 'Executor (Task execution & operations)', 'mcp-ai-wpoos' ); ?>
					</option>
					<option value="critic" <?php selected( $agent_role, 'critic' ); ?>>
						<?php esc_html_e( 'Critic (Quality validation & review)', 'mcp-ai-wpoos' ); ?>
					</option>
					<option value="specialist" <?php selected( $agent_role, 'specialist' ); ?>>
						<?php esc_html_e( 'Specialist (Domain-specific expertise)', 'mcp-ai-wpoos' ); ?>
					</option>
				</select>
				<p class="description">
					<?php esc_html_e( 'Primary role in multi-agent workflows. This determines how the profession is selected for team composition.', 'mcp-ai-wpoos' ); ?>
				</p>
			</div>
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_task_patterns">
					<?php esc_html_e( 'Task Patterns (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_decision_criteria">
					<?php esc_html_e( 'Decision Criteria (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_orchestration_rules">
					<?php esc_html_e( 'Orchestration Rules (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_quality_metrics">
					<?php esc_html_e( 'Quality Metrics (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_tool_execution_order">
					<?php esc_html_e( 'Tool Execution Order (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
			...
			<div class="wp-mcp-ai-orchestration-field">
				<label for="wp_mcp_ai_confidence_thresholds">
					<?php esc_html_e( 'Confidence Thresholds (JSON)', 'mcp-ai-wpoos' ); ?>
				</label>
				<textarea 
