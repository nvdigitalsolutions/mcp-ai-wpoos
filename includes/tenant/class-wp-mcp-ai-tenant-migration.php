 ...
 *
 * Assists with adding tenant columns to existing custom tables and
 * migrating CPT post data to include tenant metadata.
 *
 * Designed for incremental adoption: toolkits can opt into tenant
 * isolation without rebuilding tables from scratch.
 *
 * @package WP_MCP_AI
 * @since   3.1.0
 ...
 */
class WP_MCP_AI_Tenant_Migration {
