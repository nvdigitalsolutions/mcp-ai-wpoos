 ...
 *
 * Creates and maintains the tenant registry and user-to-tenant mapping tables.
 *
 * Tables created:
 *   {prefix}mcp_ai_tenants         — tenant registry
 *   {prefix}mcp_ai_tenant_user_map — user-to-tenant assignments
 *
 ...
 */
class WP_MCP_AI_Tenant_Database {
