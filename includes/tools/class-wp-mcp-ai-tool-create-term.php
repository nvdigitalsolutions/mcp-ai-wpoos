 ...
 */
class WP_MCP_AI_Tool_Create_Term implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			...
			'notes'           => __( 'parent only applies to hierarchical taxonomies; duplicate names in the same taxonomy are rejected.', 'mcp-ai-wpoos' ),
		);
	}
