		...
		if ( ! $component_type || 'plugin' === $component_type ) {
			...
			if ( is_array( $available ) ) {
				foreach ( $available as $plugin_file => $plugin ) {
					...
					$plugin_updates[] = array(
						// phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase -- WordPress plugin header properties use PascalCase.
			...
			if ( is_array( $available ) ) {
				foreach ( $available as $stylesheet => $theme ) {
					...
					$theme_updates[] = array(
						...
						// phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase -- WordPress theme header properties use PascalCase.
