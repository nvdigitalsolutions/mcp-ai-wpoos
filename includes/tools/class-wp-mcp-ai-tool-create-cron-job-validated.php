<?php
/**
 * Tool for scheduling WordPress cron events (Validated version).
 *
 * This is the Symfony Validator version of the create_cron_job tool.
 *
 * @package WP_MCP_AI
 */
...
require_once __DIR__ . '/../validators/arguments/class-create-cron-job-arguments.php';
...
class WP_MCP_AI_Tool_Create_Cron_Job_Validated extends WP_MCP_AI_Validated_Tool implements WP_MCP_AI_Tool_Capability_Flags_Interface {
	 ...
	 *
	 * @param \WP_MCP_AI\Tools\Arguments\CreateCronJobArguments $validated_args Validated arguments object.
