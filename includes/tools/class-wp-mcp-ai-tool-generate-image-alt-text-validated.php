 ...
 */
class WP_MCP_AI_Tool_Generate_Image_Alt_Text_Validated extends WP_MCP_AI_Validated_Tool implements WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Model_Requirements_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Generating alt text with Symfony Validator enforcement of the image source arguments before the vision call.', 'mcp-ai-wpoos' ),
			'when_not_to_use' => __( 'When validation is unneeded or unavailable; use generate_image_alt_text.', 'mcp-ai-wpoos' ),
			'related_tools'   => array( 'generate_image_alt_text', 'generate_image_caption' ),
			'notes'           => __( 'Delegates to generate_image_alt_text after validating image_url, attachment_id, file_id, and context.', 'mcp-ai-wpoos' ),
		);
	}
