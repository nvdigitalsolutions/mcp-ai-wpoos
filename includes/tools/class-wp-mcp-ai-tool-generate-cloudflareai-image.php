 ...
 */
class WP_MCP_AI_Tool_Generate_CloudflareAI_Image implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Shortcuts_Interface, WP_MCP_AI_Tool_LLM_Sanitizer_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Model_Requirements_Interface, WP_MCP_AI_Tool_Rules_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Generating an image with a Cloudflare Workers AI text-to-image model and saving it to the Media Library.', 'mcp-ai-wpoos' ),
			'when_not_to_use' => __( 'Other providers or image editing; use generate_openai_image, generate_gemini_image, or edit_gemini_image.', 'mcp-ai-wpoos' ),
			'related_tools'   => array( 'generate_openai_image', 'generate_gemini_image' ),
			'notes'           => __( 'Model defaults to @cf/stabilityai/stable-diffusion-xl-base-1.0. Reuse a seed for reproducible output.', 'mcp-ai-wpoos' ),
		);
	}
