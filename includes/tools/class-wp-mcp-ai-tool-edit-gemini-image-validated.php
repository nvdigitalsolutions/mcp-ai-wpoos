<?php
/**
 * Tool for editing Gemini images (Validated version).
 *
 * This is the Symfony Validator version of the edit_gemini_image tool.
 *
 * @package WP_MCP_AI
 */
...
require_once __DIR__ . '/../validators/arguments/class-edit-gemini-image-arguments.php';
require_once __DIR__ . '/class-wp-mcp-ai-tool-edit-gemini-image.php';

/**
 * Edits images using Gemini with Symfony Validator.
 *
...
class WP_MCP_AI_Tool_Edit_Gemini_Image_Validated extends WP_MCP_AI_Validated_Tool implements WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Model_Requirements_Interface, WP_MCP_AI_Tool_Shortcuts_Interface, WP_MCP_AI_Tool_LLM_Sanitizer_Interface, WP_MCP_AI_Tool_Rules_Interface {
	...
	public function __construct() {
		parent::__construct();
		$this->original_tool = new WP_MCP_AI_Tool_Edit_Gemini_Image();
	}
	...
	public function get_slug() {
		return 'edit_gemini_image_validated';
	}
	...
	protected function get_validation_class() {
		return \WP_MCP_AI\Tools\Arguments\EditGeminiImageArguments::class;
	}

	/**
	 * Execute the tool with validated arguments.
	 *
	 * @param \WP_MCP_AI\Tools\Arguments\EditGeminiImageArguments $validated_args Validated arguments object.
	...
	protected function execute_validated( $validated_args, $context ) {
		...
		if ( null !== $validated_args->image_data ) {
			$arguments['image_data'] = $validated_args->image_data;
		}

		if ( null !== $validated_args->source_mime_type ) {
			$arguments['source_mime_type'] = $validated_args->source_mime_type;
		}
