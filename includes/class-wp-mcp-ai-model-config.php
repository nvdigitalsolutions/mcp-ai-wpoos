...
class WP_MCP_AI_Model_Config {
	...
	protected static function get_default_configs() {
		return array(
			...
			'o1-preview'     => array(
				'name'           => 'o1 Preview (Deprecated - use o3)',
				'provider'       => 'openai',
				'tpm'            => 30000,
				'rpm'            => 500,
				'tpd'            => 2000000,
			...
			'o1-mini'        => array(
				'name'           => 'o1 Mini (Deprecated - use o3-mini)',
				'provider'       => 'openai',
				'tpm'            => 80000,
				'rpm'            => 800,
				'tpd'            => 5000000,
			...
			// Claude 3.x series (deprecated Nov 10, 2025).
			'claude-3-5-sonnet-20241022' => array(
				'name'           => 'Claude 3.5 Sonnet (Deprecated - use Sonnet 4.5)',
				'provider'       => 'anthropic',
				'tpm'            => 80000,
				'rpm'            => 1000,
				'tpd'            => 5000000,
			...
			'claude-3-5-haiku-20241022' => array(
				'name'           => 'Claude 3.5 Haiku (Deprecated - use Haiku 4.5)',
				'provider'       => 'anthropic',
				'tpm'            => 100000,
				'rpm'            => 2000,
				'tpd'            => 8000000,
			...
			// Mistral models.
			'mistralai/mistral-7b-v0.3' => array(
			...
			'mistralai/mixtral-8x7b' => array(
				...
				'rpd'            => 100000,
				'context_window' => 32768,
				'fallback_model' => 'mistralai/mistral-7b-v0.3',
				'cost_per_1k'    => 0.0,
				'status'         => 'active',
			),
			'mistralai/mixtral-8x22b' => array(
				'name'           => 'Mixtral 8x22B',
				'provider'       => 'lm_studio',
				'tpm'            => 1000000,
				'rpm'            => 10000,
				...
				'fallback_model' => 'mistralai/mixtral-8x7b',
				'cost_per_1k'    => 0.0,
				'status'         => 'active',
			),
			// DeepSeek models.
			'deepseek-ai/deepseek-coder-33b' => array(
			...
			'deepseek-ai/deepseek-v3' => array(
				...
				'rpd'            => 100000,
				'context_window' => 65536,
				'fallback_model' => 'deepseek-ai/deepseek-coder-33b',
				'cost_per_1k'    => 0.0,
				'status'         => 'active',
			),
			...
			'microsoft/phi-4' => array(
				...
				'rpd'            => 100000,
				'context_window' => 16384,
				'fallback_model' => 'microsoft/phi-3.5-mini',
				'cost_per_1k'    => 0.0,
				'status'         => 'active',
			),
			'microsoft/phi-3.5-mini' => array(
				'name'           => 'Phi-3.5 Mini',
				'provider'       => 'lm_studio',
				'tpm'            => 1000000,
				'rpm'            => 10000,
