...
class WP_MCP_AI_Model_Config {
	...
	protected static function get_default_configs() {
		return array(
			...
			// NOTE: Cloudflare Worker AI is treated as a local AI provider with high token limits.
			// These models have generous TPM limits similar to Ollama since Cloudflare provides
			// very high rate limits and low costs. Orchestration layer should allow ~16k+ token budgets.
			//
			// Llama 3.1 models (most popular on Workers AI).
			'@cf/meta/llama-3.1-8b-instruct'               => array(
				'name'           => 'Llama 3.1 8B Instruct',
				'provider'       => 'cloudflare',
				'tpm'            => 1000000,  // Increased to match local AI provider levels.
				'rpm'            => 10000,
				'tpd'            => 50000000,
				'rpd'            => 100000,
				'context_window' => 8000,  // 7,968 tokens per Cloudflare docs.
				'fallback_model' => '@cf/meta/llama-3.2-3b-instruct',
				'cost_per_1k'    => 0.00028,  // $0.28 per 1M input tokens.
				'status'         => 'active',
			),
			'@cf/meta/llama-3.1-8b-instruct-fast'          => array(
				...
				'tpd'            => 50000000,
				'rpd'            => 100000,
				'context_window' => 128000,  // 128K context for large documents.
				'fallback_model' => '@cf/meta/llama-3.1-8b-instruct',
				'cost_per_1k'    => 0.00028,  // Same pricing as standard.
				'status'         => 'active',
			),
			'@cf/meta/llama-3.1-70b-instruct'              => array(
				'name'           => 'Llama 3.1 70B Instruct',
				'provider'       => 'cloudflare',
				'tpm'            => 500000,  // Increased significantly, slightly lower for larger model.
				'rpm'            => 5000,
				'tpd'            => 25000000,
				'rpd'            => 50000,
				'context_window' => 128000,
				'fallback_model' => '@cf/meta/llama-3.1-8b-instruct',
				'cost_per_1k'    => 0.001,  // Higher cost for 70B model.
				'status'         => 'active',
			),
			// Llama 3.2 models (compact, efficient).
			...
			// Llama 2 models (legacy, quantized).
			...
			'@cf/meta/llama-2-13b-chat-int8'               => array(
				'name'           => 'Llama 2 13B Chat (INT8)',
				'provider'       => 'cloudflare',
				'tpm'            => 750000,  // Increased significantly.
				'rpm'            => 7500,
				'tpd'            => 37500000,
				'rpd'            => 75000,
				'context_window' => 4096,
				'fallback_model' => '@cf/meta/llama-2-7b-chat-int4',
				'cost_per_1k'    => 0.0003,
				'status'         => 'active',
			),
			// Llama 4 Scout (multimodal - NEW in 2025).
			'@cf/meta/llama-4-scout'                       => array(
				'name'           => 'Llama 4 Scout (17B, Multimodal)',
				'provider'       => 'cloudflare',
				'tpm'            => 500000,  // Increased significantly, slightly lower for larger multimodal model.
				'rpm'            => 5000,
				'tpd'            => 25000000,
				'rpd'            => 50000,
				'context_window' => 131000,  // Cloudflare supports up to 131K tokens.
				'fallback_model' => '@cf/meta/llama-3.1-8b-instruct',
				'cost_per_1k'    => 0.002,
				'status'         => 'active',
			),
			...
			// Qwen models (multilingual, strong for Chinese).
			...
			'@cf/qwen/qwen1.5-1.8b-chat'                   => array(
				...
				'rpd'            => 100000,
				'context_window' => 32768,
				'fallback_model' => '@cf/qwen/qwen1.5-0.5b-chat',
				'cost_per_1k'    => 0.0001,
				'status'         => 'active',
			),
			'@cf/qwen/qwen1.5-7b-chat-awq'                 => array(
				...
				'rpd'            => 100000,
				'context_window' => 32768,
				'fallback_model' => '@cf/qwen/qwen1.5-1.8b-chat',
				'cost_per_1k'    => 0.0002,
				'status'         => 'active',
			),
			'@cf/qwen/qwen1.5-14b-chat-awq'                => array(
				...
				'rpd'            => 75000,
				'context_window' => 32768,
				'fallback_model' => '@cf/qwen/qwen1.5-7b-chat-awq',
				'cost_per_1k'    => 0.00035,
				'status'         => 'active',
			),
			...
			'@cf/qwen/qwen3-30b-a3b-fp8'                   => array(
				...
				'provider'       => 'cloudflare',
				'tpm'            => 400000,  // Increased significantly.
				'rpm'            => 4000,
				'tpd'            => 20000000,
				'rpd'            => 40000,
				'context_window' => 32768,
			...
			'@cf/tinyllama/tinyllama-1.1b-chat-v1.0'       => array(
			...
			'@cf/microsoft/phi-2'                          => array(
				...
				'rpd'            => 100000,
				'context_window' => 2048,
				'fallback_model' => '@cf/tinyllama/tinyllama-1.1b-chat-v1.0',
				'cost_per_1k'    => 0.0001,
				'status'         => 'active',
			),
			// Specialized models.
			'@cf/tiiuae/falcon-7b-instruct'                => array(
			...
			'@cf/deepseek-ai/deepseek-math-7b-instruct'    => array(
			...
			'@cf/openchat/openchat-3.5-0106'               => array(
				'name'           => 'OpenChat 3.5',
				'provider'       => 'cloudflare',
				'tpm'            => 100000,
				'rpm'            => 500,
