...
class WP_MCP_AI_Model_Config {
	 ...
	 * Merge user configs with defaults.
			...
			'gpt-5.2-codex'                                => array(
				'name'           => 'GPT-5.2 Codex (Advanced Coding)',
				'provider'       => 'openai',
				'tpm'            => 100000,
				'rpm'            => 1000,
				'tpd'            => 10000000,
			...
			// Comprehensive catalog with costs, rate limits, and
			// context windows sourced from build.nvidia.com.
			// ──────────────────────────────────────────────────────

			// ── Meta Llama 3.x Family (Function Calling) ──────────
			'meta/llama-3.3-70b-instruct'                   => array(
				'name'           => 'Llama 3.3 70B Instruct',
				'provider'       => 'nvidia',
				'tpm'            => 100000,
				'rpm'            => 1000,
			...
			'meta/llama-3.1-405b-instruct'                  => array(
			...
			'meta/llama-3.1-70b-instruct'                   => array(
				'name'           => 'Llama 3.1 70B Instruct',
				'provider'       => 'nvidia',
				'tpm'            => 100000,
				'rpm'            => 1000,
			...
			'meta/llama-3.1-8b-instruct'                    => array(
				'name'           => 'Llama 3.1 8B Instruct',
				'provider'       => 'nvidia',
				'tpm'            => 200000,
				'rpm'            => 2000,
			...
			'meta/llama-3.2-3b-instruct'                    => array(
				'name'           => 'Llama 3.2 3B Instruct',
				'provider'       => 'nvidia',
				'tpm'            => 200000,
				'rpm'            => 2000,
				...
				'rpd'            => 20000,
				'context_window' => 131072,
				'fallback_model' => 'meta/llama-3.2-1b-instruct',
				'cost_per_1k'    => 0.00006,
				'status'         => 'active',
			),
			'meta/llama-3.2-1b-instruct'                    => array(
				'name'           => 'Llama 3.2 1B Instruct',
				'provider'       => 'nvidia',
				'tpm'            => 250000,
				'rpm'            => 2500,
			...
			'meta/llama-3.2-90b-vision-instruct'            => array(
			...
			'meta/llama-3.2-11b-vision-instruct'            => array(
			...
			'nvidia/llama-3.1-nemotron-70b-instruct'        => array(
			...
			'nvidia/nemotron-3-super-120b-a12b'             => array(
			...
			'nvidia/nemotron-3-nano-30b-a3b'                => array(
				'name'           => 'Nemotron 3 Nano 30B (MoE)',
				'provider'       => 'nvidia',
				'tpm'            => 150000,
				'rpm'            => 1500,
				'tpd'            => 7500000,
			...
			// ── Mistral AI Models ─────────────────────────────────
			'mistralai/mistral-large-2-instruct'            => array(
			...
			'microsoft/phi-3-medium-128k-instruct'          => array(
			...
			'microsoft/phi-3-mini-128k-instruct'            => array(
			...
			'microsoft/phi-3-small-128k-instruct'           => array(
			...
			'deepseek-ai/deepseek-r1'                      => array(
				...
				'rpd'            => 6000,
				'context_window' => 131072,
				'fallback_model' => 'deepseek-ai/deepseek-r1-distill-llama-70b',
				'cost_per_1k'    => 0.001,
				'status'         => 'active',
			),
			'deepseek-ai/deepseek-r1-distill-llama-70b'    => array(
				...
				'rpd'            => 8000,
				'context_window' => 131072,
				'fallback_model' => 'deepseek-ai/deepseek-r1-distill-llama-8b',
				'cost_per_1k'    => 0.0004,
				'status'         => 'active',
			),
			'deepseek-ai/deepseek-r1-distill-llama-8b'     => array(
			...
			'deepseek-ai/deepseek-r1-distill-qwen-32b'     => array(
				'name'           => 'DeepSeek R1 Distill Qwen 32B',
				'provider'       => 'nvidia',
				'tpm'            => 100000,
				'rpm'            => 1000,
				...
				'rpd'            => 10000,
				'context_window' => 131072,
				'fallback_model' => 'deepseek-ai/deepseek-r1-distill-qwen-14b',
				'cost_per_1k'    => 0.0003,
				'status'         => 'active',
			),
			'deepseek-ai/deepseek-r1-distill-qwen-14b'     => array(
				...
				'rpd'            => 15000,
				'context_window' => 131072,
				'fallback_model' => 'deepseek-ai/deepseek-r1-distill-qwen-7b',
				'cost_per_1k'    => 0.0002,
				'status'         => 'active',
			),
			'deepseek-ai/deepseek-r1-distill-qwen-7b'      => array(
			...
			'ibm/granite-34b-code-instruct'                 => array(
				...
				'rpd'            => 8000,
				'context_window' => 8192,
				'fallback_model' => 'ibm/granite-8b-code-instruct',
				'cost_per_1k'    => 0.0004,
				'status'         => 'active',
			),
			'ibm/granite-8b-code-instruct'                  => array(
			...
			'meta/llama-4-maverick-17b-128e-instruct'       => array(
				...
				'rpd'            => 8000,
				'context_window' => 1048576,
				'fallback_model' => 'meta/llama-4-scout-17b-16e-instruct',
				'cost_per_1k'    => 0.0005,
				'status'         => 'active',
			),
			'meta/llama-4-scout-17b-16e-instruct'           => array(
			...
			'qwen/qwen3-14b'                                => array(
				'name'           => 'Qwen 3 14B (Dense)',
				'provider'       => 'nvidia',
				'tpm'            => 150000,
				'rpm'            => 1500,
				'tpd'            => 7500000,
			...
			'qwen/qwen3.5-397b-a17b'                        => array(
				'name'           => 'Qwen 3.5 397B A17B (VLM, MoE)',
				'provider'       => 'nvidia',
				'tpm'            => 40000,
				'rpm'            => 400,
				'tpd'            => 2000000,
			...
			'qwen/qwen3-coder-480b-a35b-instruct'           => array(
			...
			'google/gemma-3n-e4b-it'                        => array(
				'name'           => 'Gemma 3n E4B IT (Edge/Mobile)',
				'provider'       => 'nvidia',
				'tpm'            => 200000,
				'rpm'            => 2000,
				'tpd'            => 10000000,
			...
			'mistralai/mistral-small-24b-instruct-2501'     => array(
