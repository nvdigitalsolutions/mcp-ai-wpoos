<?php
/**
 * Mailjet OAuth Handler for WP MCP AI
 *
 * Handles OAuth flows for Mailjet email service integration.
 *
 * @package WP_MCP_AI
 */
...
if ( ! class_exists( 'WP_MCP_AI_Mailjet_OAuth_Handler' ) ) {
	/**
	 * Manages Mailjet OAuth authentication flows.
	 */
	class WP_MCP_AI_Mailjet_OAuth_Handler {
