<?php
/**
 * Simple JWT Login integration for WP MCP AI.
 *
 * @package WP_MCP_AI
 */
...
if ( ! class_exists( 'WP_MCP_AI_Integration_Simple_JWT' ) ) {
	...
	/**
	 * Bridges Simple JWT Login bearer tokens into WP MCP AI authentication.
	 */
	class WP_MCP_AI_Integration_Simple_JWT {
		...
		/**
		 * Build the authentication context passed to WP MCP AI.
		 *
		 * @param array        $payload Decoded JWT payload.
