...
class WP_MCP_AI_Comments {
	...
	private function log_error( $message ) {
		...
		error_log( $log_entry ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log -- error_log used as a diagnostic fallback logger; active only when plugin logging is enabled in settings or as last-resort error capture in catch blocks.
