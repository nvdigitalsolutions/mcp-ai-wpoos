<?php
/**
 * JetEngine Custom Content Type registration for AI assistants.
 *
 *
 * @package WP_MCP_AI
 */
...
/**
 * Ensure the AI assistants CCT exists and expose helper accessors.
 */
class WP_MCP_AI_JetEngine_Assistants_CCT {
	...
	/**
	 * Retrieve the assistants CCT slug.
	 *
	 * @return string
	 */
	...
	/**
	 * Register the assistants CCT if it is missing.
	 */
	...
	/**
	 * Determine whether the assistants CCT already exists.
	 *
	...
	/**
	 * Assemble the JetEngine arguments for the assistants CCT.
	 *
	...
	/**
	 * Define the assistants meta field configuration.
	 *
	 * @return array
	 */
