...
class WP_MCP_AI_Elementor_Dashboard_Activity_Feed_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'MCP AI Activity Feed', 'wp-mcp-ai' );
    }
    ...
    protected function render() {
        ...
        if ( ! class_exists( 'WP_MCP_AI_Admin_Settings' ) || ! WP_MCP_AI_Admin_Settings::is_logging_enabled() ) {
            echo '<p class="wp-mcp-ai-activity-feed__notice">' . esc_html__( 'Enable logging in the MCP AI settings to populate the activity feed.', 'wp-mcp-ai' ) . '</p>';
            echo '</div>';
            return;
        }
