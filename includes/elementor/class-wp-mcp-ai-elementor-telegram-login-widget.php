...
class WP_MCP_AI_Elementor_Telegram_Login_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Shortcode output is generated by WP_MCP_AI_Telegram_Login_Controller::render_login_widget() which escapes all attributes with esc_attr(). The output is a Telegram SDK <script> embed tag that wp_kses_post() strips entirely, breaking the login widget.
