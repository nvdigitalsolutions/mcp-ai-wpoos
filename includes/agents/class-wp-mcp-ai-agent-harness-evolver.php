...
class WP_MCP_AI_Agent_Harness_Evolver {
	...
	public function should_evolve( $iteration ) {
		...
		return ( $iteration % $frequency === 0 ); // phpcs:ignore WordPress.PHP.YodaConditions.NotYoda
	}
...
/**
\t * Class WP_MCP_AI_Agent_Harness_Evolver_Role_Adapter
\t *
\t * Adapts harness evolution results for role-based access control.
\t */
