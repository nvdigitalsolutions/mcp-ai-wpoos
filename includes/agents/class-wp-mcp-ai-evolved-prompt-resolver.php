 ...
 *
 * @see WP_MCP_AI_Agent_Harness_Evolver Core evolution engine that produces evolved prompts.
 */
 ...
 * @since 1.9.0
 */
class WP_MCP_AI_Evolved_Prompt_Resolver {
	...
	public static function filter( $prompt, $assistant_id, $context = array() ) {
		...
		if ( class_exists( 'WP_MCP_AI_Artifact_Shadow' ) && WP_MCP_AI_Artifact_Shadow::is_enabled( $assistant_id, 'prompt' ) ) {
