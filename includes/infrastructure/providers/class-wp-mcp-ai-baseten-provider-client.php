<?php
/**
 * Baseten Provider Client Adapter
 *
 * Implements Interface_WP_MCP_AI_Provider_Client by delegating to the
 * concrete WP_MCP_AI_Baseten_Client class.
 *
 * @package WP_MCP_AI
 * @since   1.2.0
...
/**
 * Baseten implementation of the Provider Client interface.
 *
 * @since 1.2.0
 */
class WP_MCP_AI_Baseten_Provider_Client implements Interface_WP_MCP_AI_Provider_Client {

	/**
	 * The underlying Baseten client.
	 *
	 ...
	 * Constructor.
	 *
	 * @param WP_MCP_AI_Baseten_Client|null $client Optional concrete client. Defaults to a new instance.
	 */
	public function __construct( $client = null ) {
		$this->client = $client instanceof WP_MCP_AI_Baseten_Client ? $client : new WP_MCP_AI_Baseten_Client();
	}
	 ...
	 *
	 * Baseten streaming uses the same SSE protocol as OpenAI, so this
	 * delegates to `create_chat_completion` with `stream => true`.
	 *
	...
	/**
	 * Return a list of available Baseten models.
	 *
