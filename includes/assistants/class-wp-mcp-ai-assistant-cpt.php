	...
	class WP_MCP_AI_Assistant_CPT {
		...
		protected function get_tool_presets() {
			$presets = array(
				...
				'ai_ml_operations'    => array(
					'name'        => __( 'AI/ML Operations', 'wp-mcp-ai' ),
					'description' => __( 'AI model management, embeddings, vector stores, and batch operations', 'wp-mcp-ai' ),
					'tools'       => array(
						'get_model_information',
						'list_available_models',
						'suggest_best_model',
				...
				'media_production'    => array(
					'name'        => __( 'Media Production', 'wp-mcp-ai' ),
					'description' => __( 'Video, audio, and multimedia content creation and editing', 'wp-mcp-ai' ),
					'tools'       => array(
						'generate_veo_video',
						'generate_sora_video',
						'check_video_status',
