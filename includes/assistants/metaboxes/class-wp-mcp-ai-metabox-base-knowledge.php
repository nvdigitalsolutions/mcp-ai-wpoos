...
class WP_MCP_AI_Metabox_Base_Knowledge extends WP_MCP_AI_Metabox_Base {
	...
	public function get_documentation_url() {
		return 'https://github.com/nvdigitalsolutions/mcp-ai-wpoos/blob/main/docs/user-guides/professionals/profession-base-knowledge-seeding.md';
	}
	...
	<p>
		...
		<input type="text" id="wp-mcp-ai-corpus-name" name="wp_mcp_ai_corpus_name" value="<?php echo esc_attr( $corpus_name ); ?>" class="widefat" />
		<span class="description">
			<?php
			esc_html_e(
				'Optional Gemini corpus resource name for native RAG (e.g. "corpora/my-corpus-id"). When set, this corpus is used as a semantic retrieval source in every Gemini request for this assistant.',
				'mcp-ai-wpoos'
			);
			?>
		</span>
