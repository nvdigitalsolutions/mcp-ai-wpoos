	...
	class WP_MCP_AI_Tool_Registry {
		...
		protected function load_default_tools() {
			...
			$base_tools = array(
				...
				'WP_MCP_AI_Tool_Generate_Higgsfield_Video' => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-generate-higgsfield-video.php',
				'WP_MCP_AI_Tool_Generate_Higgsfield_Image' => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-generate-higgsfield-image.php',
				'WP_MCP_AI_Tool_Check_Higgsfield_Request'  => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-check-higgsfield-request.php',
				'WP_MCP_AI_Tool_Cancel_Higgsfield_Request' => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-cancel-higgsfield-request.php',
				...
				'WP_MCP_AI_Tool_List_Terms'                => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-list-terms.php',
				'WP_MCP_AI_Tool_List_Taxonomies'           => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-list-taxonomies.php',
				// Comment management tools (ported from docdyhr/mcp-wordpress, MIT).
				'WP_MCP_AI_Tool_List_Comments'             => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-list-comments.php',
				'WP_MCP_AI_Tool_Get_Comment'               => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-get-comment.php',
				'WP_MCP_AI_Tool_Create_Comment'            => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-create-comment.php',
				'WP_MCP_AI_Tool_Update_Comment'            => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-update-comment.php',
				'WP_MCP_AI_Tool_Delete_Comment'            => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-delete-comment.php',
				// User management tools (ported from docdyhr/mcp-wordpress, MIT).
				'WP_MCP_AI_Tool_List_Users'                => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-list-users.php',
				'WP_MCP_AI_Tool_Create_User'               => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-create-user.php',
				'WP_MCP_AI_Tool_Update_User'               => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-update-user.php',
				'WP_MCP_AI_Tool_Delete_User'               => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-delete-user.php',
				// Content/taxonomy/media tools (ported from docdyhr/mcp-wordpress, MIT).
				'WP_MCP_AI_Tool_Get_Post_Revisions'        => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-get-post-revisions.php',
				'WP_MCP_AI_Tool_Get_Term'                  => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-get-term.php',
				'WP_MCP_AI_Tool_Delete_Term'               => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-delete-term.php',
				'WP_MCP_AI_Tool_Get_Media'                 => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-get-media.php',
				'WP_MCP_AI_Tool_Upload_Media'              => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-upload-media.php',
				'WP_MCP_AI_Tool_Update_Media'              => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-update-media.php',
				'WP_MCP_AI_Tool_Delete_Media'              => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-delete-media.php',
				// Site settings and application password tools (ported from docdyhr/mcp-wordpress, MIT).
				'WP_MCP_AI_Tool_Get_Site_Settings'         => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-get-site-settings.php',
				'WP_MCP_AI_Tool_Update_Site_Settings'      => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-update-site-settings.php',
				'WP_MCP_AI_Tool_List_Application_Passwords' => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-list-application-passwords.php',
				...
				'WP_MCP_AI_Tool_Duplicate_Assistant'       => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-duplicate-assistant.php',
