	...
	class WP_MCP_AI_Tool_Registry {
		...
		public function get_tool_group_map() {
			...
			$default_map = array(
				...
				// Firefly III personal finance manager integration.
				'firefly_get_accounts'               => 'external-tools',
				'firefly_get_transactions'           => 'external-tools',
				'firefly_create_transaction'         => 'external-tools',
		...
		protected function load_default_tools() {
			...
			$extended_tools = array(
				...
				// Firefly III personal finance manager integration.
				'WP_MCP_AI_Tool_Firefly_Get_Accounts'      => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-firefly-get-accounts.php',
				'WP_MCP_AI_Tool_Firefly_Get_Transactions'  => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-firefly-get-transactions.php',
				'WP_MCP_AI_Tool_Firefly_Create_Transaction' => WP_MCP_AI_PATH . 'includes/tools/class-wp-mcp-ai-tool-firefly-create-transaction.php',
