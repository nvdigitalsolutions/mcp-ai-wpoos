 ...
 * ACP Session Bridge.
 *
 * Translates ACP ContentBlocks <-> existing NV oOS chat messages.
 * Maps ACP `tool_call` requests to the core `WP_MCP_AI_Tool_Registry`.
...
/**
 * Bridge between ACP specification and internal NV oOS implementation.
 */
class WP_MCP_AI_ACP_Session_Bridge {

	/**
	 * Chat Service Instance.
	 *
	 * @var WP_MCP_AI_Chat_Service|null
	 */
	 ...
	 *
	 * @param WP_MCP_AI_Chat_Service $chat_service The chat service.
	 */
	...
	/**
	 * Map ACP ContentBlocks to NV oOS message format.
	 *
