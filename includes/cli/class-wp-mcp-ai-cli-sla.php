...
$display_items = array(
array( 'metric' => 'Tier', 'value' => $tier ),
array( 'metric' => 'SLA Target', 'value' => $metrics['sla_target'] . 's' ),
array( 'metric' => 'Arrival Rate', 'value' => number_format( $metrics['arrival_rate'], 2 ) . ' jobs/sec' ),
array( 'metric' => 'Service Time', 'value' => number_format( $metrics['service_time'], 2 ) . 's' ),
array( 'metric' => 'Wait Time', 'value' => number_format( $metrics['wait_time'], 2 ) . 's' ),
array( 'metric' => 'Queue Length', 'value' => number_format( $metrics['queue_length'], 2 ) ),
array( 'metric' => 'System Capacity', 'value' => number_format( $metrics['system_capacity'], 2 ) ),
array( 'metric' => 'Utilization', 'value' => number_format( $metrics['utilization'] * 100, 1 ) . '%' ),
array( 'metric' => 'Required Workers', 'value' => $metrics['required_workers'] ),
array( 'metric' => 'Recommended Workers', 'value' => $metrics['recommended_workers'] ),
array( 'metric' => 'Max Concurrent', 'value' => $metrics['max_concurrent'] ),
array( 'metric' => 'Over Capacity', 'value' => $metrics['over_capacity'] ? 'Yes' : 'No' ),
array( 'metric' => 'Meets SLA', 'value' => $metrics['meets_sla'] ? 'Yes' : 'No' ),
);
