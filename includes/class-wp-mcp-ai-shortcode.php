	...
	public function register_assets() {
		...
		wp_localize_script(
			...
			array(
				...
				'asyncToolTimeout'    => self::get_async_tool_timeout_ms( $settings ),
				'chatDebugMode'       => $chat_debug_mode,
				'voiceMode'           => isset( $settings['voice_mode'] ) ? $settings['voice_mode'] : 'auto',
				...
				'vadSilenceThreshold' => isset( $settings['vad_silence_threshold'] ) ? absint( $settings['vad_silence_threshold'] ) : 1200,
				'vadMinSpeech'        => isset( $settings['vad_min_speech_duration'] ) ? absint( $settings['vad_min_speech_duration'] ) : 400,
				'vadMinRecordingMs'   => isset( $settings['vad_min_recording_ms'] ) ? absint( $settings['vad_min_recording_ms'] ) : 500,
