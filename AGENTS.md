...
| **Zed Agent Skills** | Zed Industries | [`.agents/skills/*.md`](.agents/skills/) | Auto-discovered by Zed agent panel | 60 coding-time agent skills (20 wp-* WordPress plugin development patterns + 33 design-* skills + mcp-ai-wpoos-plugin operational guide + mcp-ai-wpoos-test-suite repair guide + mcp-ai-wpoos-updates maintenance guide + mcp-ai-wpoos-wporg-submission wp.org readiness guide + mcp-ai-wpoos-ecosystem-port base+pro→CG Pro port guide + mcp-ai-wpoos-assistant-portability export/import guide + mcp-ai-wpoos-playground-demos Playground demo blueprint guide) — distinct from runtime bundled skills |
...
| **Bundled with base** | `includes/bundled-skills/` — **75** general-purpose skills (up from 67 in v1.1.54): 32 design-* skills (analytics-reporting through web-research), mcp-ai-wpoos-plugin operational guide, plus existing Anthropic-authored skills (document handling, design, testing) + WordPress-developer skills (security, APIs, plugin patterns) + ui-ux-pro-max design system skill. |
| **Bundled with Pro** | `addons/pro/includes/bundled-skills/` — **41** WordPress-developer skills curated from [`Lonsdale201/wp-agent-skills`](https://github.com/Lonsdale201/wp-agent-skills) (Google Workspace, WooCommerce, JetEngine, JetFormBuilder, WP Rocket, etc.) plus a `THIRD_PARTY_NOTICES.md`. |
| **Addon skill packs** | `addons/fleet-operator/skills/nvoos/` — 3 Hermes operator skills (`nvoos-approvals`, `nvoos-operations`, `nvoos-site-context`) shipped with the Fleet Operator addon. |
...
**Coding-time skills (`.agents/skills/`) vs runtime skills:** The `.agents/skills/` directory contains **60** coding-time agent skills auto-discovered by the Zed editor (33 design-* skills + 20 wp-* WordPress plugin development patterns + 1 mcp-ai-wpoos-plugin operational guide + 1 mcp-ai-wpoos-test-suite repair guide + 1 mcp-ai-wpoos-updates maintenance guide + 1 mcp-ai-wpoos-wporg-submission wp.org readiness guide + 1 mcp-ai-wpoos-ecosystem-port base+pro→CG Pro port guide + 1 mcp-ai-wpoos-assistant-portability export/import guide + 1 mcp-ai-wpoos-playground-demos Playground demo blueprint guide). These are distinct from the runtime Agent Skills (75 base + 41 Pro bundled skills loaded by NV oOS assistants at runtime). The `.agents/skills/` files are WordPress plugin development patterns that guide coding agents, while the runtime skills (`includes/bundled-skills/`) are SKILL.md files loaded by AI assistants during conversations.
