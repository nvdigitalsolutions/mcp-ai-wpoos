...
| **Bundled with base** | `includes/bundled-skills/` — **67** general-purpose skills (up from 45 in v1.1.53): 22 new design-* skills (analytics-reporting through web-research), mcp-ai-wpoos-plugin operational guide, plus existing Anthropic-authored skills (document handling, design, testing) + WordPress-developer skills (security, APIs, plugin patterns) + ui-ux-pro-max design system skill. |
