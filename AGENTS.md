...
| **Bundled with base** | `includes/bundled-skills/` — **75** general-purpose skills (up from 67 in v1.1.54): 30 design-* skills (analytics-reporting through web-research), mcp-ai-wpoos-plugin operational guide, plus existing Anthropic-authored skills (document handling, design, testing) + WordPress-developer skills (security, APIs, plugin patterns) + ui-ux-pro-max design system skill. |
