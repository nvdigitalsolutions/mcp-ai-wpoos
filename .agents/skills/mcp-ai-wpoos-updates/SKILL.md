...
`v1.1.75-docs-catch-up.md`) and the model-catalog process docs, including the
...
3. **Read the template plans** — the latest executed plan (e.g.
   `v1.1.75-docs-catch-up.md`) plus `v1.1.58`/`v1.1.59` for the original
   structure.
...
5. **Create the plan** `docs/project/plans/[VERSION]-docs-catch-up.md` if none
   exists, with the v1.1.75 structure:
...
### A3. Commit structure (mirror v1.1.58–v1.1.75)
...
- Plan templates: `docs/project/plans/v1.1.58-docs-catch-up.md`,
  ...
  `docs/project/plans/v1.1.75-docs-catch-up.md` (latest executed)
