<?php
/**
 * Tests for WP_MCP_AI_Pro_Tool_Schedule_All_Export.
 *
 ...
 * with WP_Error('wp_mcp_ai_all_export_missing').
 *
 * @package WP_MCP_AI
 */

/**
 * Test case for the schedule_all_export pro tool.
 */
class Test_Tool_Pro_Schedule_All_Export extends WP_UnitTestCase {

	/**
	 * Tool instance under test.
	 *
	 * @var WP_MCP_AI_Pro_Tool_Schedule_All_Export
	 */
	private $tool;
	 ...
	 */
	public function test_get_slug_returns_schedule_all_export() {
		$this->assertSame( 'schedule_all_export', $this->tool->get_slug() );
	}
	...
	public function test_is_available_returns_false_without_plugin() {
		$this->assertFalse( WP_MCP_AI_Pro_Tool_Schedule_All_Export::is_available() );
	}
	...
	/**
	 * Test that get_parameters_schema requires export_id.
	 */
