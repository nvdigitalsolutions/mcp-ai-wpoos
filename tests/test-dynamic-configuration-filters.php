...
class WP_MCP_AI_Dynamic_Configuration_Filters_Test extends WP_UnitTestCase {
	...
	public function test_sse_heartbeat_interval_filter() {
		...
		add_filter( 'wp_mcp_ai_sse_heartbeat_interval', function() {
			return 30;
		} );
	...
	public function test_rate_limit_max_delay_filter() {
		...
		add_filter( 'wp_mcp_ai_rate_limit_max_delay', function() {
			return 60;
		} );
	...
	public function test_rate_limit_backoff_multiplier_filter() {
		...
		add_filter( 'wp_mcp_ai_rate_limit_backoff_multiplier', function() {
			return 3;
		} );
	...
	public function test_token_budget_min_chunk_size_filter() {
		...
		add_filter( 'wp_mcp_ai_token_budget_min_chunk_size', function() {
			return 2000;
		} );
	...
	public function test_token_budget_max_input_tokens_filter() {
		...
		add_filter( 'wp_mcp_ai_token_budget_max_input_tokens', function() {
			return 20000;
		} );
	...
	public function test_wpcom_userinfo_endpoint_filter() {
		...
		add_filter( 'wp_mcp_ai_default_wpcom_userinfo_endpoint', function() {
	...
	public function test_gmail_oauth_scope_filter() {
		...
		add_filter( 'wp_mcp_ai_gmail_oauth_scope', function() {
	...
	public function test_gmail_oauth_authorize_endpoint_filter() {
		...
		add_filter( 'wp_mcp_ai_gmail_oauth_authorize_endpoint', function() {
	...
	public function test_gmail_oauth_token_endpoint_filter() {
		...
		add_filter( 'wp_mcp_ai_gmail_oauth_token_endpoint', function() {
	...
	public function test_gmail_profile_endpoint_filter() {
		...
		add_filter( 'wp_mcp_ai_gmail_profile_endpoint', function() {
