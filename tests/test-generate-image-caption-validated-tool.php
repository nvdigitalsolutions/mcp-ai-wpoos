<?php
/**
 * Tests for Generate Image Caption Validated Tool
 *
 * @package WP_MCP_AI
 */

/**
 * Class Test_WP_MCP_AI_Tool_Generate_Image_Caption_Validated
 *
 * Tests for the validated generate_image_caption tool using Symfony Validator.
 */
class Test_WP_MCP_AI_Tool_Generate_Image_Caption_Validated extends WP_UnitTestCase {

	/**
	 * Tool instance.
	 *
	 * @var WP_MCP_AI_Tool_Generate_Image_Caption_Validated
	 */
	private $tool;
	...
	public function setUp(): void {
		...
		require_once dirname( __DIR__ ) . '/includes/validators/arguments/class-generate-image-caption-arguments.php';
		require_once dirname( __DIR__ ) . '/includes/tools/class-wp-mcp-ai-tool-generate-image-caption-validated.php';
		...
		$this->tool = new WP_MCP_AI_Tool_Generate_Image_Caption_Validated();
	}
	...
	public function test_tool_metadata() {
		$this->assertEquals( 'generate_image_caption_validated', $this->tool->get_slug() );
	...
	public function test_validation_fails_with_context_too_long() {
		$arguments = array(
			'attachment_id' => 123,
			'context'       => str_repeat( 'a', 1001 ), // Over 1000 char limit.
		);
	...
	public function test_validation_passes_with_valid_context() {
		$arguments = array(
			'image_url' => 'https://example.com/image.jpg',
			'context'   => 'This is a landscape photo taken at sunset',
		);
