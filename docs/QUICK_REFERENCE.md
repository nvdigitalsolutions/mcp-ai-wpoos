...
- [Tool Reference](reference/tools/tool-reference.md) - All ~1,572 tools detailed (~306 base + ~1,266 Pro; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
