...
- [Tool Reference](reference/tools/tool-reference.md) - All ~1,586 tools detailed (~307 base + ~1,279 Pro; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
