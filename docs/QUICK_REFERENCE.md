...
- [Tool Reference](reference/tools/tool-reference.md) - All ~1,585 tools detailed (~306 base + ~1,279 Pro; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
