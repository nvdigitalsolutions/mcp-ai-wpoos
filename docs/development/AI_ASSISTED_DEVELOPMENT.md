...
- **May 2026 (v1.1.22–v1.1.25)**: Pre-submission code review — 6-agent parallel audit, 1 Critical + 5 Warnings resolved. Addons PHPCS 93% reduction. Gate 2 output escaping hardened. 18 files fixed across 3 audit passes.
