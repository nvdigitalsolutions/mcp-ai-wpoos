...
| [ORCHESTRATION-LAYER-ARCHITECTURE.md](architecture/orchestration/ORCHESTRATION-LAYER-ARCHITECTURE.md) | 60KB | 90 min | Technical deep-dive |
...
- **[Performance](features/performance/chat-performance-optimizations.md)** - Speed optimization
