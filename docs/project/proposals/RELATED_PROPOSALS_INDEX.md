...
| [`031-media-worker-crawl4ai-integration-plan.md`](./031-media-worker-crawl4ai-integration-plan.md) | ✅ Phases 1–2 implemented (worker v3.1.0) | **Crawling in the worker** — native `/api/crawl/*` endpoints, Crawl4AI-compatible facade for the plugin's `run_crawl4ai_job` remote mode, optional full Crawl4AI sibling container |
