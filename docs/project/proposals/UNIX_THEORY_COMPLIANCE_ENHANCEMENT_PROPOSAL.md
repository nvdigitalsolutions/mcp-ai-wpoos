...
- [x] `produces` / `consumes` metadata fields are documented in [`docs/reference/tools/tool-reference.md`](../reference/tools/tool-reference.md) and positioned as a data-contract layer alongside the existing capability flags / rules interfaces.
