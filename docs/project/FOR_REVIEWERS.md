...
**Current version:** 1.1.84 (September 2026)
...
| Is there a Pro/freemium model? | Yes. Base is fully functional GPLv3. Pro addon adds ~1,282 advanced tools (commercial license). Base never gates features behind a license check. |
