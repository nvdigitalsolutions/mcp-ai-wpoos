...
- **26 additional addons** (various licenses) — `addons/*/` (including Fleet Operator, Media Worker v3.2.0, Checkout API v0.1.1)
...
**Current version:** 1.1.78 (September 2026)
...
| Is there a Pro/freemium model? | Yes. Base is fully functional GPLv3. Pro addon adds ~1,265 advanced tools (commercial license). Base never gates features behind a license check. |
...
├── tools/                     ← ~303 base tool classes (~1,568 total registered through the singleton registry)
...
6. **Tool registry** — How ~1,568 tools are registered and discovered
