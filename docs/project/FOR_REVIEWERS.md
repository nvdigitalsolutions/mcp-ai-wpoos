...
**Current version:** 1.1.67 (September 2026)
...
| Is there a Pro/freemium model? | Yes. Base is fully functional GPLv3. Pro addon adds ~1,262 advanced tools (commercial license). Base never gates features behind a license check. |
...
├── tools/                     ← ~303 base tool classes (~1,565 total registered through the singleton registry)
...
6. **Tool registry** — How ~1,565 tools are registered and discovered
