...
**Current version:** 1.1.87 (September 2026)
...
| Is there a Pro/freemium model? | Yes. Base is fully functional GPLv3. Pro addon adds ~1,287 advanced tools (commercial license). Base never gates features behind a license check. |
...
├── tools/                     ← ~347 base tool classes (~1,634 total registered through the singleton registry)
