...
| 5 | E6 | OOS/markup/paper-store/OKF/crawler | M | **Decision-gated (plan decision D4/D5)** — re-confirm the decision in the gap analysis before starting; if still parked, mark ⏸️ and move on. |
