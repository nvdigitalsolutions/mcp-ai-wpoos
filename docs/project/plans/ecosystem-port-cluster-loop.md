...
| 5 | E6 | OOS/markup/paper-store/OKF/crawler | M | Decision D4 resolved (fold into CG-AI under `Engine\`, gap-analysis §10); sub-cluster 1 (OOS shadow) + sub-cluster 2 (markup) landed — continue with paper-store / OKF / crawler sub-clusters. |
