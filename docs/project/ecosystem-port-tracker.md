...
| D5 | REST surface (mcp-ai/v1 chat/tools/assistants/MCP methods) | 🟡 | D5a–D5c done (58 new ecosystem tests); remaining: chat compat route, file-download/cron-status endpoints — tracked in the plan's D5 scope |
