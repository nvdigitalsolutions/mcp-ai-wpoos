...
| D1 | Chat runtime core (clients, router, selector, caches, summarizer, RAG bridge, threads, transcripts, SSE, attachments, quick actions) | 🟡 | D1a–D1f done; chatkit next; remote file-API uploads gated on D2 |
