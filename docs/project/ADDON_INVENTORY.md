...
| 4 | **Chat SPA** | `addons/chat-spa/` | 0.6.0 | ✅ Production | GPL-3.0 | Base plugin | React-based chat surface using Vercel AI SDK. Drop-in shortcode + Gutenberg block. Connects to existing NV oOS REST endpoints. |
...
6. Docs Hub, Embedded, Canvas, Cornerstone3D, Fantasy Football, SaaS Controller, Cloudways Dashboard, Comic Reader

### Tier 4 — Skip
7. Blueprint-generated SPAs (Canvas Toolkit, Document Editor, Media Studio, Toolkit Shell)
8. Cloud Worker (not a WordPress plugin)
9. Core plugin (separate product, v1.0.0)

---

**Related documents:** [FOR_REVIEWERS.md](FOR_REVIEWERS.md) · [SECURITY_POSTURE.md](SECURITY_POSTURE.md) · [compliance/TRACEABILITY.md](../operations/compliance/TRACEABILITY.md)
