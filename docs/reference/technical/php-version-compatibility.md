...
This document explains the defensive PHP version checking strategy implemented in the Open Operator System (NV oOS) plugin to prevent parse errors on servers running PHP versions older than 7.4.
