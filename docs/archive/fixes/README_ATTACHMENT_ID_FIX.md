...
1. **[DEPLOYMENT_CHECKLIST.md](../../troubleshooting/deployment/DEPLOYMENT_CHECKLIST.md)** - Step-by-step deployment and testing
2. **[ATTACHMENT_METADATA_DEBUG_GUIDE.md](../../troubleshooting/attachments/ATTACHMENT_METADATA_DEBUG_GUIDE.md)** - How to interpret console logs
3. **[ATTACHMENT_ID_TROUBLESHOOTING.md](../../troubleshooting/attachments/ATTACHMENT_ID_TROUBLESHOOTING.md)** - Complete troubleshooting with solutions
4. **[ATTACHMENT_ID_FIX_SUMMARY.md](../../implementation-history/2025/fixes/attachments/ATTACHMENT_ID_FIX_SUMMARY.md)** - Technical deep dive and context
...
### 1. Deploy (See [DEPLOYMENT_CHECKLIST.md](../../troubleshooting/deployment/DEPLOYMENT_CHECKLIST.md))
...
| File | Purpose |
|------|---------|
| [DEPLOYMENT_CHECKLIST.md](../../troubleshooting/deployment/DEPLOYMENT_CHECKLIST.md) | Step-by-step deployment guide |
| [ATTACHMENT_METADATA_DEBUG_GUIDE.md](../../troubleshooting/attachments/ATTACHMENT_METADATA_DEBUG_GUIDE.md) | How to interpret logs |
| [ATTACHMENT_ID_TROUBLESHOOTING.md](../../troubleshooting/attachments/ATTACHMENT_ID_TROUBLESHOOTING.md) | Solutions for common issues |
| [ATTACHMENT_ID_FIX_SUMMARY.md](../../implementation-history/2025/fixes/attachments/ATTACHMENT_ID_FIX_SUMMARY.md) | Technical deep dive |
...
|-----------|-------|--------------|
| No logs appear | Old JS cached | [DEPLOYMENT_CHECKLIST.md](../../troubleshooting/deployment/DEPLOYMENT_CHECKLIST.md) |
| `from_data_id: undefined` | WordPress API issue | [ATTACHMENT_ID_TROUBLESHOOTING.md](../../troubleshooting/attachments/ATTACHMENT_ID_TROUBLESHOOTING.md) |
| `record_id: undefined` | State management issue | [ATTACHMENT_METADATA_DEBUG_GUIDE.md](../../troubleshooting/attachments/ATTACHMENT_METADATA_DEBUG_GUIDE.md) |
| `will_include_id: false` | Type check failing | [ATTACHMENT_ID_TROUBLESHOOTING.md](../../troubleshooting/attachments/ATTACHMENT_ID_TROUBLESHOOTING.md) |
| Logs correct, UI wrong | CSS or DOM issue | [ATTACHMENT_ID_TROUBLESHOOTING.md](../../troubleshooting/attachments/ATTACHMENT_ID_TROUBLESHOOTING.md) |

## Quick Start

1. **Deploy:** Follow [DEPLOYMENT_CHECKLIST.md](../../troubleshooting/deployment/DEPLOYMENT_CHECKLIST.md)
