...
- **Generate Veo Video** (`generate_veo_video`) generates realistic videos from text descriptions using Google Veo 2 and stores the results in the Media Library. Supports async mode for long-running video generation tasks.【F:includes/tools/class-wp-mcp-ai-tool-generate-veo-video.php†L17-L300】
