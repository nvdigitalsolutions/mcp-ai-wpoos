...
**Current version:** 1.1.25 (May 2026)  
**Total PHP files:** ~3,000 (base + pro + addons)  
**Total tools:** ~815 (231 base + 584 pro; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
...
```
mcp-ai-wpoos.php              ← Main entry point (v1.1.25)
includes/
