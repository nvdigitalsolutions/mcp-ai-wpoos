...
| Low | 21 | 11 CLOSED/FIXED + 1 PARTIALLY FIXED (F-CMP-02 re-verified false positive, F-DOC-01 R-D-04, F-SQL-02 extends R-S-03, F-LOGS-01, F-LOG-LEAK-01, F-COOKIE-01 re-verified false positive, F-CMP-04 base-plugin sweep, F-TIME-01, F-UPLOAD-02, F-CSP-01, F-CRON-01), 9 OPEN |
| Informational | 10 | — |
| **Total** | **50** | **30 closed/partially-fixed, 20 open** |
