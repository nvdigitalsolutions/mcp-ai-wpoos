...
- **[docs/developer/testing-docs/CI-TRIAGE-91771001271.md](developer/testing-docs/CI-TRIAGE-91771001271.md)** ⭐ **NEW** — CI triage log for the wave-5 PHPUnit run (PR #6296): run identity, 145 failures grouped by cause, in-flight PR mapping, cluster status. (September 4, 2026)
