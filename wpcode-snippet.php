...
function nvd_dashboard_widget() {
    ...
    $variants = $wpdb->get_results( "SELECT plugin_variant, COUNT(*) as count FROM $table GROUP BY plugin_variant" );
    
    echo '<h3>Total Installations: ' . number_format( $total ) . '</h3>';
