...
- **`.agents/skills/*.md`** — 53 coding-time agent skills for Zed editor: 20 wp-* WordPress plugin development patterns (wp-abilities-api, wp-action-scheduler, wp-html-api, wp-i18n-audit, wp-plugin-*, wp-query-cache, wp-rest-api, wp-security-*, wp-utf8-text), 31 design-* skills, the mcp-ai-wpoos-plugin operational guide, and the mcp-ai-wpoos-test-suite repair guide.
...
├── .agents/skills/       # 53 coding-time agent skills for Zed editor (20 wp-* + 31 design-* + mcp-ai-wpoos-plugin + mcp-ai-wpoos-test-suite)
