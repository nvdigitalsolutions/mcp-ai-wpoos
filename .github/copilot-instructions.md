...
│   ├── tools/            # ~1,565 total built-in tool implementations
...
- **Full Version**: ~1,565 tools (~303 base + ~1,262 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
