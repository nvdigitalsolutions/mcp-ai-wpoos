...
│   ├── tools/            # ~1,586 total built-in tool implementations
...
├── .agents/skills/       # 59 coding-time agent skills for Zed editor (20 wp-* + 32 design-* + mcp-ai-wpoos-plugin + mcp-ai-wpoos-test-suite + mcp-ai-wpoos-updates + mcp-ai-wpoos-wporg-submission + mcp-ai-wpoos-ecosystem-port + mcp-ai-wpoos-assistant-portability + mcp-ai-wpoos-playground-demos)
...
- **Base Version** (default): ~307 core tools, no third-party dependencies
- **Full Version**: ~1,586 tools (~307 base + ~1,279 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
