...
│   ├── tools/            # ~1,572 total built-in tool implementations
...
├── .agents/skills/       # 58 coding-time agent skills for Zed editor (20 wp-* + 32 design-* + mcp-ai-wpoos-plugin + mcp-ai-wpoos-test-suite + mcp-ai-wpoos-updates + mcp-ai-wpoos-wporg-submission + mcp-ai-wpoos-ecosystem-port + mcp-ai-wpoos-assistant-portability)
...
- **Full Version**: ~1,572 tools (~306 base + ~1,266 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
