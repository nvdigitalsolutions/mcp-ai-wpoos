...
- **`.agents/skills/*.md`** — 56 coding-time agent skills for Zed editor: 20 wp-* WordPress plugin development patterns (wp-abilities-api, wp-action-scheduler, wp-html-api, wp-i18n-audit, wp-plugin-*, wp-query-cache, wp-rest-api, wp-security-*, wp-utf8-text), 31 design-* skills, the mcp-ai-wpoos-plugin operational guide, the mcp-ai-wpoos-test-suite repair guide, the mcp-ai-wpoos-updates maintenance guide, the mcp-ai-wpoos-wporg-submission wp.org readiness guide, and the mcp-ai-wpoos-ecosystem-port base+pro→CG Pro port guide.
...
│   ├── tools/            # ~1,568 total built-in tool implementations
...
├── .agents/skills/       # 56 coding-time agent skills for Zed editor (20 wp-* + 31 design-* + mcp-ai-wpoos-plugin + mcp-ai-wpoos-test-suite + mcp-ai-wpoos-updates + mcp-ai-wpoos-wporg-submission + mcp-ai-wpoos-ecosystem-port)
...
- **Full Version**: ~1,568 tools (~303 base + ~1,265 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
