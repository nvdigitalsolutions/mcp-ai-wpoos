...
│   ├── tools/            # ~1,566 total built-in tool implementations
...
├── .agents/skills/       # 54 coding-time agent skills for Zed editor (20 wp-* + 31 design-* + mcp-ai-wpoos-plugin + mcp-ai-wpoos-test-suite + mcp-ai-wpoos-updates)
...
- **Full Version**: ~1,566 tools (~303 base + ~1,263 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
