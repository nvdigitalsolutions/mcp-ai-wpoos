...
│   ├── tools/            # ~1,543 total built-in tool implementations
...
- **Base Version** (default): ~300 core tools, no third-party dependencies
- **Full Version**: ~1,543 tools (~300 base + ~1,243 pro) including WooCommerce, JetEngine, and Pro addons; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative
