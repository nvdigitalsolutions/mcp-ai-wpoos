...
> Last reviewed: **September 22, 2026** · Version: **2.37**
...
├── class-wp-mcp-ai-tool-registry.php   ← Tool registry singleton (~1,586 tools total; live count is authoritative)
...
├── tools/                              ← base tool implementations (~307 classes; live count is authoritative)
...
- **Constants:** `WP_MCP_AI_BASE_VERSION = true` (~307 base tool classes) or `false` (~1,586 total; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
