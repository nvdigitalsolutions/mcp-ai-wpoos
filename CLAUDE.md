...
> Last reviewed: **September 21, 2026** · Version: **2.36**
...
├── class-wp-mcp-ai-tool-registry.php   ← Tool registry singleton (~1,585 tools total; live count is authoritative)
...
- **Constants:** `WP_MCP_AI_BASE_VERSION = true` (~306 base tool classes) or `false` (~1,585 total; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
