...
> Last reviewed: **September 25, 2026** · Version: **2.40**
...
├── class-wp-mcp-ai-tool-registry.php   ← Tool registry singleton (~1,594 tools total; live count is authoritative)
...
- **Constants:** `WP_MCP_AI_BASE_VERSION = true` (~312 base tool classes) or `false` (~1,594 total; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
