...
> Last reviewed: **September 24, 2026** · Version: **2.39**
...
├── class-wp-mcp-ai-tool-registry.php   ← Tool registry singleton (~1,590 tools total; live count is authoritative)
...
├── tools/                              ← base tool implementations (~308 classes; live count is authoritative)
...
- **Constants:** `WP_MCP_AI_BASE_VERSION = true` (~308 base tool classes) or `false` (~1,590 total; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
