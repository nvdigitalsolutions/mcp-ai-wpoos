...
|------|---------|-------|-------------|
| **Base** | `WP_MCP_AI_BASE_VERSION = true` | ~307 core tools | Open-source, WordPress.org compatible |
| **Full (Pro)** | `WP_MCP_AI_BASE_VERSION = false` | ~1,586 tools (~307 base + ~1,279 Pro) | Premium addon with third-party integrations |
...
includes/
├── tools/class-wp-mcp-ai-tool-*.php    # ~307 core tools
