...
> Last reviewed: September 22, 2026 (v1.1.83 post — PRs #6726–#6743).
>
...
**Total tools:** ~1,586 (~307 base + ~1,279 Pro; live count via `WP_MCP_AI_Tool_Registry::get_tools()` is authoritative)
