...
│   ├── tools/                             ← ~307 base tools; ~307 enabled in base mode
...
|---|---|---|
| `WP_MCP_AI_BASE_VERSION` | `true` | `true` = ~307 base tools; `false` = ~1,586 total |
...
| **Tools** | ~307 core tools | +~1,279 Pro tools = **~1,586 total** |
