...
│   ├── tools/                             ← ~312 base tools; ~312 enabled in base mode
...
|---|---|---|
| `WP_MCP_AI_BASE_VERSION` | `true` | `true` = ~312 base tools; `false` = ~1,594 total |
...
| **Tools** | ~312 core tools | +~1,282 Pro tools = **~1,594 total** |
