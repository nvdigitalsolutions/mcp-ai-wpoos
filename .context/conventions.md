...
│   ├── tools/                             ← ~308 base tools; ~308 enabled in base mode
...
|---|---|---|
| `WP_MCP_AI_BASE_VERSION` | `true` | `true` = ~308 base tools; `false` = ~1,590 total |
...
| **Tools** | ~308 core tools | +~1,282 Pro tools = **~1,590 total** |
