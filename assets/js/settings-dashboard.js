...
(function($) {
	...
	const WP_MCP_AI_Dashboard = {
		...
		bindEvents: function() {
			...
			// Using case-insensitive selector to handle both lowercase and uppercase method values
			$(document).on('submit', 'form[method="post" i]', this.handleFormSubmit.bind(this));
