...
- 🧹 **Housekeeping.** Stale 1.1.31 build zips removed. SPA addon ZIPs rebuilt with updated security overrides.
...
- ✅ **Housekeeping.** Stale 1.1.31 build zips removed (PR #5437). SPA addon ZIPs rebuilt with updated security overrides and dependency bumps. nvoos-graphify standalone ZIP built at v1.0.0. nvoos-graphify-ai ZIP built at v1.0.0-dev.
...
|---------|------|------------|
| **v1.1.33** | Jun 2026 | WP 7.0 Connectors credential integration across all 17 AI clients with source badges, nvoos-graphify v1.0.0 release (Plugin Check compliant), 3 guzzlehttp CVEs + undici override, 29 npm alerts across 14 packages, 15 dependabot bumps |
