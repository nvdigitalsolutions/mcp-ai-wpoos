...
- Companion Elementor widgets surface everything saved on the assistant post—model defaults, knowledge files, prompt shortcuts, and assigned tools—so you can build documentation and dashboards without copying values manually.【F:includes/elementor/class-wp-mcp-ai-elementor-assistant-defaults-widget.php†L17-L164】【F:includes/elementor/class-wp-mcp-ai-elementor-assistant-base-knowledge-widget.php†L17-L209】【F:includes/elementor/class-wp-mcp-ai-elementor-assistant-prompt-shortcuts-widget.php†L17-L205】【F:includes/elementor/class-wp-mcp-ai-elementor-assistant-tools-widget.php†L17-L211】
