...
| Update WooCommerce Product Quantity 🌟 | `update_woo_product_qty` | Updates stock quantity across all stock-managed types with set/increase/decrease operations, canonical low-stock notifications, and stock-status sync. **Pro addon tool**.【F:addons/pro/includes/tools/ecommerce/class-wp-mcp-ai-tool-update-woo-product-qty.php†L1-L50】|
