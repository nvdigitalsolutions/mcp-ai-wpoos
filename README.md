...
| **NPM Package Management** | | **AI agents can manage Node.js packages within WordPress** |
| NPM Install Package | `npm_install_package` | Installs npm packages with optional version specifications and dev dependency support. Administrators can add JavaScript dependencies to their WordPress installation programmatically. Supports scoped packages and version constraints.【F:includes/tools/class-wp-mcp-ai-tool-npm-install-package.php†L1-L442】|
| NPM Update Package | `npm_update_package` | Updates npm packages to their latest compatible versions according to package.json semver ranges. Can update all packages or specific ones by name.【F:includes/tools/class-wp-mcp-ai-tool-npm-update-package.php†L1-L384】|
| NPM Remove Package | `npm_remove_package` | Removes npm packages and updates package.json accordingly. Safely uninstalls JavaScript dependencies from the WordPress installation.【F:includes/tools/class-wp-mcp-ai-tool-npm-remove-package.php†L1-L388】|
