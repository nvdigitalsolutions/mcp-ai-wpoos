<?php
/**
 * Shopify UCP catalog mode-awareness tests.
 *
 ...
 *
 * @package WP_MCP_AI_Pro\Tests
 */

/**
 * Shopify UCP mode-awareness tests.
 */
class Test_Shopify_UCP_Mode_Awareness extends WP_UnitTestCase {
	...
	public function setUp(): void {
		...
		require_once WP_MCP_AI_PRO_PATH . 'includes/tools/ecommerce/class-wp-mcp-ai-pro-tool-shopify-orders.php';
		require_once WP_MCP_AI_PRO_PATH . 'includes/tools/ecommerce/class-wp-mcp-ai-pro-tool-shopify-customers.php';
		require_once WP_MCP_AI_PRO_PATH . 'includes/tools/ecommerce/class-wp-mcp-ai-pro-tool-shopify-inventory.php';
	...
	public function test_catalog_tool_resolves_ucp_connection_among_multiple(): void {
		...
		$ucp_connection_id = $this->create_connection( 'storefront_catalog' );
		$tool              = new WP_MCP_AI_Pro_Tool_Shopify_Catalog();
