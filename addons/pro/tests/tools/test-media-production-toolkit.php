<?php
/**
 * Batch test for Media Production Pro tools (image-production + video-production).
 *
 * @package WP_MCP_AI_Pro @subpackage Tests @group tools @group pro @group media-production
 */
class Test_WP_MCP_AI_Media_Production_Toolkit extends WP_UnitTestCase {
	/** @var int */ protected $user_id;
	/** @var array */ protected static $dirs = array( 'image-production', 'video-production' );
