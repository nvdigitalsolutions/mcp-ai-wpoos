<?php
/**
 * Batch test for Ecommerce + Email Marketing Pro tools.
 *
 * @package WP_MCP_AI_Pro @subpackage Tests @group tools @group pro @group ecommerce
 */
class Test_WP_MCP_AI_Ecommerce_Marketing_Toolkit extends WP_UnitTestCase {
	/** @var int */ protected $user_id;
	/** @var array */ protected static $dirs = array( 'ecommerce', 'email-marketing' );
