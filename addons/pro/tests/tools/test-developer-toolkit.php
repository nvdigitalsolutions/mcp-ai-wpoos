<?php
/**
 * Batch test for Developer + Math + AI Tool Builder Pro tools.
 *
 * @package WP_MCP_AI_Pro @subpackage Tests @group tools @group pro @group developer
 */
class Test_WP_MCP_AI_Developer_Toolkit extends WP_UnitTestCase {
	/** @var int */ protected $user_id;
	/** @var array */ protected static $dirs = array( 'developer', 'math', 'ai-tool-builder' );
