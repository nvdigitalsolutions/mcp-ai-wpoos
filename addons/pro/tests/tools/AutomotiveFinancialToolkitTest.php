<?php
/**
 * Batch test for Automotive + Financial Planning Pro tools.
 *
...
class AutomotiveFinancialToolkitTest extends WP_UnitTestCase {

	/** @var int */
	protected $user_id;

	/** @var array */
	protected static $dirs = array( 'automotive', 'financial-planning' );
