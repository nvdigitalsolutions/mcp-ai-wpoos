...
class Test_Toolkit_MCP_Audit_Log extends WP_UnitTestCase {
	...
	public function test_get_entries_consumer_filter() {
		$this->log->record( array( 'consumer' => 'a', 'source' => 's', 'entity' => 'e', 'method' => 'resources/read' ) );
		$this->log->record( array( 'consumer' => 'b', 'source' => 's', 'entity' => 'e', 'method' => 'resources/read' ) );
		$this->log->record( array( 'consumer' => 'a', 'source' => 's', 'entity' => 'e', 'method' => 'prompts/get' ) );
	...
	public function test_get_summary_groups_pairs() {
		for ( $i = 0; $i < 3; $i++ ) {
			$this->log->record( array( 'consumer' => 'arch', 'source' => 'health', 'entity' => 'e', 'method' => 'resources/read' ) );
		}
		$this->log->record( array( 'consumer' => 'arch', 'source' => 'crm', 'entity' => 'e', 'method' => 'prompts/get' ) );
	...
	public function test_clear_empties_log() {
		$this->log->record( array( 'consumer' => 'c', 'source' => 's', 'entity' => 'e', 'method' => 'resources/read' ) );
	...
	public function test_audit_recorded_action_fires() {
		...
		$this->log->record( array( 'consumer' => 'c', 'source' => 's', 'entity' => 'e', 'method' => 'prompts/get' ) );
