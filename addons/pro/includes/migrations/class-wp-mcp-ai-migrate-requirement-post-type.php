<?php
/**
 * Migration: Update requirement post type name
 *
 * Migrates posts from old post type name 'mcp_ai_reg_requirement' (22 chars - invalid)
 * to new post type name 'mcp_ai_requirement' (18 chars - valid).
 *
...
class WP_MCP_AI_Migrate_Requirement_Post_Type {
	...
	public static function run() {
		...
		if ( 0 === $total_posts ) {
			...
			return array(
				'status'   => 'success',
				'message'  => __( 'No requirements found to migrate.', 'mcp-ai-wpoos-pro' ),
				'migrated' => 0,
				'total'    => 0,
			);
		}
		...
		return array(
			...
			'message'  => sprintf(
				...
				__( 'Successfully migrated %d requirements.', 'mcp-ai-wpoos-pro' ),
				$updated
			),
			'migrated' => $updated,
			'total'    => $total_posts,
	...
	public static function rollback() {
		...
		if ( 0 === $total_posts ) {
			...
			return array(
				'status'      => 'success',
				'message'     => __( 'No requirements found to rollback.', 'mcp-ai-wpoos-pro' ),
				'rolled_back' => 0,
				'total'       => 0,
			);
		}
		...
		return array(
			...
			'message'     => sprintf(
				...
				__( 'Successfully rolled back %d requirements.', 'mcp-ai-wpoos-pro' ),
				$updated
			),
			'rolled_back' => $updated,
			'total'       => $total_posts,
