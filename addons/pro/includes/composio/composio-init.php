 ...
 *
 * Loads the Composio client, auth handler, trigger bridge, webhook controller
 * and the six composio_* MCP tools. Hooks into wp_mcp_ai_bootstrapped at
 * priority 45 (after core tool interfaces are guaranteed loaded).
 *
...
add_action(
	...
	function () {
		...
		// Register the six composio_* tools.
