		...
		register_post_type(
			...
			array(
				'labels'              => array(
					...
					'menu_name'             => __( 'Reg Products', 'mcp-ai-wpoos-pro' ),
					...
					'all_items'             => __( 'All Products', 'mcp-ai-wpoos-pro' ),
				),
				'public'              => false,
				'show_ui'             => true,
		...
		register_post_type(
			...
			array(
				'labels'              => array(
					...
					'all_items'             => __( 'All Registrations', 'mcp-ai-wpoos-pro' ),
				),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => 'wp-mcp-ai',
		...
		register_post_type(
			...
			array(
				'labels'              => array(
					...
					'all_items'             => __( 'All Countries', 'mcp-ai-wpoos-pro' ),
				),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => 'wp-mcp-ai',
		...
		register_post_type(
			...
			array(
				'labels'              => array(
					...
					'all_items'             => __( 'All Requirements', 'mcp-ai-wpoos-pro' ),
				),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => 'wp-mcp-ai',
