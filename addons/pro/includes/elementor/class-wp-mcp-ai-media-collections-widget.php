<?php
/**
 * Media Collections Elementor Widget
 *
 * Displays media collections from the Media toolkit.
 *
...
/**
 * Media Collections Widget Class
 *
 * @since 1.0.0
 */
class WP_MCP_AI_Media_Collections_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'wp_mcp_ai_media_collections';
	}
	...
	public function get_title() {
		return __( 'Media Collections', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_keywords() {
		return array( 'media', 'collections', 'gallery', 'images', 'mcp' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'carousel' => __( 'Carousel', 'mcp-ai-wpoos-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'limit',
			array(
				'label'   => __( 'Number of Collections', 'mcp-ai-wpoos-pro' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'default' => 9,
				'min'     => 1,
				'max'     => 100,
	...
	protected function render() {
		...
		$shortcode = '[mcp_media_collections ' . implode( ' ', $attributes ) . ']';
