<?php
/**
 * DJ Packages Elementor Widget
 *
 * Displays packages from the DJ Management toolkit.
 *
...
/**
 * DJ Packages Widget Class
 *
 * @since 1.0.0
 */
class WP_MCP_AI_Dj_Packages_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'DJ Packages', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_keywords() {
		return array( 'dj', 'packages', 'pricing', 'services', 'events', 'mcp' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_features',
			array(
				'label'        => __( 'Show Features', 'mcp-ai-wpoos-pro' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'mcp-ai-wpoos-pro' ),
				'label_off'    => __( 'No', 'mcp-ai-wpoos-pro' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		if ( ! empty( $settings['show_features'] ) && 'yes' === $settings['show_features'] ) {
			$attributes[] = 'show_features="yes"';
		}

		// Build and render shortcode.
		$shortcode = '[mcp_dj_packages ' . implode( ' ', $attributes ) . ']';
