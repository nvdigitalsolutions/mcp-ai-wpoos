...
class WP_MCP_AI_Task_Templates_CCT {
	...
	public static function bootstrap() {
		...
		// 1-10; registering inside that window races with it and can stomp
		// JetEngine's CCT state (Task Templates and siblings disappear from the
		// JetEngine → CCT admin menu). Priority 11 is the documented safe window.
