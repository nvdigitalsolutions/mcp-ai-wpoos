			...
			<div class="wp-mcp-ai-research-container">
				<div class="wp-mcp-ai-research-sidebar">
					...
					<div class="wp-mcp-ai-research-actions">
						...
						<p>
							<button type="button" class="button button-primary button-large wp-mcp-ai-create-post-btn-sidebar wp-mcp-ai-add-to-database-btn">
				...
				<div class="wp-mcp-ai-research-main">
					<?php if ( $assistant_id > 0 ) : ?>
						<div class="wp-mcp-ai-research-chat">
							<?php
							// Define CPT action buttons for post creation.
							$cpt_actions = array(
								array(
									'label'   => __( 'Create Post', 'mcp-ai-wpoos-pro' ),
									'action'  => 'create_post',
