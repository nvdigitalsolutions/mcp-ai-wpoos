			...
			<div class="wp-mcp-ai-research-container">
				<div class="wp-mcp-ai-research-sidebar">
					...
					<div class="wp-mcp-ai-research-actions">
						...
						<p>
							<button type="button" class="button button-primary button-large wp-mcp-ai-create-policy-btn-sidebar wp-mcp-ai-add-to-database-btn">
					...
					<?php if ( $assistant_id > 0 ) : ?>
						...
						<div class="wp-mcp-ai-research-create-section" style="display: none;">
							<div class="wp-mcp-ai-research-data-preview">
								<h3><?php esc_html_e( 'Researched Policy Data', 'mcp-ai-wpoos-pro' ); ?></h3>
								<div id="wp-mcp-ai-research-data-content"></div>
							</div>
							<div class="wp-mcp-ai-research-create-actions">
								<button type="button" class="button button-primary button-hero wp-mcp-ai-create-policy-btn">
									<span class="dashicons dashicons-plus-alt" style="margin-top: 8px;"></span>
									<?php esc_html_e( 'Create Policy from Research', 'mcp-ai-wpoos-pro' ); ?>
								</button>
								<p class="description">
									<?php esc_html_e( 'This will create a new policy template using the information from your research conversation.', 'mcp-ai-wpoos-pro' ); ?>
								</p>
							</div>
						</div>
					<?php else : ?>
