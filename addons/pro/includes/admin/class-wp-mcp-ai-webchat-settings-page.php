			...
			<div class="toolkit-card" style="background: #fff3cd; border: 1px solid #ffc107; padding: 20px; margin: 20px 0;">
				...
				<ul>
					...
					<li>
						...
						<?php esc_html_e( ' Chrome/Edge 79+, Firefox 78+, Safari 14+, or Opera 66+ with WebRTC support.', 'mcp-ai-wpoos-pro' ); ?>
					</li>
					<li>
				...
				<p class="webchat-webrtc-note">
					<strong><?php esc_html_e( 'Note about WebRTC Errors:', 'mcp-ai-wpoos-pro' ); ?></strong>
					<?php esc_html_e( ' If you see "WebRTC is not supported" errors in your browser console, these are from the browser extension attempting to initialize WebRTC.', 'mcp-ai-wpoos-pro' ); ?>
				</p>
				<p class="webchat-webrtc-note">
					<?php esc_html_e( 'These errors are harmless if you\'re not actively using the WebChat feature and do not affect the functionality of your WordPress site.', 'mcp-ai-wpoos-pro' ); ?>
				</p>
				<p class="webchat-webrtc-note">
					<?php esc_html_e( 'To resolve these errors, ensure you are using a modern browser with WebRTC support or disable the WebChat browser extension on pages where it is not needed.', 'mcp-ai-wpoos-pro' ); ?>
				</p>
			</div>
