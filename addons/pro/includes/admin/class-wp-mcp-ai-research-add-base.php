...
$base_url = add_query_arg( array( 'page' => sanitize_key( $_GET['page'] ?? '' ), 'tab' => 'research' ), admin_url( 'admin.php' ) ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
