 ...
 * for Policy Research & Add functionality.
 *
...
class WP_MCP_AI_Policy_Settings_Page extends WP_MCP_AI_CPT_Settings_Page_Base {
	...
	public function __construct() {
		...
		$this->page_title  = __( 'Policy Settings', 'mcp-ai-wpoos-pro' );
	...
	public function render_enable_research_field() {
		...
		<label>
			...
			/>
			<?php esc_html_e( 'Enable the Research & Add page for policy research', 'mcp-ai-wpoos-pro' ); ?>
		</label>
		<p class="description">
			<?php esc_html_e( 'When enabled, users can access the Research & Add page to create insurance policies using AI assistance.', 'mcp-ai-wpoos-pro' ); ?>
		</p>
		<?php
	}
