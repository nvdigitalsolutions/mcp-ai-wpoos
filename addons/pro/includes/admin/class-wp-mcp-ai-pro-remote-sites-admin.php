	...
	protected function render_edit_form( $connection ) {
			...
			<table class="form-table">
				...
				<tr class="whatsapp-only-field" style="display: none;">
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'WhatsApp Business Cloud API version. Select the latest version supported by your Meta app.', 'mcp-ai-wpoos-pro' ); ?></p>
					</td>
				</tr>
		...
		function toggleConnectionTypeFields(connectionType) {
			...
			if (connectionType === 'wordpress') {
				...
				// WhatsApp uses Business Cloud API — version is driven by the Cloud API Version dropdown
