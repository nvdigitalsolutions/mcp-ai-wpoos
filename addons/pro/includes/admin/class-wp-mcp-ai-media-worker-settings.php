...
class WP_MCP_AI_Media_Worker_Settings {
        ...
        <div class="wrap">
            ...
            <div class="card" style="max-width:800px;">
                ...
                <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                    ...
                    <?php if ( ! $has_constant ) : ?><p class="submit"><button type="submit" class="button button-primary"><?php esc_html_e( 'Save Settings', 'mcp-ai-wpoos-pro' ); ?></button></p><?php endif; ?>
                </form>
            </div>
            <div class="card" style="max-width:800px;">
    ...
    public function save_settings() {
        ...
        wp_safe_redirect(add_query_arg(array('page'=>'wp-mcp-ai-media-worker','saved'=>1),admin_url('admin.php')));
        exit;
    }
    ...
    public function ajax_test_connection() {
        ...
        if(is_wp_error($r)) wp_send_json_error(array('message'=>'Connection failed: '.$r->get_error_message()));
    ...
    private function get_url() {
        if(defined('WP_MEDIA_WORKER_URL')&&WP_MEDIA_WORKER_URL) return rtrim(WP_MEDIA_WORKER_URL,'/');
