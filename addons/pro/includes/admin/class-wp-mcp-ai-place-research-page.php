			...
			<div class="wp-mcp-ai-research-container">
				<div class="wp-mcp-ai-research-sidebar">
					...
					<div class="wp-mcp-ai-research-actions">
						...
						<p>
							<button type="button" class="button button-primary button-large wp-mcp-ai-create-place-btn-sidebar" style="width: 100%;">
					...
					<?php if ( $assistant_id > 0 ) : ?>
						...
						<div class="wp-mcp-ai-research-create-section" style="display: none;">
							<div class="wp-mcp-ai-research-data-preview">
								<h3><?php esc_html_e( 'Researched Data', 'mcp-ai-wpoos-pro' ); ?></h3>
								<div id="wp-mcp-ai-research-data-content"></div>
							</div>
							<div class="wp-mcp-ai-research-create-actions">
								<button type="button" class="button button-primary button-hero wp-mcp-ai-create-place-btn">
									<span class="dashicons dashicons-plus-alt" style="margin-top: 8px;"></span>
									<?php esc_html_e( 'Create Place from Research', 'mcp-ai-wpoos-pro' ); ?>
								</button>
								<p class="description">
									<?php esc_html_e( 'This will create a new place using the information from your research conversation.', 'mcp-ai-wpoos-pro' ); ?>
								</p>
							</div>
						</div>
					<?php else : ?>
