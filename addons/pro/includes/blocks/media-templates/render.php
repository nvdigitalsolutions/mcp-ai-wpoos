...
if ( ! empty( $attributes['columns'] ) && in_array( $attributes['display'], array( 'grid', 'masonry' ), true ) ) {
...
$shortcode = '[mcp_media_templates ' . implode( ' ', $shortcode_atts ) . ']';
