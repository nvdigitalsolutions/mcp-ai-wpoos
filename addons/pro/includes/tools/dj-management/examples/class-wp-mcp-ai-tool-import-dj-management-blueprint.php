<?php
/**
 * Import DJ Management Blueprint — installs a curated DJ management assistant blueprint.
 *
 ...
 * @subpackage DJ_Management_Toolkit
 * @since     2.3.1
...
/**
 * Imports a curated DJ management assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_DJ_Management_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import DJ Management Blueprint tool requires the DJ Management Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_dj_management_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import DJ Management Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
