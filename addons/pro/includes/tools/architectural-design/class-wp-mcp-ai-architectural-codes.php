	...
	protected static function jm_asce_wind_rules() {
		return array(
			'structural' => array(
				'wind_standard' => 'ASCE 7 referenced via JNBC Part 7',
				'wind_zones'    => array(
					'inland'   => array( 'basic_wind_ms' => 58.0, 'basic_wind_mph' => 130 ),
					'standard' => array( 'basic_wind_ms' => 63.0, 'basic_wind_mph' => 141 ),
					'coastal'  => array( 'basic_wind_ms' => 67.0, 'basic_wind_mph' => 150 ),
				),
				'opening_protection_required' => true,
			),
		);
	...
	protected static function us_ada_rules() {
		return array(
			'accessibility' => array(
				...
				'min_accessible_wc_stall_mm' => array( 'width' => 1525.0, 'depth' => 1525.0 ),
			),
		);
	}
