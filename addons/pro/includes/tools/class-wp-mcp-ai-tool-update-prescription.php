	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'prescription' => array(
				'id'                 => $prescription_id,
				'member_id'          => $member_id,
				'medication_name'    => $medication_name ?: get_post_field( 'post_title', $prescription_id ),
				'dosage'             => $dosage ?: get_post_meta( $prescription_id, '_prescription_dosage', true ),
				'frequency'          => $frequency ?: get_post_meta( $prescription_id, '_prescription_frequency', true ),
				'prescribing_doctor' => $prescribing_doctor ?: get_post_meta( $prescription_id, '_prescription_doctor', true ),
				'start_date'         => $start_date ?: get_post_meta( $prescription_id, '_prescription_start_date', true ),
				'end_date'           => $end_date ?: get_post_meta( $prescription_id, '_prescription_end_date', true ),
				'status'             => $status ?: get_post_meta( $prescription_id, '_prescription_status', true ),
