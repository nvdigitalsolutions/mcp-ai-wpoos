...
class WP_MCP_AI_Tool_Detect_Buying_Signals implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'detect_buying_signals'; }
	public function get_name() { return __( 'Detect Buying Signals', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Detect buying-intent keywords and phrases in a message body.', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() { return array( 'type' => 'object', 'properties' => array( 'message_body' => array( 'type' => 'string' ) ), 'required' => array( 'message_body' ) ); }
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		$hot = count( $signals ) >= 3;
		return array( 'success' => true, 'buying_signals' => $signals, 'signal_count' => count( $signals ), 'is_hot' => $hot, 'message' => $hot ? __( 'Multiple buying signals detected — lead appears hot.', 'mcp-ai-wpoos-pro' ) : __( 'Buying signal scan complete.', 'mcp-ai-wpoos-pro' ) );
	}
}
