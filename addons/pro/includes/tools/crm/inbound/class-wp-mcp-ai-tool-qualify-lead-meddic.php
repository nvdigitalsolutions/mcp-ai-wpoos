...
class WP_MCP_AI_Tool_Qualify_Lead_Meddic implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'message'       => $overall >= 45 ? __( 'Lead meets MEDDIC qualification threshold.', 'mcp-ai-wpoos-pro' ) : __( 'Lead needs more discovery before MEDDIC qualification.', 'mcp-ai-wpoos-pro' ),
		);
	}
}
