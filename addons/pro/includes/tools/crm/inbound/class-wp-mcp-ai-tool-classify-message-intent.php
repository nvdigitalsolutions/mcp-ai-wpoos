...
class WP_MCP_AI_Tool_Classify_Message_Intent implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'classify_message_intent'; }
	public function get_name() { return __( 'Classify Message Intent', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Classify an inbound message for intent, sentiment, buying signals, and spam probability.', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() { return array( 'type' => 'object', 'properties' => array( 'message_body' => array( 'type' => 'string' ), 'channel' => array( 'type' => 'string', 'default' => 'email' ) ), 'required' => array( 'message_body' ) ); }
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( ! class_exists( 'WP_MCP_AI_CRM_Classifier' ) ) { return new WP_Error( 'classifier_missing', __( 'CRM Classifier engine not available.', 'mcp-ai-wpoos-pro' ) ); }
		...
		return array( 'success' => true, 'classification' => $result );
	}
}
