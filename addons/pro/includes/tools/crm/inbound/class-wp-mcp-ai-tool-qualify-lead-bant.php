...
class WP_MCP_AI_Tool_Qualify_Lead_Bant implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'message'       => $overall >= 50 ? __( 'Lead meets BANT qualification threshold.', 'mcp-ai-wpoos-pro' ) : __( 'Lead needs more information before BANT qualification.', 'mcp-ai-wpoos-pro' ),
		);
	}
}
