...
class WP_MCP_AI_Tool_Draft_Lead_Reply implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_description() {
		return __( 'Generate an AI-assisted reply draft for a lead message. Does NOT send — returns the draft for review.', 'mcp-ai-wpoos-pro' ); }
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'tone'    => $tone,
			'channel' => $channel,
			'message' => __( 'Reply draft generated. Review before sending.', 'mcp-ai-wpoos-pro' ),
		);
	}
}
