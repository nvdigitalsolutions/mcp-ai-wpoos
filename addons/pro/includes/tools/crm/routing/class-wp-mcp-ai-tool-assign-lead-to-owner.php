...
class WP_MCP_AI_Tool_Assign_Lead_To_Owner implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'assign_lead_to_owner'; }
	public function get_name() { return __( 'Assign Lead to Owner', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Assign a lead to a specific owner, or use the automatic routing strategy (round_robin, weighted).', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() {
		return array(
			'type' => 'object',
			'properties' => array(
				'lead_id' => array( 'type' => 'integer', 'description' => __( 'Lead or contact post ID.', 'mcp-ai-wpoos-pro' ) ),
				'owner_id' => array( 'type' => 'integer', 'description' => __( 'WP user ID to assign. If 0 or omitted, uses the automatic routing strategy.', 'mcp-ai-wpoos-pro' ) ),
			),
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( class_exists( 'WP_MCP_AI_CRM_Audit' ) ) {
			WP_MCP_AI_CRM_Audit::record( 'lead_assigned', 'lead', $lead_id, array(
