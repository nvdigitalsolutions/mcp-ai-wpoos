...
class WP_MCP_AI_Tool_Snooze_CRM_Activity implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'snooze_crm_activity'; }
	public function get_name() { return __( 'Snooze CRM Activity', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Snooze a CRM activity to a future date.', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() {
		return array( 'type' => 'object', 'properties' => array(
			'activity_id' => array( 'type' => 'integer' ),
			'new_due_date' => array( 'type' => 'string', 'description' => __( 'New due date (YYYY-MM-DD).', 'mcp-ai-wpoos-pro' ) ),
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array( 'success' => true, 'message' => __( 'Activity snoozed.', 'mcp-ai-wpoos-pro' ), 'activity_id' => $id, 'new_due_date' => $new_due, 'snooze_count' => $snooze_count );
	}
}
