...
class WP_MCP_AI_Tool_Complete_CRM_Activity implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'complete_crm_activity'; }
	public function get_name() { return __( 'Complete CRM Activity', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Mark a CRM activity as completed.', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() {
		return array( 'type' => 'object', 'properties' => array( 'activity_id' => array( 'type' => 'integer' ), 'outcome' => array( 'type' => 'string' ) ), 'required' => array( 'activity_id' ) );
	}
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		$p  = get_post( $id );
		if ( ! $p || 'mcp_ai_crm_activity' !== $p->post_type ) { return new WP_Error( 'not_found', __( 'Activity not found.', 'mcp-ai-wpoos-pro' ) ); }
		...
		if ( class_exists( 'WP_MCP_AI_CRM_Audit' ) ) { WP_MCP_AI_CRM_Audit::record( 'activity_completed', 'activity', $id ); }

		return array( 'success' => true, 'message' => __( 'Activity marked as completed.', 'mcp-ai-wpoos-pro' ), 'activity_id' => $id );
	}
}
