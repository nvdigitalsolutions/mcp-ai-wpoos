...
class WP_MCP_AI_Tool_Get_CRM_Activity implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_slug() { return 'get_crm_activity'; }
	public function get_name() { return __( 'Get CRM Activity', 'mcp-ai-wpoos-pro' ); }
	public function get_description() { return __( 'Retrieve a single CRM activity by ID.', 'mcp-ai-wpoos-pro' ); }
	public function get_parameters_schema() {
		return array( 'type' => 'object', 'properties' => array( 'activity_id' => array( 'type' => 'integer' ) ), 'required' => array( 'activity_id' ) );
	}
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( class_exists( 'WP_MCP_AI_CRM_Audit' ) ) { WP_MCP_AI_CRM_Audit::record( 'activity_viewed', 'activity', $id ); }

		return array(
			'success' => true,
			'activity' => array(
				'id' => $p->ID, 'title' => $p->post_title, 'body' => $p->post_content,
