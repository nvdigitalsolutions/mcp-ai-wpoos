...
if ( ! class_exists( 'WP_MCP_AI_Tool_DietPi_List_Services' ) ) {
	...
	class WP_MCP_AI_Tool_DietPi_List_Services extends WP_MCP_AI_Tool_DietPi_Base {
		...
		public function get_slug()        { return 'dietpi_list_services'; }
		public function get_name()        { return __( 'List DietPi Services', 'mcp-ai-wpoos-pro' ); }
		public function get_description() { return __( 'List all DietPi-managed services with their current running states. Services include Transmission, Jackett, Sonarr, Radarr, Plex, Jellyfin, and any other software managed by DietPi.', 'mcp-ai-wpoos-pro' ); }
