...
if ( ! class_exists( 'WP_MCP_AI_Tool_DietPi_System_Stats' ) ) {
	class WP_MCP_AI_Tool_DietPi_System_Stats extends WP_MCP_AI_Tool_DietPi_Base {
		public function get_slug() { return 'dietpi_system_stats'; }
		public function get_name() { return __( 'DietPi System Stats', 'mcp-ai-wpoos-pro' ); }
		public function get_description() { return __( 'Get live system statistics: CPU temperature and frequency, RAM usage, disk space, system load, and Raspberry Pi throttling flags (undervoltage, thermal throttling, etc.).', 'mcp-ai-wpoos-pro' ); }
