<?php
/**
 * Import Email Marketing Blueprint — installs a curated email marketing assistant blueprint.
 *
 * @package   WP_MCP_AI_Pro
 * @subpackage Email_Marketing_Toolkit
 * @since     2.3.1
 */
...
/**
 * Imports a curated email marketing assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_Email_Marketing_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINT_SLUGS = array( 'email-campaign-manager' );
	...
	public function get_slug() {
		return 'import_email_marketing_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import Email Marketing Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
