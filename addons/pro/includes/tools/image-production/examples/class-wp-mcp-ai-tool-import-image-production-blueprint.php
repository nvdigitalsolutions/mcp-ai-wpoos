<?php
/**
 * Import Image Production Blueprint — installs a curated image production assistant blueprint.
 *
...
/**
 * Imports a curated image production assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_Image_Production_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINT_SLUGS = array( 'creative-image-producer' );
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Image Production Blueprint tool requires the Image Production Toolkit to be enabled.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_image_production_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import Image Production Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
