...
class WP_MCP_AI_Tool_Get_Images_Without_Alt implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Get Images Without Alt tool requires the Image Production Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_name() {
		return __( 'Get Images Without Alt', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties' => array(
				'mime_type' => array(
					'type'        => 'string',
					'description' => __( 'Filter by MIME type prefix (e.g. "image/jpeg", "image/png"). Optional.', 'mcp-ai-wpoos-pro' ),
				),
				'date_from' => array(
					'type'        => 'string',
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		return array(
			...
			'message' => sprintf(
				...
				__( 'Found %d image(s) missing alt text.', 'mcp-ai-wpoos-pro' ),
				count( $images )
			),
			'count'   => count( $images ),
			'images'  => $images,
