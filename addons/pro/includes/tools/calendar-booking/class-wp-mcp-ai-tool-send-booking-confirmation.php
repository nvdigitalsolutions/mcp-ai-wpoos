...
public function get_slug() { return 'send_booking_confirmation'; }
public function get_name() { return __( 'Send Booking Confirmation', 'mcp-ai-wpoos-pro' ); }
public function get_description() { return __( 'Send confirmation emails to clients for their appointments.', 'mcp-ai-wpoos-pro' ); }
...
'include_ical' => array( 'type' => 'boolean', 'description' => __( 'Include iCal attachment', 'mcp-ai-wpoos-pro' ), 'default' => true ),
'custom_message' => array( 'type' => 'string', 'description' => __( 'Additional custom message', 'mcp-ai-wpoos-pro' ) ),
...
return array( 'success' => true, 'appointment_id' => $appointment_id, 'email_sent' => $sent, 'recipient' => $client_email, 'message' => $sent ? __( 'Confirmation sent successfully.', 'mcp-ai-wpoos-pro' ) : __( 'Failed to send confirmation.', 'mcp-ai-wpoos-pro' ) );
}
}
