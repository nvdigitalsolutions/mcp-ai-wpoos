...
public function get_slug() { return 'sync_google_calendar'; }
public function get_name() { return __( 'Sync Google Calendar', 'mcp-ai-wpoos-pro' ); }
public function get_description() { return __( 'Sync appointments with Google Calendar.', 'mcp-ai-wpoos-pro' ); }
...
'sync_direction' => array( 'type' => 'string', 'enum' => array( 'to_google', 'from_google', 'bidirectional' ), 'default' => 'to_google' ),
'calendar_id' => array( 'type' => 'string', 'description' => __( 'Google Calendar ID', 'mcp-ai-wpoos-pro' ) ),
...
return array( 'success' => true, 'appointment_id' => $appointment_id, 'sync_status' => $sync_result['status'], 'google_event_id' => $sync_result['event_id'], 'message' => __( 'Google Calendar sync initiated.', 'mcp-ai-wpoos-pro' ) );
}
}
