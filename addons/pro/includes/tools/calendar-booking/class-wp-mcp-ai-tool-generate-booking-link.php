...
public function get_slug() { return 'generate_booking_link'; }
public function get_name() { return __( 'Generate Booking Link', 'mcp-ai-wpoos-pro' ); }
public function get_description() { return __( 'Generate public booking links for appointment scheduling.', 'mcp-ai-wpoos-pro' ); }
public function get_parameters_schema() {
return array( 'type' => 'object', 'properties' => array(
'appointment_type' => array( 'type' => 'string', 'description' => __( 'Type of appointment', 'mcp-ai-wpoos-pro' ) ),
'duration_minutes' => array( 'type' => 'integer', 'description' => __( 'Default duration', 'mcp-ai-wpoos-pro' ), 'default' => 60 ),
'expiry_days' => array( 'type' => 'integer', 'description' => __( 'Link expiry in days (0 for no expiry)', 'mcp-ai-wpoos-pro' ), 'default' => 0 ),
'max_bookings' => array( 'type' => 'integer', 'description' => __( 'Maximum bookings allowed', 'mcp-ai-wpoos-pro' ), 'default' => 0 ),
) );
}
...
if ( is_wp_error( $link_id ) ) { return $link_id; }
$booking_url = home_url( '/book/' . $link_token );
return array( 'success' => true, 'link_id' => $link_id, 'booking_url' => $booking_url, 'token' => $link_token, 'appointment_type' => $appointment_type, 'duration_minutes' => $duration, 'expiry_days' => $expiry_days, 'max_bookings' => $max_bookings, 'message' => __( 'Booking link generated successfully.', 'mcp-ai-wpoos-pro' ) );
}
}
