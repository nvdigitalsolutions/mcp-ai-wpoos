<?php
/**
 * Get JetAppointment Providers Tool
 *
 * Lists JetAppointment providers (staff/experts) from the configured provider CPT.
...
class WP_MCP_AI_Tool_Get_JetAppointment_Providers implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Get JetAppointment Providers', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties' => array(
				'search' => array(
					'type'        => 'string',
					'description' => __( 'Search term to filter providers by name.', 'mcp-ai-wpoos-pro' ),
				),
				'limit'  => array(
					'type'        => 'integer',
					'description' => __( 'Maximum providers to return (default: 50).', 'mcp-ai-wpoos-pro' ),
					'default'     => 50,
					'minimum'     => 1,
					'maximum'     => 100,
				),
