<?php
/**
 * Import Calendar & Booking Blueprint — installs a curated calendar and booking assistant blueprint.
 *
...
/**
 * Imports a curated calendar and booking assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_Calendar_Booking_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Calendar & Booking Blueprint tool requires the Calendar & Booking Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_calendar_booking_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import Calendar & Booking Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
