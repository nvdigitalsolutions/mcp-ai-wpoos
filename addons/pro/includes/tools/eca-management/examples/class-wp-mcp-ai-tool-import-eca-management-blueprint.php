<?php
/**
 * Import ECA Management Blueprint — installs a curated ECA management assistant blueprint.
 *
 ...
 * @subpackage ECA_Management_Toolkit
 * @since     2.3.1
...
/**
 * Imports a curated ECA management assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_ECA_Management_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import ECA Management Blueprint tool requires the ECA Management Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_eca_management_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import ECA Management Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
