 ...
 */
class WP_MCP_AI_Tool_Update_Student implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	/**
	 * {@inheritdoc}
	 */
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Updating a student\'s name, year group, house, email, or iSAMS ID.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Creating or deleting a student; use create_student or delete_student.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'create_student', 'delete_student', 'get_student' ),
			'notes'           => __( 'Changes stay local to WordPress and are not pushed back to iSAMS.', 'mcp-ai-wpoos-pro' ),
		);
	}
