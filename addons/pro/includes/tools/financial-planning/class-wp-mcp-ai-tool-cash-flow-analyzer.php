...
public function get_slug() { return 'cash_flow_analyzer'; }
public function get_name() { return __( 'Cash Flow Analyzer', 'mcp-ai-wpoos-pro' ); }
...
'type' => 'object',
'properties' => array(
'monthly_income' => array( 'type' => 'number', 'description' => __( 'Monthly income', 'mcp-ai-wpoos-pro' ), 'minimum' => 0 ),
'monthly_expenses' => array( 'type' => 'number', 'description' => __( 'Monthly expenses', 'mcp-ai-wpoos-pro' ), 'minimum' => 0 ),
'forecast_months' => array( 'type' => 'integer', 'description' => __( 'Months to forecast', 'mcp-ai-wpoos-pro' ), 'minimum' => 1, 'maximum' => 36, 'default' => 12 ),
'income_growth_rate' => array( 'type' => 'number', 'description' => __( 'Annual income growth rate (%)', 'mcp-ai-wpoos-pro' ), 'default' => 0 ),
'expense_inflation_rate' => array( 'type' => 'number', 'description' => __( 'Annual expense inflation rate (%)', 'mcp-ai-wpoos-pro' ), 'default' => 3 ),
),
'required' => array( 'monthly_income', 'monthly_expenses' ),
);
}
public function get_capability_flags() { return array( 'pro', 'computation' ); }
