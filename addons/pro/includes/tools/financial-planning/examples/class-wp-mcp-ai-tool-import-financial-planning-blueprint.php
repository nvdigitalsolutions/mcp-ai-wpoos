<?php
/**
 * Import Financial Planning Blueprint — installs a curated financial planning assistant blueprint.
 *
 ...
 * @subpackage Financial_Planning_Toolkit
 * @since     2.3.1
...
class WP_MCP_AI_Tool_Import_Financial_Planning_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Financial Planning Blueprint tool requires the Financial Planner Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_name() {
		return __( 'Import Financial Planning Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
