...
class WP_MCP_AI_Tool_Apply_Collection_Template implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_capability_flags() {
		return array(
			'pro',                  // Pro tier tool.
			'write',                // Modifies collection configuration and media items.
			'state-changing',       // Updates collection templates and statistics.
			...
			'consumes-tokens',      // Uses AI via process_collection tool.
		);
	}
