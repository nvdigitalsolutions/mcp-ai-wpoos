	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		$place_data = array(
			...
			'place'   => array(
				...
				'facebook'           => get_post_meta( $place_id, '_place_facebook', true ) ? get_post_meta( $place_id, '_place_facebook', true ) : '',
				'instagram'          => get_post_meta( $place_id, '_place_instagram', true ) ? get_post_meta( $place_id, '_place_instagram', true ) : '',
				'tripadvisor'        => get_post_meta( $place_id, '_place_tripadvisor', true ) ? get_post_meta( $place_id, '_place_tripadvisor', true ) : '',
				'booking'            => get_post_meta( $place_id, '_place_booking', true ) ? get_post_meta( $place_id, '_place_booking', true ) : '',
