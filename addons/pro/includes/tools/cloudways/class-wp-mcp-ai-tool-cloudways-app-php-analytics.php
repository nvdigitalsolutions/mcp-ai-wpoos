...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_PHP_Analytics' ) ) {
	 ...
	 * {@inheritdoc}
	 */
	class WP_MCP_AI_Tool_Cloudways_App_PHP_Analytics extends WP_MCP_AI_Tool_Cloudways_Base implements WP_MCP_AI_Tool_Usage_Guidance_Interface {
		...
		public function get_usage_guidance() {
			return array(
				'when_to_use'     => __( 'Investigating slow PHP pages and response times for a known application.', 'mcp-ai-wpoos-pro' ),
				'when_not_to_use' => __( 'Database or traffic bottlenecks; use cloudways_app_mysql_analytics or cloudways_app_traffic_analytics.', 'mcp-ai-wpoos-pro' ),
				'related_tools'   => array( 'cloudways_app_mysql_analytics', 'cloudways_app_fpm_settings_update', 'cloudways_app_monitor_summary' ),
			);
		}
