<?php
/**
 * Cloudways Create App Backup Tool
 *
...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Create_App_Backup' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Create_App_Backup extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_slug() {
			return 'cloudways_create_app_backup';
		}

		/** {@inheritdoc} */
		public function get_name() {
			return __( 'Create App Backup', 'mcp-ai-wpoos-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			$path   = '/app/' . $server_id . '/' . $app_id . '/backup';
			...
			return $this->success(
				sprintf(
					...
					__( 'Backup initiated for app %d.', 'mcp-ai-wpoos-pro' ),
					$app_id
				),
				$result
			);
