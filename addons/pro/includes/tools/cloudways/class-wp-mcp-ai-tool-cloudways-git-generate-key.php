<?php
/**
 * Cloudways Git Generate Key Tool
 *
 * Generate a fresh SSH deploy key for an application.
 *
...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Git_Generate_Key' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Git_Generate_Key extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_slug() {
			return 'cloudways_git_generate_key';
		}

		/** {@inheritdoc} */
		public function get_name() {
			return __( 'Generate Git Deploy Key', 'mcp-ai-wpoos-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			$path   = '/app/' . $server_id . '/' . $app_id . '/git/key/generate';
			...
			return $this->success(
				sprintf(
					...
					__( 'Git deploy key generated for app %d.', 'mcp-ai-wpoos-pro' ),
					$app_id
				),
				$result
			);
