<?php
/**
 * Cloudways Rollback Restore Tool
 *
 * Roll back the last backup restore action.
 *
...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_App_Restore_Rollback' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_App_Restore_Rollback extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_slug() {
			return 'cloudways_app_restore_rollback';
		}

		/** {@inheritdoc} */
		public function get_name() {
			return __( 'Rollback Restore', 'mcp-ai-wpoos-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			$path   = '/app/' . $server_id . '/' . $app_id . '/restore/rollback';
			...
			return $this->success(
				__( 'Restore rollback initiated.', 'mcp-ai-wpoos-pro' ),
				$result
			);
		}
	}
