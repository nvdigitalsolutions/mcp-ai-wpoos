<?php
/**
 * Cloudways Purge App Cache Tool
 *
 * Clear all cache layers for an application (Varnish, object cache, etc.).
 *
...
if ( ! class_exists( 'WP_MCP_AI_Tool_Cloudways_Purge_App_Cache' ) ) {
	...
	class WP_MCP_AI_Tool_Cloudways_Purge_App_Cache extends WP_MCP_AI_Tool_Cloudways_Base {
		...
		public function get_slug() {
			return 'cloudways_purge_app_cache';
		}

		/** {@inheritdoc} */
		public function get_name() {
			return __( 'Purge App Cache', 'mcp-ai-wpoos-pro' );
		}
		...
		public function execute( array $arguments = array(), array $context = array() ) {
			...
			$path   = '/app/' . $server_id . '/' . $app_id . '/cache/purge';
			...
			return $this->success(
				sprintf(
					...
					__( 'Cache purged for app %d.', 'mcp-ai-wpoos-pro' ),
					$app_id
				),
				$result
			);
