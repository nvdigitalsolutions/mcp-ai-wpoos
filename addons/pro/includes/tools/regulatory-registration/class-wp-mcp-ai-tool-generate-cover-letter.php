 ...
 */
class WP_MCP_AI_Tool_Generate_Cover_Letter implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	/**
	 * {@inheritdoc}
	 */
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Producing a submission cover letter for a registration, with recipient details and submission type.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Bundling the letter with documents into a package; use generate_submission_pack or generate_pdf_dossier.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'generate_submission_pack', 'generate_pdf_dossier', 'submit_to_authority' ),
			'notes'           => __( 'submission_type supports new, renewal, variation, and withdrawal; format is pdf, docx, or html.', 'mcp-ai-wpoos-pro' ),
		);
	}
