<?php
/**
 * Import E-commerce Blueprint — installs a curated e-commerce assistant blueprint.
 *
...
/**
 * Imports a curated e-commerce assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_Ecommerce_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import E-commerce Blueprint tool requires the E-commerce Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_ecommerce_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import E-commerce Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
