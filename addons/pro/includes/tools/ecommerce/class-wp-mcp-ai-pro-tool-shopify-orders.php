...
class WP_MCP_AI_Pro_Tool_Shopify_Orders implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		// expose orders — refuse with a hint instead of failing mid-API-call.
		$api_mode = $client->get_api_mode();
		if ( 'admin_api' !== $api_mode ) {
			return $this->get_catalog_mode_admin_only_error( $api_mode, __( 'Shopify orders', 'mcp-ai-wpoos-pro' ) );
		}
