 ...
 * @since 1.2.0
 */
class WP_MCP_AI_Tool_Solve_Equation implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Solving linear, quadratic, and polynomial equations symbolically for a given variable.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Simplifying an expression without solving; use simplify_expression.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'simplify_expression', 'calculate_derivative', 'calculate_integral' ),
			'notes'           => __( 'show_steps=true returns step-by-step explanations when available.', 'mcp-ai-wpoos-pro' ),
		);
	}
