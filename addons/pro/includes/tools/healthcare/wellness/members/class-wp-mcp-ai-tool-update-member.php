 ...
 */
class WP_MCP_AI_Tool_Update_Member implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	/**
	 * {@inheritdoc}
	 */
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Updating fields on an existing member; provide only the fields to change.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Creating a member; use create_member. Removing a member; use delete_member.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'create_member', 'get_member' ),
			'notes'           => __( 'Unprovided fields stay unchanged; email is validated with is_email.', 'mcp-ai-wpoos-pro' ),
		);
	}
