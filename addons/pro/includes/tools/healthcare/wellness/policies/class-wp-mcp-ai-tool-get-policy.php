 ...
 */
class WP_MCP_AI_Tool_Get_Policy implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	/**
	 * {@inheritdoc}
	 */
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Reading coverage details for one known insurance policy by policy_id.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Discovering or filtering policies; use list_policies or search_policies.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'list_policies', 'search_policies', 'update_policy' ),
			'notes'           => __( 'Returns policy_number, provider, coverage dates, premium, copays, and deductible.', 'mcp-ai-wpoos-pro' ),
		);
	}
