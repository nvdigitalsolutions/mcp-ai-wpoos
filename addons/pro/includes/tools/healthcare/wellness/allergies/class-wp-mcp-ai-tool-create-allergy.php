 ...
 */
class WP_MCP_AI_Tool_Create_Allergy implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	/**
	 * {@inheritdoc}
	 */
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Recording a new allergy record for a member, or updating one by passing allergy_id.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Editing an existing allergy without recreating fields; use update_allergy.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'update_allergy', 'list_allergies', 'check_member_allergies' ),
			'notes'           => __( 'severity is required: mild, moderate, or severe; allergy_type includes food, drug, environmental, contact, latex, insect.', 'mcp-ai-wpoos-pro' ),
		);
	}
