<?php
/**
 * Import Project Management Blueprint — installs a curated project management assistant blueprint.
 *
...
class WP_MCP_AI_Tool_Import_Project_Management_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Project Management Blueprint tool requires the Project Management Toolkit to be enabled in plugin settings.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_name() {
		return __( 'Import Project Management Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
