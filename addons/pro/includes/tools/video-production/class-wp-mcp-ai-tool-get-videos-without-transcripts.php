...
class WP_MCP_AI_Tool_Get_Videos_Without_Transcripts implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Get Videos Without Transcripts', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties' => array(
				...
				'language' => array(
					'type'        => 'string',
					'description' => __( 'Language code for transcripts (e.g. "en").', 'mcp-ai-wpoos-pro' ),
					'default'     => 'en',
				),
				'limit'    => array(
					'type'        => 'integer',
	...
	public static function get_unavailable_reason() {
		...
		return __( 'Get Videos Without Transcripts tool is not available.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( ! $current_user_id || ! user_can( $current_user_id, 'read' ) ) {
			return new WP_Error(
				'wp_mcp_ai_forbidden',
				__( 'You do not have permission to view video transcripts.', 'mcp-ai-wpoos-pro' )
			);
		}
		...
		return array(
			...
			'message' => sprintf(
				...
				__( 'Found %d videos without transcripts.', 'mcp-ai-wpoos-pro' ),
				count( $videos )
			),
			'total'   => count( $videos ),
			'videos'  => $videos,
