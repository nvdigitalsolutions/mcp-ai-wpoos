<?php
/**
 * Import Extended Cognition Blueprint — installs a curated extended cognition assistant blueprint.
 *
 * @package   WP_MCP_AI_Pro
 * @subpackage Extended_Cognition_Toolkit
 * @since     2.3.1
 */
...
/**
 * Imports a curated extended cognition assistant blueprint into the mcp_ai_assistant CPT.
 *
 * @since 2.3.1
 */
class WP_MCP_AI_Tool_Import_Extended_Cognition_Blueprint implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	const BLUEPRINT_SLUGS = array( 'sensory-context-analyst' );
	...
	public static function get_unavailable_reason() {
		return __( 'The Import Extended Cognition Blueprint tool requires the Extended Cognition Toolkit to be enabled.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_slug() {
		return 'import_extended_cognition_blueprint'; }
	/**
	 * {@inheritdoc}
	 */
	public function get_name() {
		return __( 'Import Extended Cognition Blueprint', 'mcp-ai-wpoos-pro' ); }
	/**
	 * {@inheritdoc}
	 */
