...
class WP_MCP_AI_Tool_Graph_Function implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function execute( array $arguments = array(), array $context = array() ) {
		...
		if ( false === $graph_result || isset( $graph_result['error'] ) ) {
			return array(
				'success' => false,
				'error'   => __( 'Function graphing requires a graphing service (Chart.js/D3.js). Please implement the wp_mcp_ai_graph_function filter or set up a graphing microservice. See INTEGRATION_BEST_PRACTICES.md for implementation guide.', 'mcp-ai-wpoos-pro' ),
			);
		}
