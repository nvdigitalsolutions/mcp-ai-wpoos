 ...
 * @since 1.2.0
 */
class WP_MCP_AI_Tool_CRE_Loan_Quote_Generator implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Producing a full loan quote with LTV, DSCR, debt yield, payments, origination costs, prepayment terms, and total cost of capital.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Ranking execution paths; use cre_execution_strategy_advisor. Comparing multiple lender quotes; use cre_term_sheet_comparator.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'cre_term_sheet_comparator', 'cre_execution_strategy_advisor', 'cre_deal_screening_calculator' ),
			'notes'           => __( 'Requires loan_amount, property_value, noi, and interest_rate. Amortization, prepayment, and cost inputs are optional.', 'mcp-ai-wpoos-pro' ),
		);
	}
