 ...
 * @since 1.2.0
 */
class WP_MCP_AI_Tool_CRE_Tenant_Credit_Analyzer implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Assessing tenant credit quality across a portfolio with concentration scoring, investment-grade classification, and early warning flags.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'Borrower or sponsor credit analysis for loan underwriting; use cre_borrower_profile_analyzer.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'cre_lease_expiration_manager', 'cre_concentration_limit_monitor', 'cre_borrower_profile_analyzer' ),
			'notes'           => __( 'credit_rating accepts AAA through CCC or NR; requires pct_of_total_rent per tenant to compute concentration risk.', 'mcp-ai-wpoos-pro' ),
		);
	}
