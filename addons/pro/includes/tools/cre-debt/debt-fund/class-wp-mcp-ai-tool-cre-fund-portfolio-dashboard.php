 ...
 * @since 1.2.0
 */
class WP_MCP_AI_Tool_CRE_Fund_Portfolio_Dashboard implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface, WP_MCP_AI_Tool_Usage_Guidance_Interface {
	...
	public function get_usage_guidance() {
		return array(
			'when_to_use'     => __( 'Producing one overview of a debt fund: AUM, weighted-average rate/DSCR/LTV, exposure mix, maturity schedule, and performance status.', 'mcp-ai-wpoos-pro' ),
			'when_not_to_use' => __( 'LP capital-account reporting; use cre_lp_report_generator. Concentration policy checks; use cre_concentration_limit_monitor.', 'mcp-ai-wpoos-pro' ),
			'related_tools'   => array( 'cre_lp_report_generator', 'cre_concentration_limit_monitor', 'cre_credit_risk_scorer' ),
			'notes'           => __( 'Requires fund_name and loans with name, balance, property_type, state, rate, dscr, ltv, maturity_date, and status. Output is analysis only.', 'mcp-ai-wpoos-pro' ),
		);
	}
