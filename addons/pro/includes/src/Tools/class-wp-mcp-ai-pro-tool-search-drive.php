...
class WP_MCP_AI_Pro_Tool_Search_Drive implements WP_MCP_AI_Tool_Interface, WP_MCP_AI_Tool_Capability_Flags_Interface {
	...
	public function get_name() {
		return __( 'Search Google Drive Files', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_description() {
		return __( 'Searches the configured Google Drive and returns recent matches, including file names, types, and metadata.', 'mcp-ai-wpoos-pro' );
	}
	...
	public function get_parameters_schema() {
		return array(
			...
			'properties'           => array(
				...
				'query'         => array(
					'type'        => 'string',
					'description' => __( 'Google Drive search query string. Supports the same syntax as the Drive web interface (e.g., "name contains \'report\'" or "mimeType = \'application/pdf\'").', 'mcp-ai-wpoos-pro' ),
				),
				'max_results'   => array(
					'type'        => 'integer',
