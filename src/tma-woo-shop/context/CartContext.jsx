 ...
 *
 * Actions:
 *   ADD_ITEM     – add or increment a product/variation
...
/** @typedef {{ key:string, productId:number, variationId:number|null, name:string, price:number, qty:number, image:string }} CartItem */

/**
 * Generate a unique line-item key from product/variation IDs.
 *
 * @param {number}      productId
 * @param {number|null} variationId
 * @return {string}
 */
const makeKey = ( productId, variationId ) =>
...
function cartReducer( state, action ) {
	switch ( action.type ) {
		case 'ADD_ITEM': {
			...
			const key = makeKey( item.productId, item.variationId );
