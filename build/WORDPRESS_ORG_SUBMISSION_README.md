...
1. `mcp-ai-wpoos-base-1.1.3.zip` - Base version (text domain: `mcp-ai-wpoos-base`)
2. `mcp-ai-wpoos-pro-1.1.3.zip` - Pro add-on (text domain: `mcp-ai-wpoos-pro`)
3. `mcp-ai-wpoos-1.1.3.zip` - Combined (text domain: `mcp-ai-wpoos`)
...
5. `nvdigital-open-operator-system-oos-1.1.3.zip` - Base (text domain: `nvdigital-open-operator-system-oos`)
6. `nvdigital-open-operator-system-oos-pro-1.1.3.zip` - Pro (text domain: `nvdigital-open-operator-system-oos-pro`)
7. `nvdigital-open-operator-system-oos-complete-1.1.3.zip` - Combined (text domain: `nvdigital-open-operator-system-oos`)
...
**Original:** `mcp-ai-wpoos-base-1.1.3.zip`  
**WordPress.org:** `nvdigital-open-operator-system-oos-1.1.3.zip` (5.2M)
...
**Original:** `mcp-ai-wpoos-pro-1.1.3.zip`  
**WordPress.org:** `nvdigital-open-operator-system-oos-pro-1.1.3.zip` (35M)
...
**Original:** `mcp-ai-wpoos-1.1.3.zip`  
**WordPress.org:** `nvdigital-open-operator-system-oos-complete-1.1.3.zip` (43M)
...
- **File to use:** `nvdigital-open-operator-system-oos-1.1.3.zip`
...
### PRO Package  
- **File to use:** `nvdigital-open-operator-system-oos-pro-1.1.3.zip`
- **Requirements:** Base plugin must be installed first
- **Manual Install:** Upload via Plugins → Add New → Upload Plugin

### COMPLETE Package (Self-hosted)
- **File to use:** `nvdigital-open-operator-system-oos-complete-1.1.3.zip`
