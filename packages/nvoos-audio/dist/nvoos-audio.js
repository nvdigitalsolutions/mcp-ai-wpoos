...
(function(window) {
	...
	let SPEECH_ENABLED_CLASS = 'wp-mcp-ai-speech-enabled';
	let SPEECH_ERROR_CLASS = 'wp-mcp-ai-speech-button--error';
	...
	let TRANSCRIBE_RECORDING_CLASS = 'wp-mcp-ai-chat__transcribe--recording';
	const MAX_TRANSCRIBE_BYTES = 26214400; // 25MB

	// Audio translation constants (uses same tool as transcription)
	let TRANSLATE_RECORDING_CLASS = 'wp-mcp-ai-chat__translate--recording';

	// Voice chat constants
	let VOICE_CHAT_RECORDING_CLASS = 'wp-mcp-ai-chat__voice-chat--recording';
	let VOICE_CHAT_PROCESSING_CLASS = 'wp-mcp-ai-chat__voice-chat--processing';
	let VOICE_CHAT_LISTENING_CLASS = 'wp-mcp-ai-chat__voice-chat--listening';
